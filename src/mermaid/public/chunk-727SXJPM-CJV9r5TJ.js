import { g as tt } from "./chunk-FMBD7UC4-BsNoqpHi.js";
import { c as st } from "./chunk-ND2GUHAM-B58vhIOR.js";
import { g as it } from "./chunk-55IACEB6-Q791aHQa.js";
import { s as at } from "./chunk-2J33WTMH-HCULbuMq.js";
import { b as f, aD as Ie, a4 as F, aa as rt, aV as nt, bk as Oe, a_ as de, aR as ut, b1 as lt, a2 as ct, b0 as ot, a1 as ht, b3 as dt, a5 as pt, z as I, t as At, a6 as ft, aZ as gt, aN as G } from "./mermaid.core-FRDjOodn.js";
var we = (function() {
  var t = /* @__PURE__ */ f(function(O, o, h, p) {
    for (h = h || {}, p = O.length; p--; h[O[p]] = o) ;
    return h;
  }, "o"), i = [1, 18], a = [1, 19], r = [1, 20], n = [1, 41], c = [1, 26], l = [1, 42], d = [1, 24], m = [1, 25], g = [1, 32], N = [1, 33], Ae = [1, 34], b = [1, 45], fe = [1, 35], ge = [1, 36], me = [1, 37], Ce = [1, 38], be = [1, 27], ke = [1, 28], Ee = [1, 29], Te = [1, 30], ye = [1, 31], k = [1, 44], E = [1, 46], T = [1, 43], y = [1, 47], De = [1, 9], A = [1, 8, 9], Z = [1, 58], $ = [1, 59], ee = [1, 60], te = [1, 61], se = [1, 62], Fe = [1, 63], Be = [1, 64], _ = [1, 8, 9, 41], Pe = [1, 77], M = [1, 8, 9, 12, 13, 22, 39, 41, 44, 46, 68, 69, 70, 71, 72, 73, 74, 79, 81], ie = [1, 8, 9, 12, 13, 18, 20, 22, 39, 41, 44, 46, 47, 60, 68, 69, 70, 71, 72, 73, 74, 79, 81, 86, 100, 102, 103], ae = [13, 60, 86, 100, 102, 103], U = [13, 60, 73, 74, 86, 100, 102, 103], Me = [13, 60, 68, 69, 70, 71, 72, 86, 100, 102, 103], re = [1, 103], z = [1, 121], Y = [1, 117], K = [1, 113], W = [1, 119], Q = [1, 114], j = [1, 115], X = [1, 116], q = [1, 118], H = [1, 120], Re = [22, 50, 60, 61, 82, 86, 87, 88, 89, 90], Ge = [1, 128], ne = [12, 39], _e = [1, 8, 9, 39, 41, 44, 46], ue = [1, 8, 9, 22], Ue = [1, 153], ze = [1, 8, 9, 61], x = [1, 8, 9, 22, 50, 60, 61, 82, 86, 87, 88, 89, 90], Se = {
    ...
    performAction: /* @__PURE__ */ f(function(o, h, p, u, C, e, J) {
      var s = e.length - 1;
      switch (C) {
        case 8:
          this.$ = e[s - 1];
        ...
        case 19:
          ...
          break;
        case 20:
          e[s - 1].title = u.cleanupLabel(e[s]), u.addRelation(e[s - 1]);
          break;
        case 31:
          this.$ = e[s].trim(), u.setAccTitle(this.$);
          break;
        case 32:
        case 33:
          ...
          break;
        case 34:
          u.addClassesToNamespace(e[s - 3], e[s - 1][0], e[s - 1][1]), u.popNamespace();
          break;
        case 35:
          u.addClassesToNamespace(e[s - 4], e[s - 1][0], e[s - 1][1]), u.popNamespace();
          break;
        case 36:
          this.$ = u.addNamespace(e[s]);
          break;
        case 37:
          this.$ = u.addNamespace(e[s - 1], e[s]);
          break;
        case 38:
          this.$ = [[e[s]], []];
          break;
        ...
        case 46:
          ...
          break;
        case 48:
          u.setCssClass(e[s - 2], e[s]);
          break;
        case 49:
          u.addMembers(e[s - 3], e[s - 1]);
          break;
        case 51:
          u.setCssClass(e[s - 5], e[s - 3]), u.addMembers(e[s - 5], e[s - 1]);
          break;
        case 52:
          u.addAnnotation(e[s - 3], e[s - 1]);
          break;
        case 53:
          u.addAnnotation(e[s - 6], e[s - 4]), u.addMembers(e[s - 6], e[s - 1]);
          break;
        case 54:
          u.addAnnotation(e[s - 5], e[s - 3]);
          break;
        case 55:
          this.$ = e[s], u.addClass(e[s]);
          break;
        case 56:
          this.$ = e[s - 1], u.addClass(e[s - 1]), u.setClassLabel(e[s - 1], e[s]);
          break;
        case 60:
          u.addAnnotation(e[s], e[s - 2]);
          break;
        case 61:
        case 74:
          this.$ = [e[s]];
        ...
        case 63:
          break;
        case 64:
          u.addMember(e[s - 1], u.cleanupLabel(e[s]));
          break;
        case 65:
          break;
        case 66:
        ...
        case 70:
          ...
          break;
        case 71:
          this.$ = u.addNote(e[s], e[s - 1]);
          break;
        case 72:
          this.$ = u.addNote(e[s]);
          break;
        case 73:
          this.$ = e[s - 2], u.defineClass(e[s - 1], e[s]);
          break;
        case 75:
        ...
        case 91:
        case 97:
          this.$ = e[s - 2], u.setClickEvent(e[s - 1], e[s]);
          break;
        case 92:
        case 98:
          this.$ = e[s - 3], u.setClickEvent(e[s - 2], e[s - 1]), u.setTooltip(e[s - 2], e[s]);
          break;
        case 93:
          this.$ = e[s - 2], u.setLink(e[s - 1], e[s]);
          break;
        case 94:
          this.$ = e[s - 3], u.setLink(e[s - 2], e[s - 1], e[s]);
          break;
        case 95:
          this.$ = e[s - 3], u.setLink(e[s - 2], e[s - 1]), u.setTooltip(e[s - 2], e[s]);
          break;
        case 96:
          this.$ = e[s - 4], u.setLink(e[s - 3], e[s - 2], e[s]), u.setTooltip(e[s - 3], e[s - 1]);
          break;
        case 99:
          this.$ = e[s - 3], u.setClickEvent(e[s - 2], e[s - 1], e[s]);
          break;
        case 100:
          this.$ = e[s - 4], u.setClickEvent(e[s - 3], e[s - 2], e[s - 1]), u.setTooltip(e[s - 3], e[s]);
          break;
        case 101:
          this.$ = e[s - 3], u.setLink(e[s - 2], e[s]);
          break;
        case 102:
          this.$ = e[s - 4], u.setLink(e[s - 3], e[s - 1], e[s]);
          break;
        case 103:
          this.$ = e[s - 4], u.setLink(e[s - 3], e[s - 1]), u.setTooltip(e[s - 3], e[s]);
          break;
        case 104:
          this.$ = e[s - 5], u.setLink(e[s - 4], e[s - 2], e[s]), u.setTooltip(e[s - 4], e[s - 1]);
          break;
        case 105:
          this.$ = e[s - 2], u.setCssStyle(e[s - 1], e[s]);
          break;
        case 106:
          u.setCssClass(e[s - 1], e[s]);
          break;
        case 107:
          this.$ = [e[s]];
          break;
    ...
    parse: /* @__PURE__ */ f(function(o) {
      var h = this, p = [0], u = [], C = [null], e = [], J = this.table, s = "", ce = 0, Ye = 0, Je = 2, Ke = 1, Ze = e.slice.call(arguments, 1), D = Object.create(this.lexer), w = { yy: {} };
      ...
      function We() {
        var S;
        return S = u.pop() || D.lex() || Ke, typeof S != "number" && (S instanceof Array && (u = S, S = u.pop()), S = h.symbols_[S] || S), S;
      }
      f(We, "lex");
...
` + h + "^";
      ...
      test_match: /* @__PURE__ */ f(function(o, h) {
        ...
        }, this.options.ranges && (C.yylloc.range = this.yylloc.range.slice(0))), u = o[0].match(/(?:\r\n?|\n).*/g), u && (this.yylineno += u.length), this.yylloc = {
      ...
      next: /* @__PURE__ */ f(function() {
        ...
        for (var C = this._currentRules(), e = 0; e < C.length; e++)
          if (p = this._input.match(this.rules[C[e]]), p && (!h || p[0].length > h[0].length)) {
            if (h = p, u = e, this.options.backtrack_lexer) {
        ...
        return h ? (o = this.test_match(h, C[u]), o !== !1 ? o : !1) : this._input === "" ? this.EOF : this.parseError("Lexical error on line " + (this.yylineno + 1) + `. Unrecognized text.
` + this.showPosition(), {
          text: "",
          token: null,
          line: this.yylineno
      ...
      options: {},
      performAction: /* @__PURE__ */ f(function(h, p, u, C) {
        switch (u) {
          case 0:
            return 62;
          case 1:
...
var Bt = we, je = ["#", "+", "~", "-", ""], Xe = class {
  ...
  parseMember(t) {
    ...
    if (this.memberType === "method") {
      ...
      if (n) {
        ...
        if (je.includes(c) && (this.visibility = c), this.id = n[2], this.parameters = n[3] ? n[3].trim() : "", i = n[4] ? n[4].trim() : "", this.returnType = n[5] ? n[5].trim() : "", i === "") {
      ...
      const r = t.length, n = t.substring(0, 1), c = t.substring(r - 1);
      je.includes(n) && (this.visibility = n), /[$*]/.exec(c) && (i = c), this.id = t.substring(
        this.visibility === "" ? 0 : 1,
        i === "" ? r : r - 1
      );
    }
...
}, pe = "classId-", qe = 0, P = /* @__PURE__ */ f((t) => I.sanitizeText(t, F()), "sanitizeText"), _t = class Ve {
  constructor() {
    this.relations = [], this.classes = /* @__PURE__ */ new Map(), this.styleClasses = /* @__PURE__ */ new Map(), this.notes = /* @__PURE__ */ new Map(), this.interfaces = [], this.namespaces = /* @__PURE__ */ new Map(), this.namespaceCounter = 0, this.namespaceStack = [], this.diagramId = "", this.functions = [], this.lineType = {
      ...
      de(i).select("svg").selectAll("g").filter(function() {
        ...
        const l = de(c.currentTarget), d = l.attr("title");
        if (!d)
          return;
        const m = c.currentTarget.getBoundingClientRect();
        a.transition().duration(200).style("opacity", ".9"), a.html(ut.sanitize(d)).style("left", `${window.scrollX + m.left + m.width / 2}px`).style("top", `${window.scrollY + m.bottom + 4}px`), l.classed("hover", !0);
      }).on("mouseout", (c) => {
  ...
  setClassLabel(i, a) {
    ...
    this.classes.get(n).label = a, this.classes.get(n).text = `${a}${this.classes.get(n).type ? `<${this.classes.get(n).type}>` : ""}`;
  }
  /**
   ...
   */
  addClass(i) {
    const a = I.sanitizeText(i, F()), { className: r, type: n } = this.splitClassNameAndType(a);
    if (this.classes.has(r))
      return;
    const c = I.sanitizeText(r, F());
    this.classes.set(c, {
      id: c,
      type: n,
      label: c,
  ...
  lookUpDomId(i) {
    ...
    if (this.classes.has(a)) {
      const r = this.classes.get(a).domId;
      return this.diagramId ? `${this.diagramId}-${r}` : r;
    }
    throw new Error("Class not found: " + a);
  }
  clear() {
    this.relations = [], this.classes = /* @__PURE__ */ new Map(), this.notes = /* @__PURE__ */ new Map(), this.interfaces = [], this.functions = [], this.functions.push(this.setupToolTips.bind(this)), this.namespaces = /* @__PURE__ */ new Map(), this.namespaceCounter = 0, this.namespaceStack = [], this.diagramId = "", this.direction = "TB", At();
  }
  getClass(i) {
   ...
   */
  addAnnotation(i, a) {
    const r = this.splitClassNameAndType(i).className;
    this.classes.get(r).annotations.push(a);
  }
  /**
  ...
  addMember(i, a) {
    this.addClass(i);
    const r = this.splitClassNameAndType(i).className, n = this.classes.get(r);
    if (typeof a == "string") {
      const c = a.trim();
      c.startsWith("<<") && c.endsWith(">>") ? n.annotations.push(P(c.substring(2, c.length - 2))) : c.indexOf(")") > 0 ? n.methods.push(new Xe(c, "method")) : c && n.members.push(new Xe(c, "attribute"));
    }
  }
  addMembers(i, a) {
    Array.isArray(a) && (a.reverse(), a.forEach((r) => this.addMember(i, r)));
  }
  addNote(i, a) {
    const r = this.notes.size, n = {
      id: `note${r}`,
      class: a,
      text: i,
      index: r
  ...
  defineClass(i, a) {
    for (const r of i) {
      ...
      n === void 0 && (n = { id: r, styles: [], textStyles: [] }, this.styleClasses.set(r, n)), a && a.forEach((c) => {
        if (/color/.exec(c)) {
        ...
        c.cssClasses.includes(r) && c.styles.push(...a.flatMap((l) => l.split(",")));
      });
    }
  }
  /**
  ...
  setTooltip(i, a) {
    i.split(",").forEach((r) => {
      a !== void 0 && (this.classes.get(r).tooltip = P(a));
    });
  }
  getTooltip(i, a) {
  ...
  setLink(i, a, r) {
    ...
    i.split(",").forEach((c) => {
      ...
      d && (d.link = Oe.formatUrl(a, n), n.securityLevel === "sandbox" ? d.linkTarget = "_top" : typeof r == "string" ? d.linkTarget = P(r) : d.linkTarget = "_blank");
  ...
  setClickEvent(i, a, r) {
    i.split(",").forEach((n) => {
      this.setClickFunc(n, a, r), this.classes.get(n).haveCallback = !0;
    }), this.setCssClass(i, "clickable");
  }
  setClickFunc(i, a, r) {
    ...
    if (this.classes.has(l)) {
      ...
      d.length === 0 && d.push(l), this.functions.push(() => {
        const m = this.lookUpDomId(l), g = document.querySelector(`[id="${m}"]`);
  ...
  static getAncestorIds(i) {
    const a = i.split("."), r = new Array(a.length);
    r[0] = a[0];
    for (let n = 1; n < a.length; n++)
      r[n] = `${r[n - 1]}.${a[n]}`;
    return r;
  }
  createNamespaceNode(i, a, r, n = !1) {
    return {
      id: i,
      label: a,
  ...
  linkParentChild(i, a) {
    const r = this.namespaces.get(i), n = this.namespaces.get(a);
    !r || !n || (r.children.has(a) || r.children.set(a, n), n.parent ??= i);
  }
  addNamespace(i, a) {
    const r = Ve.resolveQualifiedId(i, this.namespaceStack);
    if (this.namespaceStack.push(r), this.namespaces.has(r)) {
      const l = this.namespaces.get(r);
      return l.explicit = !0, a && (l.label = a), r;
    }
    const n = r.split("."), c = Ve.getAncestorIds(r);
    for (let l = 0; l < c.length; l++) {
      const d = c[l], m = l > 0 ? c[l - 1] : void 0, g = l === c.length - 1, N = g && a ? a : n[l];
   ...
   * @public
   */
  addClassesToNamespace(i, a, r) {
    if (this.namespaces.has(i)) {
      for (const n of a) {
        const { className: c } = this.splitClassNameAndType(n), l = this.getClass(c);
        l.parent = i, this.namespaces.get(i).classes.set(c, l);
      }
      for (const n of r) {
        const c = this.getNote(n);
        c.parent = i, this.namespaces.get(i).notes.set(n, c);
      }
    }
  }
  setCssStyle(i, a) {
    const r = this.classes.get(i);
    if (!(!a || !r))
      for (const n of a)
  ...
  getData() {
    const i = [], a = [], r = F(), n = r.class?.hierarchicalNamespaces ?? !0;
    for (const l of this.namespaces.values()) {
      if (!n && !l.explicit)
        continue;
      const d = {
        id: l.id,
        label: n ? l.label : l.id,
        isGroup: !0,
        ...
        cssStyles: [],
        look: r.look,
        parentId: n ? l.parent : void 0
      };
      i.push(d);
    }
    for (const l of this.classes.values()) {
      const d = n ? l.parent : this.resolveExplicitAncestor(l.parent), m = {
        ...l,
        type: void 0,
        isGroup: !1,
        parentId: d,
    ...
    for (const l of this.notes.values()) {
      ...
      i.push(m);
      const g = this.classes.get(l.class)?.id;
      if (g) {
        const N = {
          id: `edgeNote${l.index}`,
          start: l.id,
    ...
    return { nodes: i, edges: a, other: {}, config: r, direction: this.getDirection() };
  }
...
.edgeLabel[data-look="neo"] {
  ...
  ${tt()}
`, "getStyles"), St = mt, Ct = /* @__PURE__ */ f((t, i = "TB") => {
  if (!t.doc)
    return i;
  let a = i;
  for (const r of t.doc)
    r.stmt === "dir" && (a = r.value);
  return a;
}, "getDir"), bt = /* @__PURE__ */ f(function(t, i) {
  return i.db.getClasses();
}, "getClasses"), kt = /* @__PURE__ */ f(async function(t, i, a, r) {
  Ie.info("REF0:"), Ie.info("Drawing class diagram (v3)", i);
  const { securityLevel: n, state: c, layout: l } = F();
  r.db.setDiagramId(i);
  const d = r.db.getData(), m = it(i, n);
  d.type = r.type, d.layoutAlgorithm = rt(l), d.nodeSpacing = c?.nodeSpacing || 50, d.rankSpacing = c?.rankSpacing || 50, d.markers = ["aggregation", "extension", "composition", "dependency", "lollipop"], d.diagramId = i, await nt(d, m);
  const g = 8;
  Oe.insertTitle(
    m,
  ...
  ), at(m, g, "classDiagram", c?.useMaxWidth ?? !0);
}, "draw"), Nt = {
  getClasses: bt,
  draw: kt,
  getDir: Ct
