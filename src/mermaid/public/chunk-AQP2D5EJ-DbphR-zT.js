import { g as Zt } from "./chunk-55IACEB6-Q791aHQa.js";
import { s as te } from "./chunk-2J33WTMH-HCULbuMq.js";
import { b as f, aD as _, a4 as w, aV as ee, bk as se, a2 as ie, b1 as re, a1 as ae, b0 as ne, b3 as oe, a5 as le, a0 as ce, z as W, t as he } from "./mermaid.core-FRDjOodn.js";
var Dt = (function() {
  var t = /* @__PURE__ */ f(function(Y, a, c, r) {
    for (c = c || {}, r = Y.length; r--; c[Y[r]] = a) ;
    return c;
  }, "o"), e = [1, 2], l = [1, 3], s = [1, 4], u = [2, 4], d = [1, 9], S = [1, 11], g = [1, 16], n = [1, 17], T = [1, 18], m = [1, 19], N = [1, 33], A = [1, 20], k = [1, 21], h = [1, 22], x = [1, 23], D = [1, 24], $ = [1, 26], L = [1, 27], P = [1, 28], I = [1, 29], J = [1, 30], st = [1, 31], it = [1, 32], rt = [1, 35], at = [1, 36], nt = [1, 37], ot = [1, 38], j = [1, 34], p = [1, 4, 5, 16, 17, 19, 21, 22, 24, 25, 26, 27, 28, 29, 33, 35, 37, 38, 41, 45, 48, 51, 52, 53, 54, 57], lt = [1, 4, 5, 14, 15, 16, 17, 19, 21, 22, 24, 25, 26, 27, 28, 29, 33, 35, 37, 38, 39, 40, 41, 45, 48, 51, 52, 53, 54, 57], At = [4, 5, 16, 17, 19, 21, 22, 24, 25, 26, 27, 28, 29, 33, 35, 37, 38, 41, 45, 48, 51, 52, 53, 54, 57], yt = {
    ...
    performAction: /* @__PURE__ */ f(function(a, c, r, y, E, i, F) {
      var o = i.length - 1;
      switch (E) {
        case 3:
          return y.setRootDoc(i[o]), i[o];
        case 4:
          this.$ = [];
          break;
        case 5:
          i[o] != "nl" && (i[o - 1].push(i[o]), this.$ = i[o - 1]);
          break;
        case 6:
        case 7:
          this.$ = i[o];
        ...
        case 13:
          const q = i[o - 1];
          q.description = y.trimColon(i[o]), this.$ = q;
          break;
        case 14:
          this.$ = { stmt: "relation", state1: i[o - 2], state2: i[o] };
          break;
        case 15:
          const gt = y.trimColon(i[o]);
          this.$ = { stmt: "relation", state1: i[o - 3], state2: i[o - 1], description: gt };
          break;
        case 19:
          this.$ = { stmt: "state", id: i[o - 3], type: "default", description: "", doc: i[o - 1] };
          break;
        case 20:
          var B = i[o], H = i[o - 2].trim();
          if (i[o].match(":")) {
            var ht = i[o].split(":");
            B = ht[0], H = [H, ht[1]];
          }
          ...
          break;
        case 21:
          this.$ = { stmt: "state", id: i[o - 3], type: "default", description: i[o - 5], doc: i[o - 1] };
          break;
        case 22:
          this.$ = { stmt: "state", id: i[o], type: "fork" };
          break;
        case 23:
          this.$ = { stmt: "state", id: i[o], type: "join" };
          break;
        case 24:
          this.$ = { stmt: "state", id: i[o], type: "choice" };
          break;
        case 25:
          this.$ = { stmt: "state", id: y.getDividerId(), type: "divider" };
          break;
        case 26:
          this.$ = { stmt: "state", id: i[o - 1].trim(), note: { position: i[o - 2].trim(), text: i[o].trim() } };
          break;
        case 29:
          this.$ = i[o].trim(), y.setAccTitle(this.$);
          break;
        case 30:
        case 31:
        ...
        case 34:
        case 35:
          this.$ = { stmt: "classDef", id: i[o - 1].trim(), classes: i[o].trim() };
          break;
        case 36:
          this.$ = { stmt: "style", id: i[o - 1].trim(), styleClass: i[o].trim() };
          break;
        case 37:
          this.$ = { stmt: "applyClass", id: i[o - 1].trim(), styleClass: i[o].trim() };
          break;
        case 38:
        ...
        case 44:
        case 45:
          this.$ = { stmt: "state", id: i[o].trim(), type: "default", description: "" };
          break;
        case 46:
          this.$ = { stmt: "state", id: i[o - 2].trim(), classes: [i[o].trim()], type: "default", description: "" };
          break;
        case 47:
          this.$ = { stmt: "state", id: i[o - 2].trim(), classes: [i[o].trim()], type: "default", description: "" };
          break;
    ...
    parse: /* @__PURE__ */ f(function(a) {
      var c = this, r = [0], y = [], E = [null], i = [], F = this.table, o = "", B = 0, H = 0, ht = 2, q = 1, gt = i.slice.call(arguments, 1), b = Object.create(this.lexer), M = { yy: {} };
      for (var Tt in this.yy)
        Object.prototype.hasOwnProperty.call(this.yy, Tt) && (M.yy[Tt] = this.yy[Tt]);
      b.setInput(a, M.yy), M.yy.lexer = b, M.yy.parser = this, typeof b.yylloc > "u" && (b.yylloc = {});
      var Et = b.yylloc;
      i.push(Et);
      ...
      function xt() {
        var O;
        return O = y.pop() || b.lex() || q, typeof O != "number" && (O instanceof Array && (y = O, O = y.pop()), O = c.symbols_[O] || O), O;
      }
      f(xt, "lex");
      for (var C, U, R, _t, z = {}, ut, G, Lt, dt; ; ) {
        if (U = r[r.length - 1], this.defaultActions[U] ? R = this.defaultActions[U] : ((C === null || typeof C > "u") && (C = xt()), R = F[U] && F[U][C]), typeof R > "u" || !R.length || !R[0]) {
          var mt = "";
          dt = [];
          for (ut in F[U])
            this.terminals_[ut] && ut > ht && dt.push("'" + this.terminals_[ut] + "'");
          b.showPosition ? mt = "Parse error on line " + (B + 1) + `:
` + b.showPosition() + `
Expecting ` + dt.join(", ") + ", got '" + (this.terminals_[C] || C) + "'" : mt = "Parse error on line " + (B + 1) + ": Unexpected " + (C == q ? "end of input" : "'" + (this.terminals_[C] || C) + "'"), this.parseError(mt, {
            text: b.match,
        ...
        if (R[0] instanceof Array && R.length > 1)
          throw new Error("Parse Error: multiple actions possible at state: " + U + ", token: " + C);
        switch (R[0]) {
          case 1:
            r.push(C), E.push(b.yytext), i.push(b.yylloc), r.push(R[1]), C = null, H = b.yyleng, o = b.yytext, B = b.yylineno, Et = b.yylloc;
            break;
          case 2:
            if (G = this.productions_[R[1]][1], z.$ = E[E.length - G], z._$ = {
              ...
              return _t;
            G && (r = r.slice(0, -1 * G * 2), E = E.slice(0, -1 * G), i = i.slice(0, -1 * G)), r.push(this.productions_[R[1]][0]), E.push(z.$), i.push(z._$), Lt = F[r[r.length - 2]][r[r.length - 1]], r.push(Lt);
            break;
          case 3:
            return !0;
        }
    ...
    var Y = {
      EOF: 1,
      parseError: /* @__PURE__ */ f(function(c, r) {
        if (this.yy.parser)
      ...
      setInput: /* @__PURE__ */ f(function(a, c) {
...
` + c + "^";
      ...
      test_match: /* @__PURE__ */ f(function(a, c) {
        var r, y, E;
...
` + this.showPosition(), {
      ...
      performAction: /* @__PURE__ */ f(function(c, r, y, E) {
        function i() {
          const F = r.yytext.indexOf("%%");
          if (F === 0)
            return !1;
          if (F > 0) {
            const o = r.yytext.slice(0, F), B = r.yytext.slice(F);
            B && c.lexer.unput(B), r.yytext = o;
          }
          return !0;
        }
        switch (f(i, "processId"), y) {
          case 0:
            return 38;
          case 1:
            return 40;
...
Dt.parser = Dt;
var Ge = Dt, ue = "TB", Ft = "TB", It = "dir", X = "state", K = "root", vt = "relation", de = "classDef", fe = "style", pe = "applyClass", tt = "default", Bt = "divider", Gt = "fill:none", Yt = "fill: #333", Vt = "c", Mt = "markdown", Ut = "normal", bt = "rect", kt = "rectWithTitle", Se = "stateStart", ye = "stateEnd", Ot = "divider", Nt = "roundedWithTitle", ge = "note", Te = "noteGroup", et = "statediagram", Ee = "state", _e = `${et}-${Ee}`, Wt = "transition", me = "note", be = "note-edge", ke = `${Wt} ${be}`, De = `${et}-${me}`, ve = "cluster", Ce = `${et}-${ve}`, Ae = "cluster-alt", xe = `${et}-${Ae}`, jt = "parent", Ht = "note", Le = "state", Ct = "----", Ie = `${Ct}${Ht}`, Rt = `${Ct}${jt}`, zt = /* @__PURE__ */ f((t, e = Ft) => {
  if (!t.doc)
    return e;
  let l = e;
  for (const s of t.doc)
    s.stmt === "dir" && (l = s.value);
  return l;
}, "getDir"), Oe = /* @__PURE__ */ f(function(t, e) {
  return e.db.getClasses();
}, "getClasses"), Ne = /* @__PURE__ */ f(async function(t, e, l, s) {
  _.info("REF0:"), _.info("Drawing state diagram (v2)", e);
  const { securityLevel: u, state: d, layout: S } = w();
  s.db.extract(s.db.getRootDocV2());
  const g = s.db.getData(), n = Zt(e, u);
  g.type = s.type, g.layoutAlgorithm = S, g.nodeSpacing = d?.nodeSpacing || 50, g.rankSpacing = d?.rankSpacing || 50, w().look === "neo" ? g.markers = ["barbNeo"] : g.markers = ["barb"], g.diagramId = e, await ee(g, n);
  const m = 8;
  try {
    (typeof s.db.getLinks == "function" ? s.db.getLinks() : /* @__PURE__ */ new Map()).forEach((A, k) => {
      const h = typeof k == "string" ? k : typeof k?.id == "string" ? k.id : "";
      if (!h) {
        _.warn("⚠️ Invalid or missing stateId from key:", JSON.stringify(k));
        return;
      }
      const x = n.node()?.querySelectorAll("g");
      let D;
      if (x?.forEach((I) => {
        I.textContent?.trim() === h && (D = I);
      }), !D) {
        _.warn("⚠️ Could not find node matching text:", h);
        return;
      }
      const $ = D.parentNode;
      if (!$) {
        _.warn("⚠️ Node has no parent, cannot wrap:", h);
        return;
      }
      const L = document.createElementNS("http://www.w3.org/2000/svg", "a"), P = A.url.replace(/^"+|"+$/g, "");
      if (L.setAttributeNS("http://www.w3.org/1999/xlink", "xlink:href", P), L.setAttribute("target", "_blank"), A.tooltip) {
        const I = A.tooltip.replace(/^"+|"+$/g, "");
        L.setAttribute("title", I);
      }
      $.replaceChild(L, D), L.appendChild(D), _.info("🔗 Wrapped node in <a> tag for:", h, A.url);
    });
  } catch (N) {
  ...
  ), te(n, m, et, d?.useMaxWidth ?? !0);
}, "draw"), Ye = {
  getClasses: Oe,
  draw: Ne,
  getDir: zt
}, pt = /* @__PURE__ */ new Map(), V = 0;
function St(t = "", e = 0, l = "", s = Ct) {
  const u = l !== null && l.length > 0 ? `${s}${l}` : "";
  return `${Le}-${t}${u}-${e}`;
}
f(St, "stateDomId");
var Re = /* @__PURE__ */ f((t, e, l, s, u, d, S, g) => {
      ...
      case vt:
        {
          ...
          const T = S === "neo", m = {
            ...
            style: Gt,
            labelStyle: "",
            label: W.sanitizeText(n.description ?? "", w()),
            arrowheadStyle: Yt,
            labelpos: Vt,
            labelType: Mt,
            thickness: Ut,
...
var Z = /* @__PURE__ */ f((t, e, l, s, u, d, S, g) => {
  ...
  if (_.info("dataFetcher parsedItem", e, T, N), n !== "root") {
    ...
    if (x.shape === Ot && (x.label = ""), t && t.id !== "root" && (_.trace("Setting node ", n, " to be child of its parent ", t.id), x.parentId = t.id), x.centerLabel = !0, e.note) {
      const D = {
        labelStyle: "",
        shape: ge,
        label: e.note.text,
      ...
      V++, L.id = $, D.parentId = $, Q(s, L, g), Q(s, D, g), Q(s, x, g);
      let P = n, I = D.id;
      e.note.position === "left of" && (P = D.id, I = n), u.push({
        id: P + "-" + I,
        start: P,
        end: I,
        arrowhead: "none",
  ...
  e.doc && (_.trace("Adding nodes children "), Re(e, e.doc, l, s, u, !d, S, g));
}, "dataFetcher"), we = /* @__PURE__ */ f(() => {
  pt.clear(), V = 0;
}, "reset"), v = {
  START_NODE: "[*]",
  START_TYPE: "start",
  ...
  handleStyleDef(t) {
    const e = t.id.trim().split(","), l = t.styleClass.split(",");
    for (const s of e) {
      let u = this.getState(s);
      if (!u) {
        const d = s.trim();
        this.addState(d), u = this.getState(d);
      }
      u && (u.styles = l.map((d) => d.replace(/;/g, "")?.trim()));
    }
  }
  setRootDoc(t) {
  ...
  docTranslator(t, e, l) {
    ...
    if (e.stmt === X && (e.id === v.START_NODE ? (e.id = t.id + (l ? "_start" : "_end"), e.start = l) : e.id = e.id.trim()), e.stmt !== K && e.stmt !== X || !e.doc)
      return;
    const s = [];
    let u = [];
    ...
    e.doc.forEach((d) => this.docTranslator(e, d, !0));
  }
  getRootDocV2() {
   ...
   */
  addState(t, e = tt, l = void 0, s = void 0, u = void 0, d = void 0, S = void 0, g = void 0) {
    const n = t?.trim();
    if (!this.currentDocument.states.has(n))
      ...
      T.doc || (T.doc = l), T.type || (T.type = e);
    }
    if (s && (_.info("Setting state description", n, s), (Array.isArray(s) ? s : [s]).forEach((m) => this.addDescription(n, m.trim()))), u) {
      const T = this.currentDocument.states.get(n);
      if (!T)
        throw new Error(`State not found: ${n}`);
      T.note = u, T.note.text = W.sanitizeText(T.note.text, w());
    }
    d && (_.info("Setting state classes", n, d), (Array.isArray(d) ? d : [d]).forEach((m) => this.setCssClass(n, m.trim()))), S && (_.info("Setting state styles", n, S), (Array.isArray(S) ? S : [S]).forEach((m) => this.setStyle(n, m.trim()))), g && (_.info("Setting state styles", n, S), (Array.isArray(g) ? g : [g]).forEach((m) => this.setTextStyle(n, m.trim())));
  }
  clear(t) {
    this.nodes = [], this.edges = [], this.documents = { root: Pt() }, this.currentDocument = this.documents.root, this.startEndCount = 0, this.classes = $t(), t || (this.links = /* @__PURE__ */ new Map(), he());
  }
  getState(t) {
   ...
   */
  addLink(t, e, l) {
    this.links.set(t, { url: e, tooltip: l }), _.warn("Adding link", t, e, l);
  }
  /**
   ...
   *
   */
  endTypeIfNeeded(t = "", e = tt) {
    return t === v.END_NODE ? v.END_TYPE : e;
  }
  addRelationObjs(t, e, l = "") {
    const s = this.startIdIfNeeded(t.id.trim()), u = this.startTypeIfNeeded(t.id.trim(), t.type), d = this.startIdIfNeeded(e.id.trim()), S = this.startTypeIfNeeded(e.id.trim(), e.type);
    this.addState(
      s,
      u,
      t.doc,
      ...
      id1: s,
      id2: d,
      relationTitle: W.sanitizeText(l, w())
    });
  }
  /**
  ...
  addRelation(t, e, l) {
    if (typeof t == "object" && typeof e == "object")
      this.addRelationObjs(t, e, l);
    else if (typeof t == "string" && typeof e == "string") {
      const s = this.startIdIfNeeded(t.trim()), u = this.startTypeIfNeeded(t), d = this.endIdIfNeeded(e.trim()), S = this.endTypeIfNeeded(e);
      this.addState(s, u), this.addState(d, S), this.currentDocument.relations.push({
        id1: s,
        id2: d,
        relationTitle: l ? W.sanitizeText(l, w()) : void 0
      });
    }
  }
  addDescription(t, e) {
    const l = this.currentDocument.states.get(t), s = e.startsWith(":") ? e.replace(":", "").trim() : e;
    l?.descriptions?.push(W.sanitizeText(s, w()));
  }
  cleanupLabel(t) {
  ...
  addStyleClass(t, e = "") {
    ...
    const l = this.classes.get(t);
    e && l && e.split(v.STYLECLASS_SEP).forEach((s) => {
      const u = s.replace(/([^;]*);/, "$1").trim();
      if (RegExp(v.COLOR_KEYWORD).exec(s)) {
        const S = u.replace(v.FILL_KEYWORD, v.BG_FILL).replace(v.COLOR_KEYWORD, v.FILL_KEYWORD);
        l.textStyles.push(S);
      }
      l.styles.push(u);
    });
  ...
  setCssClass(t, e) {
    t.split(",").forEach((l) => {
      ...
      if (!s) {
        const u = l.trim();
        this.addState(u), s = this.getState(u);
      }
      s?.classes?.push(e);
    });
  }
