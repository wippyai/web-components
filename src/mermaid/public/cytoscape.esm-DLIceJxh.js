...
function rc(r, e) {
  for (var t = 0; t < e.length; t++) {
    var a = e[t];
    a.enumerable = a.enumerable || !1, a.configurable = !0, "value" in a && (a.writable = !0), Object.defineProperty(r, Ql(a.key), a);
  }
}
function ht(r, e, t) {
  return e && rc(r.prototype, e), Object.defineProperty(r, "prototype", {
    writable: !1
  }), r;
}
function Cr(r, e) {
...
function Zl(r, e, t) {
  return (e = Ql(e)) in r ? Object.defineProperty(r, e, {
    value: t,
    enumerable: !0,
    configurable: !0,
    writable: !0
...
function Qe(r, e) {
  return jf(r) || ac(r, e) || Us(r, e) || nc();
}
function pn(r) {
  return ec(r) || tc(r) || Us(r) || ic();
}
function sc(r, e) {
...
function Us(r, e) {
  if (r) {
    if (typeof r == "string") return ks(r, e);
    var t = {}.toString.call(r).slice(8, -1);
    return t === "Object" && r.constructor && (t = r.constructor.name), t === "Map" || t === "Set" ? Array.from(r) : t === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t) ? ks(r, e) : void 0;
  }
}
var je = typeof window > "u" ? null : window, Eo = je ? je.navigator : null;
je && je.document;
var oc = rr(""), Jl = rr({}), uc = rr(function() {
}), lc = typeof HTMLElement > "u" ? "undefined" : rr(HTMLElement), Ra = function(e) {
  return e && e.instanceString && $e(e.instanceString) ? e.instanceString() : null;
}, he = function(e) {
  return e != null && rr(e) == oc;
}, $e = function(e) {
  return e != null && rr(e) === uc;
}, Ve = function(e) {
  return !Tr(e) && (Array.isArray ? Array.isArray(e) : e != null && e instanceof Array);
}, Me = function(e) {
  return e != null && rr(e) === Jl && !Ve(e) && e.constructor === Object;
}, vc = function(e) {
  return e != null && rr(e) === Jl;
}, ae = function(e) {
  return e != null && rr(e) === rr(1) && !isNaN(e);
}, fc = function(e) {
  ...
  return Ra(e) === "collection" && e._private.single;
}, jl = function(e) {
  return Ra(e) === "collection" && !e._private.single;
}, Ks = function(e) {
  return Ra(e) === "core";
}, ev = function(e) {
  return Ra(e) === "stylesheet";
}, cc = function(e) {
  return Ra(e) === "event";
}, ot = function(e) {
  ...
  return vc(e) && $e(e.then);
}, pc = function() {
  return Eo && Eo.userAgent.match(/msie|trident|edge/i);
}, Yt = function(e, t) {
  t || (t = function() {
  ...
  return ot(e) ? e : e.charAt(0).toUpperCase() + e.substring(1);
}, tt = function(e, t) {
  return e.slice(-1 * t.length) === t;
}, er = "(?:[-+]?(?:(?:\\d+|\\d*\\.\\d+)(?:[Ee][+-]?\\d+)?))", yc = "rgb[a]?\\((" + er + "[%]?)\\s*,\\s*(" + er + "[%]?)\\s*,\\s*(" + er + "[%]?)(?:\\s*,\\s*(" + er + "))?\\)", mc = "rgb[a]?\\((?:" + er + "[%]?)\\s*,\\s*(?:" + er + "[%]?)\\s*,\\s*(?:" + er + "[%]?)(?:\\s*,\\s*(?:" + er + "))?\\)", bc = "hsl[a]?\\((" + er + ")\\s*,\\s*(" + er + "[%])\\s*,\\s*(" + er + "[%])(?:\\s*,\\s*(" + er + "))?\\)", wc = "hsl[a]?\\((?:" + er + ")\\s*,\\s*(?:" + er + "[%])\\s*,\\s*(?:" + er + "[%])(?:\\s*,\\s*(?:" + er + "))?\\)", xc = "\\#[0-9a-fA-F]{3}", Ec = "\\#[0-9a-fA-F]{6}", tv = function(e, t) {
  return e < t ? -1 : e > t ? 1 : 0;
}, Cc = function(e, t) {
  return -1 * tv(e, t);
}, ye = Object.assign != null ? Object.assign.bind(Object) : function(r) {
  ...
  return (Ve(e) ? e : null) || Dc(e) || Tc(e) || kc(e) || Sc(e);
}, Bc = {
...
function Rn() {
  if (ko) return Jn;
  ko = 1;
  var r = Pc(), e = typeof self == "object" && self && self.Object === Object && self, t = r || e || Function("return this")();
  return Jn = t, Jn;
}
var jn, Do;
function Ac() {
...
function sv() {
  if (Lo) return ii;
  Lo = 1;
  var r = Ys(), e = Lc(), t = Ic(), a = "[object Null]", n = "[object Undefined]", i = r ? r.toStringTag : void 0;
  function s(o) {
...
function Nc() {
  if (No) return ui;
  No = 1;
  var r = Mc(), e = Ia(), t = Oa(), a = NaN, n = /^[-+]0x[0-9a-f]+$/i, i = /^0b[01]+$/i, s = /^0o[0-7]+$/i, o = parseInt;
  function u(l) {
    if (typeof l == "number")
      return l;
    if (t(l))
...
function zc() {
  if (zo) return li;
  zo = 1;
  var r = Ia(), e = Ac(), t = Nc(), a = "Expected a function", n = Math.max, i = Math.min;
  function s(o, u, l) {
...
var Fc = zc(), Na = /* @__PURE__ */ La(Fc), vi = je ? je.performance : null, ov = vi && vi.now ? function() {
  return vi.now();
} : function() {
  return Date.now();
}, Vc = (function() {
  if (je) {
    if (je.requestAnimationFrame)
      return function(r) {
        je.requestAnimationFrame(r);
      };
    if (je.mozRequestAnimationFrame)
      return function(r) {
        je.mozRequestAnimationFrame(r);
      };
    if (je.webkitRequestAnimationFrame)
      return function(r) {
        je.webkitRequestAnimationFrame(r);
      };
    if (je.msRequestAnimationFrame)
      return function(r) {
        je.msRequestAnimationFrame(r);
      };
  }
  return function(r) {
  ...
  return Vc(e);
}, Xr = ov, Ct = 9261, uv = 65599, _t = 5381, lv = function(e) {
  for (var t = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : Ct, a = t, n; n = e.next(), !n.done; )
    a = a * uv + n.value | 0;
  return a;
}, xa = function(e) {
  var t = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : Ct;
  return t * uv + e | 0;
}, Ea = function(e) {
...
function Wc(r, e, t) {
  if (t === 0) return r;
  var a = (e.x1 + e.x2) / 2, n = (e.y1 + e.y2) / 2, i = e.w / e.h, s = 1 / i, o = Gc(r.x, r.y, a, n, t), u = Hc(o.x, o.y, a, n, i, s);
  return {
    x: u.x,
    y: u.y
  };
}
var Vo = !0, $c = console.warn != null, Uc = console.trace != null, Zs = Number.MAX_SAFE_INTEGER || 9007199254740991, fv = function() {
  return !0;
}, bn = function() {
  return !1;
}, qo = function() {
  ...
  cv() && ($c ? console.warn(e) : (console.log(e), Uc && console.trace()));
}, Kc = function(e) {
  return ye({}, e);
}, qr = function(e) {
  return e == null ? e : Ve(e) ? e.slice() : Me(e) ? Kc(e) : e;
}, Xc = function(e) {
  return e.slice();
}, dv = function(e, t) {
  for (
...
})(), Kr = typeof Map < "u" ? Map : Qc, Jc = "undefined", jc = /* @__PURE__ */ (function() {
  function r(e) {
    if (dt(this, r), this._obj = /* @__PURE__ */ Object.create(null), this.size = 0, e != null) {
      var t;
...
})(), jt = (typeof Set > "u" ? "undefined" : rr(Set)) !== Jc ? Set : jc, Mn = function(e, t) {
  var a = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : !0;
  if (e === void 0 || t === void 0 || !Ks(e)) {
  ...
  var l = [];
  Ve(t.classes) ? l = t.classes : he(t.classes) && (l = t.classes.split(/\s+/));
  ...
  var h = t.style || t.css;
  h && (ze("Setting a `style` bypass at element creation should be done only when absolutely necessary.  Try to use the stylesheet instead."), this.style(h));
}, _o = function(e) {
  return e = {
    bfs: e.bfs || !e.dfs,
    dfs: e.dfs || !e.bfs
    ...
    var s;
    Me(a) && !Tr(a) && (s = a, a = s.roots || s.root, n = s.visit, i = s.directed), i = arguments.length === 2 && !$e(n) ? n : i, n = $e(n) ? n : function() {
    };
    ...
    for (var C = function() {
      ...
      var L = c[R], I = f[R], M = I != null ? I.source() : null, O = I != null ? I.target() : null, q = I == null ? void 0 : A.same(M) ? O[0] : M[0], _;
      if (_ = n(A, I, q, d++, L), _ === !0)
        return y = A, 1;
      if (_ === !1)
        return 1;
      for (var N = A.connectedEdges().filter(function(j) {
        ...
        var U = N[F], J = U.connectedNodes().filter(function(j) {
          return !j.same(A) && p.has(j);
        }), Z = J.id();
        J.length !== 0 && !h[Z] && (J = J[0], l.push(J), e.bfs && (h[Z] = !0, v.push(J)), f[Z] = U, c[Z] = c[R] + 1);
      }
...
var nn = { exports: {} }, ed = nn.exports, Go;
function rd() {
...
var fi, Ho;
function td() {
  return Ho || (Ho = 1, fi = rd()), fi;
}
var ad = td(), za = /* @__PURE__ */ La(ad), nd = vr({
  root: null,
  weight: function(e) {
    return 1;
  },
  ...
  dijkstra: function(e) {
    ...
    var a = nd(e), n = a.root, i = a.weight, s = a.directed, o = this, u = i, l = he(n) ? this.filter(n)[0] : n[0], v = {}, f = {}, c = {}, h = this.byGroup(), d = h.nodes, y = h.edges;
    ...
    for (var E = function(I, M) {
      for (var O = (s ? I.edgesTo(M) : I.edgesWith(M)).intersect(y), q = 1 / 0, _, N = 0; N < O.length; N++) {
        var F = O[N], U = u(F);
        (U < q || !_) && (q = U, _ = F);
      }
      return {
    ...
    return {
      ...
      pathTo: function(I) {
        var M = he(I) ? d.filter(I)[0] : I[0], O = [], q = M, _ = q.id();
        if (M.length > 0)
          for (O.unshift(M); f[_]; ) {
            var N = f[_];
            O.unshift(N.edge), O.unshift(N.node), q = N.node, _ = q.id();
          }
        return o.spawn(O);
      }
    };
  ...
  // Implemented from pseudocode from wikipedia
  aStar: function(e) {
    var t = this.cy(), a = od(e), n = a.root, i = a.goal, s = a.heuristic, o = a.directed, u = a.weight;
    n = t.collection(n)[0], i = t.collection(i)[0];
    var l = n.id(), v = i.id(), f = {}, c = {}, h = {}, d = new za(function(_, N) {
      return c[_.id()] - c[N.id()];
    }), y = new jt(), g = {}, p = {}, m = function(N, F) {
      d.push(N), y.add(F);
    }, b, w, E = function() {
      ...
      for (var P = b._private.edges, A = 0; A < P.length; A++) {
        ...
        if (this.hasElementWithId(R.id()) && !(o && R.data("source") !== w)) {
          ...
          if (this.hasElementWithId(O) && !h[O]) {
            var q = f[w] + u(R);
            if (!C(O)) {
              f[O] = q, c[O] = q + s(M), m(M, O), g[O] = b, p[O] = R;
              continue;
            }
            q < f[O] && (f[O] = q, c[O] = q + s(M), g[O] = b, p[O] = R);
          }
        }
      }
    }
  ...
  floydWarshall: function(e) {
    for (var t = this.cy(), a = ld(e), n = a.weight, i = a.directed, s = n, o = this.byGroup(), u = o.nodes, l = o.edges, v = u.length, f = v * v, c = function(U) {
      return u.indexOf(U);
    }, h = function(U) {
      return u[U];
    ...
    var q = function(U) {
      ...
      distance: function(U, J) {
        var Z = _(U), j = _(J);
        return d[Z * v + j];
      },
      path: function(U, J) {
        var Z = _(U), j = _(J), re = h(Z);
        if (Z === j)
          return re.collection();
        if (m[Z * v + j] == null)
          return t.collection();
        var ne = t.collection(), Q = Z, V;
        for (ne.merge(re); Z !== j; )
          Q = Z, Z = m[Z * v + j], V = b[Q * v + Z], ne.merge(V), ne.merge(h(Z));
        return ne;
      }
    };
    return N;
  ...
  bellmanFord: function(e) {
    var t = this, a = fd(e), n = a.weight, i = a.directed, s = a.root, o = n, u = this, l = this.cy(), v = this.byGroup(), f = v.edges, c = v.nodes, h = c.length, d = new Kr(), y = !1, g = [];
    s = l.collection(s)[0], f.unmergeBy(function(we) {
      return we.isLoop();
    });
    for (var p = f.length, m = function(me) {
      var ge = d.get(me.id());
      return ge || (ge = {}, d.set(me.id(), ge)), ge;
    }, b = function(me) {
      return (he(me) ? l.$(me) : me)[0];
    }, w = function(me) {
      return m(b(me)).dist;
    }, E = function(me) {
      for (var ge = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : s, se = b(me), de = [], fe = se; ; ) {
        if (fe == null)
          return t.spawn();
        var xe = m(fe), be = xe.edge, Se = xe.pred;
        if (de.unshift(fe[0]), fe.same(ge) && de.length > 0)
          break;
        be != null && de.unshift(be), fe = Se;
      }
      return u.spawn(de);
    }, C = 0; C < h; C++) {
      var x = c[C], T = m(x);
    ...
    for (var k = !1, D = function(me, ge, se, de, fe, xe) {
      var be = de.dist + xe;
      be < fe.dist && !se.same(de.edge) && (fe.dist = be, fe.pred = me, fe.edge = se, k = !0);
    }, B = 1; B < h; B++) {
      k = !1;
      for (var P = 0; P < p; P++) {
    ...
    if (k)
      for (var q = [], _ = 0; _ < p; _++) {
        var N = f[_], F = N.source(), U = N.target(), J = o(N), Z = m(F).dist, j = m(U).dist;
        if (Z + J < j || !i && j + J < Z)
          if (y || (ze("Graph contains a negative weight cycle for Bellman-Ford"), y = !0), e.findNegativeWeightCycles !== !1) {
            var re = [];
            Z + J < j && re.push(F), !i && j + J < Z && re.push(U);
            for (var ne = re.length, Q = 0; Q < ne; Q++) {
              var V = re[Q], H = [V];
              H.push(m(V).edge);
              for (var W = m(V).pred; H.indexOf(W) === -1; )
                H.push(W), H.push(m(W).edge), W = m(W).pred;
              H = H.slice(H.indexOf(W));
              for (var Y = H[0].id(), te = 0, ce = 2; ce < H.length; ce += 2)
                H[ce].id() < Y && (Y = H[ce].id(), te = ce);
              H = H.slice(te).concat(H.slice(0, te)), H.push(H[0]);
              var Be = H.map(function(we) {
                return we.id();
              }).join(",");
              q.indexOf(Be) === -1 && (g.push(u.spawn(H)), q.push(Be));
            }
          } else
            break;
      }
  ...
  // bellmanFord
}, dd = Math.sqrt(2), hd = function(e, t, a) {
  ...
  kargerStein: function() {
    ...
    var i = a.length, s = n.length, o = Math.ceil(Math.pow(Math.log(i) / Math.LN2, 2)), u = Math.floor(i / dd);
    if (i < 2) {
    ...
    for (var c = 1 / 0, h = [], d = new Array(i), y = new Array(i), g = new Array(i), p = function(q, _) {
      for (var N = 0; N < i; N++)
        _[N] = q[N];
    }, m = 0; m <= o; m++) {
      for (var b = 0; b < i; b++)
        y[b] = b;
      var w = ci(y, l.slice(), i, u), E = w.slice();
      p(y, g);
      var C = ci(y, w, u, 2), x = ci(g, E, u, 2);
    ...
    var L = function(q) {
      ...
      return q.forEach(function(N) {
        _.merge(N), N.connectedEdges().forEach(function(F) {
          e.contains(F) && !T.contains(F) && _.merge(F);
        });
      }), _;
    }, I = [L(k), L(D)], M = {
      cut: T,
...
}, Dd = (di = Math.hypot) !== null && di !== void 0 ? di : function(r, e) {
...
function Bd(r, e) {
  ...
  var t = function(T, k) {
    ...
    for (var k = 0, D = 0; D < T.length; D++) {
      var B = T[D], P = T[(D + 1) % T.length];
      k += B.x * P.y - P.x * B.y;
    }
    return k / 2;
  }, u = function(T, k, D, B) {
    var P = a(k, T), A = a(B, D), R = i(P, A);
    if (Math.abs(R) < 1e-9)
      return t(T, n(P, 0.5));
    var L = i(a(D, T), A) / R;
    return t(T, n(P, L));
  ...
  for (var p = f.map(function(x, T) {
    var k = t(l[T], n(x, e)), D = t(l[(T + 1) % v], n(x, e));
    return {
      p1: k,
      p2: D
    };
...
function Pd(r, e, t, a, n, i) {
  var s = Fd(r, e, t, a, n), o = Bd(s, i), u = yr();
  return o.forEach(function(l) {
    return pv(u, l.x, l.y);
  }), u;
}
var mv = function(e, t, a, n, i, s, o) {
  var u = arguments.length > 7 && arguments[7] !== void 0 ? arguments[7] : "auto", l = u === "auto" ? lt(i, s) : u, v = i / 2, f = s / 2;
  l = Math.min(l, v, f);
  var c = l !== v, h = l !== f, d;
  if (c) {
    var y = a - v + l - o, g = n - f - o, p = a + v - l + o, m = g;
    if (d = nt(e, t, a, n, y, g, p, m, !1), d.length > 0)
      return d;
  }
  if (h) {
  ...
  if (c) {
    var x = a - v + l - o, T = n + f + o, k = a + v - l + o, D = T;
    if (d = nt(e, t, a, n, x, T, k, D, !1), d.length > 0)
      return d;
  }
  if (h) {
    var B = a - v - o, P = n - f + l - o, A = B, R = n + f - l + o;
    if (d = nt(e, t, a, n, B, P, A, R, !1), d.length > 0)
      return d;
  }
  var L;
  {
    var I = a - v + l, M = n - f + l;
    if (L = ga(e, t, a, n, I, M, l + o), L.length > 0 && L[0] <= I && L[1] <= M)
      return [L[0], L[1]];
  }
  {
    var O = a + v - l, q = n - f + l;
    if (L = ga(e, t, a, n, O, q, l + o), L.length > 0 && L[0] >= O && L[1] <= q)
      return [L[0], L[1]];
  }
  {
    var _ = a + v - l, N = n + f - l;
    if (L = ga(e, t, a, n, _, N, l + o), L.length > 0 && L[0] >= _ && L[1] >= N)
      return [L[0], L[1]];
  }
  {
    var F = a - v + l, U = n + f - l;
    if (L = ga(e, t, a, n, F, U, l + o), L.length > 0 && L[0] <= F && L[1] >= U)
      return [L[0], L[1]];
  }
  return [];
}, Ad = function(e, t, a, n, i, s, o) {
  var u = o, l = Math.min(a, i), v = Math.max(a, i), f = Math.min(n, s), c = Math.max(n, s);
  return l - u <= e && e <= v + u && f - u <= t && t <= c + u;
}, Rd = function(e, t, a, n, i, s, o, u, l) {
  var v = {
    x1: Math.min(a, o, i) - l,
    x2: Math.max(a, o, i) + l,
    y1: Math.min(n, u, s) - l,
  ...
  if (m !== 0) {
    ...
    return g === 0 || p === 0 ? hi(e, a, o) === o ? [o, u] : hi(e, a, i) === i ? [i, s] : hi(i, o, a) === a ? [a, n] : [] : [];
}, Fd = function(e, t, a, n, i) {
  ...
  for (var g, p, m, b, w = 0; w < h.length / 2; w++)
    g = h[w * 2], p = h[w * 2 + 1], w < h.length / 2 - 1 ? (m = h[(w + 1) * 2], b = h[(w + 1) * 2 + 1]) : (m = h[0], b = h[1]), v = nt(e, t, n, i, g, p, m, b), v.length !== 0 && l.push(v[0], v[1]);
  return l;
}, Vd = function(e, t, a, n, i, s, o, u, l) {
  var v = [], f, c = new Array(a.length * 2);
  l.forEach(function(m, b) {
    b === 0 ? (c[c.length - 2] = m.startX, c[c.length - 1] = m.startY) : (c[b * 4 - 2] = m.startX, c[b * 4 - 1] = m.startY), c[b * 4] = m.stopX, c[b * 4 + 1] = m.stopY, f = ga(e, t, n, i, m.cx, m.cy, m.radius), f.length !== 0 && v.push(f[0], f[1]);
  });
...
function gi(r, e) {
  ...
  var i = [].concat(pn(t(r)), pn(t(e))), s = Cr(i), o;
  try {
    for (s.s(); !(o = s.n()).done; ) {
...
var _d = vr({
  ...
  pageRank: function(e) {
    for (var t = _d(e), a = t.dampingFactor, n = t.precision, i = t.iterations, s = t.weight, o = this._private.cy, u = this.byGroup(), l = u.nodes, v = u.edges, f = l.length, c = f * f, h = v.length, d = new Array(c), y = new Array(f), g = (1 - a) / f, p = 0; p < f; p++) {
      for (var m = 0; m < f; m++) {
        var b = p * f + m;
        d[b] = 0;
      }
    ...
    for (var w = 0; w < h; w++) {
      ...
      if (C !== x) {
        var T = l.indexOfId(C), k = l.indexOfId(x), D = s(E), B = k * f + T;
        d[B] += D, y[T] += D;
      }
    }
    ...
    for (var O = new Array(f), q = new Array(f), _, N = 0; N < f; N++)
      O[N] = 1;
    for (var F = 0; F < i; F++) {
      for (var U = 0; U < f; U++)
        q[U] = 0;
    ...
    var V = {
      rank: function(W) {
        return W = o.collection(W)[0], O[l.indexOf(W)];
      }
    };
    return V;
  }
...
var Ko = vr({
  ...
  closenessCentralityNormalized: function(e) {
    for (var t = Ko(e), a = t.harmonic, n = t.weight, i = t.directed, s = this.cy(), o = {}, u = 0, l = this.nodes(), v = this.floydWarshall({
      weight: n,
      directed: i
    }), f = 0; f < l.length; f++) {
  ...
  closenessCentrality: function(e) {
    var t = Ko(e), a = t.root, n = t.weight, i = t.directed, s = t.harmonic;
    a = this.filter(a)[0];
...
var Hd = vr({
  ...
  betweennessCentrality: function(e) {
    for (var t = Hd(e), a = t.directed, n = t.weight, i = n != null, s = this.cy(), o = this.nodes(), u = {}, l = {}, v = 0, f = {
      set: function(b, w) {
        l[b] = w, w > v && (v = w);
      },
      get: function(b) {
    ...
    for (var y = function() {
      for (var b = o[g].id(), w = [], E = {}, C = {}, x = {}, T = new za(function(J, Z) {
        return x[J] - x[Z];
      }), k = 0; k < o.length; k++) {
        var D = o[k].id();
        E[D] = [], C[D] = 0, x[D] = 1 / 0;
      ...
      for (C[b] = 1, x[b] = 0, T.push(b); !T.empty(); ) {
        var B = T.pop();
        if (w.push(B), i)
          for (var P = 0; P < u[B].length; P++) {
            var A = u[B][P], R = s.getElementById(B), L = void 0;
            R.edgesTo(A).length > 0 ? L = R.edgesTo(A)[0] : L = A.edgesTo(R)[0];
            var I = n(L);
            A = A.id(), x[A] > x[B] + I && (x[A] = x[B] + I, T.nodes.indexOf(A) < 0 ? T.push(A) : T.updateItem(A), C[A] = 0, E[A] = []), x[A] == x[B] + I && (C[A] = C[A] + C[B], E[A].push(B));
          }
        else
          for (var M = 0; M < u[B].length; M++) {
            var O = u[B][M].id();
            x[O] == 1 / 0 && (T.push(O), x[O] = x[B] + 1), x[O] == x[B] + 1 && (C[O] = C[O] + C[B], E[O].push(B));
          }
      }
      for (var q = {}, _ = 0; _ < o.length; _++)
        q[o[_].id()] = 0;
      for (; w.length > 0; ) {
        for (var N = w.pop(), F = 0; F < E[N].length; F++) {
          var U = E[N][F];
          q[U] = q[U] + C[U] / C[N] * (1 + q[N]);
        }
        N != o[g].id() && f.set(N, f.get(N) + q[N]);
      }
    }, g = 0; g < o.length; g++)
      y();
    var p = {
...
Ps.bc = Ps.betweennessCentrality;
var Wd = vr({
  expandFactor: 2,
  ...
  for (var t = 0; t < e.length; t++)
    for (var a = 0; a < e.length; a++)
      t != a && jd(e[t], e[a]) && e.splice(a, 1);
  return e;
}, Xo = function(e) {
  for (var t = this.nodes(), a = this.edges(), n = this.cy(), i = $d(e), s = {}, o = 0; o < t.length; o++)
    s[t[o].id()] = o;
  for (var u = t.length, l = u * u, v = new Array(l), f, c = 0; c < l; c++)
    v[c] = 0;
  for (var h = 0; h < a.length; h++) {
    var d = a[h], y = s[d.source().id()], g = s[d.target().id()], p = Ud(d, i.attributes);
    v[y * u + g] += p, v[g * u + y] += p;
  }
  Kd(v, u, i.multFactor), xv(v, u);
  for (var m = !0, b = 0; m && b < i.maxIterations; )
    m = !1, f = Yd(v, u, i.expandFactor), v = Zd(f, u, i.inflateFactor), Qd(v, f, l, 4) || (m = !0), b++;
  var w = Jd(v, u, t, n);
  return w = eh(w), w;
}, rh = {
  markovClustering: Xo,
  ...
  return Math.max(e, Ev(t, a));
}, ua = function(e, t, a, n, i) {
  for (var s = arguments.length > 5 && arguments[5] !== void 0 ? arguments[5] : th, o = n, u, l, v = 0; v < e; v++)
    u = t(v), l = a(v), o = i(o, u, l);
  return s(o);
}, Zt = {
  euclidean: function(e, t, a) {
    return e >= 2 ? ua(e, t, a, 0, Zo, ah) : ua(e, t, a, 0, Yo);
  },
  squaredEuclidean: function(e, t, a) {
    return ua(e, t, a, 0, Zo);
  },
  manhattan: function(e, t, a) {
    return ua(e, t, a, 0, Yo);
  },
  max: function(e, t, a) {
    return ua(e, t, a, -1 / 0, nh);
  }
};
Zt["squared-euclidean"] = Zt.squaredEuclidean;
Zt.squaredeuclidean = Zt.squaredEuclidean;
function In(r, e, t, a, n, i) {
  var s;
  return $e(r) ? s = r : s = Zt[r] || Zt.euclidean, e === 0 && $e(r) ? s(n, i) : s(e, t, a, n, i);
}
var ih = vr({
  k: 2,
  m: 2,
  ...
  return o;
}, Cv = function(e, t, a, n, i) {
  for (var s = 1 / 0, o = 0, u = 0; u < t.length; u++) {
    var l = En(a, e, t[u], n, i);
    l < s && (s = l, o = u);
  }
  return o;
}, Tv = function(e, t, a) {
  ...
  for (var n = 0, i = 0; i < t.length; i++)
    n += En("manhattan", t[i], e, a, "kMedoids");
  return n;
}, lh = function(e) {
  var t = this.cy(), a = this.nodes(), n = null, i = ao(e), s = new Array(i.k), o = {}, u;
  i.testMode ? typeof i.testCentroids == "number" ? (i.testCentroids, u = pi(a, i.k, i.attributes)) : rr(i.testCentroids) === "object" ? u = i.testCentroids : u = pi(a, i.k, i.attributes) : u = pi(a, i.k, i.attributes);
  for (var l = !0, v = 0; l && v < i.maxIterations; ) {
    for (var f = 0; f < a.length; f++)
      n = a[f], o[n.id()] = Cv(n, u, i.distance, i.attributes, "kMeans");
    l = !1;
    for (var c = 0; c < i.k; c++) {
      var h = Tv(c, a, o);
      if (h.length !== 0) {
        for (var d = i.attributes.length, y = u[c], g = new Array(d), p = new Array(d), m = 0; m < d; m++) {
          ...
          g[m] = p[m] / h.length, sh(g[m], y[m], i.sensitivityThreshold) || (l = !0);
        }
  ...
  var t = this.cy(), a = this.nodes(), n = null, i = ao(e), s = new Array(i.k), o, u = {}, l, v = new Array(i.k);
  i.testMode ? typeof i.testCentroids == "number" || (rr(i.testCentroids) === "object" ? o = i.testCentroids : o = Qo(a, i.k)) : o = Qo(a, i.k);
  for (var f = !0, c = 0; f && c < i.maxIterations; ) {
    for (var h = 0; h < a.length; h++)
      n = a[h], u[n.id()] = Cv(n, o, i.distance, i.attributes, "kMedoids");
    f = !1;
  ...
  for (var o, u, l, v = 2 / (i.m - 1), f = 0; f < a.length; f++)
    for (var c = 0; c < n.length; c++) {
      o = 0;
      for (var h = 0; h < a.length; h++)
        u = En(i.distance, n[c], a[f], i.attributes, "cmeans"), l = En(i.distance, n[c], a[h], i.attributes, "cmeans"), o += Math.pow(u / l, v);
      e[c][f] = 1 / o;
    }
}, dh = function(e, t, a, n) {
  ...
  var t = this.cy(), a = this.nodes(), n = ao(e), i, s, o, u, l;
  ...
  for (var m = !0, b = 0; m && b < n.maxIterations; )
    m = !1, fh(s, a, o, l, n), ch(o, u, s, a, n), oh(o, u, n.sensitivityThreshold) || (m = !0), b++;
  return i = dh(a, o, n, t), {
    clusters: i,
  ...
  var t = gh(e), a = ph[t.linkage];
  return a != null && (t.linkage = a), t;
}, eu = function(e, t, a, n, i) {
  for (var s = 0, o = 1 / 0, u, l = i.attributes, v = function(k, D) {
    return In(i.distance, l.length, function(B) {
      return l[B](k);
    }, function(B) {
      return l[B](D);
    }, k, D);
  ...
  if (!e) return "";
  if (e.left && e.right) {
    var a = As(e.left, t), n = As(e.right, t), i = t.add({
      group: "nodes",
      data: {
        id: a + "," + n
      }
  ...
  if (!e) return [];
  var n = [], i = [], s = [];
  return t === 0 ? (e.left && Ht(e.left, n), e.right && Ht(e.right, i), s = n.concat(i), [a.collection(s)]) : t === 1 ? e.value ? [a.collection(e.value)] : (e.left && Ht(e.left, n), e.right && Ht(e.right, i), [a.collection(n), a.collection(i)]) : e.value ? [a.collection(e.value)] : (e.left && (n = Rs(e.left, t - 1, a)), e.right && (i = Rs(e.right, t - 1, a)), n.concat(i));
}, ru = function(e) {
  for (var t = this.cy(), a = this.nodes(), n = yh(e), i = n.attributes, s = function(b, w) {
    return In(n.distance, i.length, function(E) {
      return i[E](b);
    }, function(E) {
      return i[E](w);
    }, b, w);
  ...
  for (var g = eu(o, v, u, l, n); g; )
    g = eu(o, v, u, l, n);
  var p;
  return n.mode === "dendrogram" ? (p = Rs(o[0], n.dendrogramDepth, t), n.addDendrogram && As(o[0], t)) : (p = new Array(o.length), o.forEach(function(m, b) {
    m.key = m.index = null, p[b] = t.collection(m.value);
  })), p;
}, mh = {
  hierarchicalClustering: ru,
  hca: ru
}, bh = vr({
  distance: "euclidean",
  ...
  0.5 <= t && t < 1 || He("Damping must range on [0.5, 1).  Got: ".concat(t));
  var n = ["median", "mean", "min", "max"];
  return n.some(function(i) {
    return i === a;
  }) || ae(a) || He("Preference must be one of [".concat(n.map(function(i) {
    return "'".concat(i, "'");
  ...
  return -In(e, n.length, function(s) {
    return i(t, s);
  }, function(s) {
    return i(a, s);
  }, t, a);
  ...
  var a = null;
  return t === "median" ? a = wd(e) : t === "mean" ? a = bd(e) : t === "min" ? a = yd(e) : t === "max" ? a = md(e) : a = t, a;
}, Ch = function(e, t, a) {
  for (var n = [], i = 0; i < e; i++)
  ...
  for (var n = tu(e, t, a), i = 0; i < a.length; i++) {
  ...
  for (var t = this.cy(), a = this.nodes(), n = wh(e), i = {}, s = 0; s < a.length; s++)
    i[a[s].id()] = s;
  var o, u, l, v, f, c;
  ...
  for (var d = 0; d < o; d++)
    for (var y = 0; y < o; y++)
      d !== y && (l[d * o + y] = xh(n.distance, a[d], a[y], n.attributes));
  v = Eh(l, n.preference);
  for (var g = 0; g < o; g++)
    l[g * o + g] = v;
  f = new Array(u);
  ...
  for (k = 0; k < n.maxIterations; k++) {
    for (var D = 0; D < o; D++) {
      for (var B = -1 / 0, P = -1 / 0, A = -1, R = 0, L = 0; L < o; L++)
        b[L] = f[D * o + L], R = c[D * o + L] + l[D * o + L], R >= B ? (P = B, B = R, A = L) : R > P && (P = R);
      for (var I = 0; I < o; I++)
        f[D * o + I] = (1 - n.damping) * (l[D * o + I] - B) + n.damping * b[I];
      f[D * o + A] = (1 - n.damping) * (l[D * o + A] - P) + n.damping * b[A];
    }
    for (var M = 0; M < o; M++) {
      for (var O = 0, q = 0; q < o; q++)
        b[q] = c[q * o + M], w[q] = Math.max(0, f[q * o + M]), O += w[q];
      O -= w[M], w[M] = f[M * o + M], O += w[M];
      for (var _ = 0; _ < o; _++)
        c[_ * o + M] = (1 - n.damping) * Math.min(0, O - w[_]) + n.damping * b[_];
    ...
    if (N > 0 && (k >= n.minIterations - 1 || k == n.maxIterations - 1)) {
      for (var J = 0, Z = 0; Z < o; Z++) {
        E[Z] = 0;
        for (var j = 0; j < n.minIterations; j++)
          E[Z] += x[j * o + Z];
        (E[Z] === 0 || E[Z] === n.minIterations) && J++;
      }
      if (J === o)
        break;
    }
  }
  for (var re = Ch(o, f, c), ne = Th(o, l, re), Q = {}, V = 0; V < re.length; V++)
    Q[re[V]] = [];
  for (var H = 0; H < a.length; H++) {
    var W = i[a[H].id()], Y = ne[W];
    Y != null && Q[Y].push(a[H]);
  }
  for (var te = new Array(re.length), ce = 0; ce < re.length; ce++)
    te[ce] = t.collection(Q[re[ce]]);
  return te;
}, Sh = {
  affinityPropagation: au,
  ap: au
}, kh = vr({
  root: void 0,
  directed: !1
  ...
  hierholzer: function(e) {
    ...
    var a = kh(e), n = a.root, i = a.directed, s = this, o = !1, u, l, v;
  ...
  hopcroftTarjanBiconnected: Ya,
  htbc: Ya,
  htb: Ya,
  hopcroftTarjanBiconnectedComponents: Ya
}, Za = function() {
  ...
  tarjanStronglyConnected: Za,
  tsc: Za,
  tscc: Za,
  tarjanStronglyConnectedComponents: Za
}, Sv = {};
[Ca, id, sd, ud, vd, cd, gd, Gd, Ut, Kt, Ps, rh, hh, mh, Sh, Dh, Bh, Ph].forEach(function(r) {
  ye(Sv, r);
});
/*!
...
*/
var kv = 0, Dv = 1, Bv = 2, Or = function(e) {
  if (!(this instanceof Or)) return new Or(e);
  this.id = "Thenable/1.0.7", this.state = kv, this.fulfillValue = void 0, this.rejectReason = void 0, this.onFulfilled = [], this.onRejected = [], this.proxy = {
...
Or.prototype = {
  ...
  fulfill: function(e) {
    return nu(this, Dv, "fulfillValue", e);
  },
  reject: function(e) {
    return nu(this, Bv, "rejectReason", e);
  },
  /*  "The then Method" [Promises/A+ 1.1, 1.2, 2.2]  */
  then: function(e, t) {
    var a = this, n = new Or();
    return a.onFulfilled.push(su(e, n, "fulfill")), a.onRejected.push(su(t, n, "reject")), Pv(a), n.proxy;
  }
};
var nu = function(e, t, a, n) {
  return e.state === kv && (e.state = t, e[a] = n, Pv(e)), e;
}, Pv = function(e) {
  e.state === Dv ? iu(e, "onFulfilled", e.fulfillValue) : e.state === Bv && iu(e, "onRejected", e.rejectReason);
}, iu = function(e, t, a) {
  if (e[t].length !== 0) {
    var n = e[t];
    e[t] = [];
  ...
  var a;
  if (rr(t) === "object" && t !== null || typeof t == "function")
    try {
      a = t.then;
    } catch (i) {
      e.reject(i);
  ...
  if (typeof a == "function") {
    ...
    try {
      a.call(
        ...
        function(i) {
          n || (n = !0, i === t ? e.reject(new TypeError("circular thenable chain")) : Av(e, i));
        },
        /*  rejectPromise  */
...
Or.resolve = function(r) {
  return new Or(function(e, t) {
    e(r);
  });
};
Or.reject = function(r) {
  return new Or(function(e, t) {
    t(r);
  });
};
var ea = typeof Promise < "u" ? Promise : Or, Ms = function(e, t, a) {
  var n = Ks(e), i = !n, s = this._private = ye({
    duration: 1e3
  }, t, a);
...
function Mh() {
  if (lu) return bi;
  lu = 1;
  var r = sv(), e = Ia(), t = "[object AsyncFunction]", a = "[object Function]", n = "[object GeneratorFunction]", i = "[object Proxy]";
  function s(o) {
    if (!e(o))
      return !1;
    var u = r(o);
...
function Nh() {
  if (du) return Ci;
  du = 1;
  var r = Mh(), e = Ih(), t = Ia(), a = Oh(), n = /[\\^$.*+?()[\]{}|]/g, i = /^\[object .+?Constructor\]$/, s = Function.prototype, o = Object.prototype, u = s.toString, l = o.hasOwnProperty, v = RegExp(
...
function Hh() {
  ...
  return i.prototype.clear = r, i.prototype.delete = e, i.prototype.get = t, i.prototype.has = a, i.prototype.set = n, Mi = i, Mi;
}
var Li, Cu;
function Wh() {
  if (Cu) return Li;
...
function Yh() {
  ...
  return i.prototype.clear = r, i.prototype.delete = e, i.prototype.get = t, i.prototype.has = a, i.prototype.set = n, qi = i, qi;
}
var _i, Ru;
function Zh() {
  if (Ru) return _i;
  Ru = 1;
  var r = no(), e = Rn(), t = r(e, "Map");
  return _i = t, _i;
}
var Gi, Mu;
function Qh() {
...
function ag() {
  ...
  return i.prototype.clear = r, i.prototype.delete = e, i.prototype.get = t, i.prototype.has = a, i.prototype.set = n, Yi = i, Yi;
}
var Zi, qu;
function ng() {
  if (qu) return Zi;
  qu = 1;
  var r = ag(), e = "Expected a function";
  function t(a, n) {
...
function Mv() {
  if (Gu) return Ji;
  Gu = 1;
  var r = ig(), e = /[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g, t = /\\(\\)?/g, a = r(function(n) {
    var i = [];
...
function sg() {
  if (Wu) return es;
  Wu = 1;
  var r = Ys(), e = Lv(), t = On(), a = Oa(), n = r ? r.prototype : void 0, i = n ? n.toString : void 0;
  function s(o) {
    if (typeof o == "string")
      return o;
    if (t(o))
...
var lg = ug(), vg = /* @__PURE__ */ La(lg), ss, Zu;
function fg() {
  if (Zu) return ss;
  Zu = 1;
  var r = no(), e = (function() {
...
function dg() {
  if (Ju) return us;
  Ju = 1;
  var r = cg(), e = Rv(), t = Object.prototype, a = t.hasOwnProperty;
  function n(i, s, o) {
    var u = i[s];
...
var yg = pg(), mg = /* @__PURE__ */ La(yg), cs, tl;
function bg() {
  if (tl) return cs;
  tl = 1;
  function r(e, t) {
...
function wg() {
  if (al) return ds;
  al = 1;
  var r = Lv(), e = bg(), t = On(), a = Oa(), n = Mv(), i = io(), s = Iv();
  function o(u) {
    return t(u) ? r(u, i) : a(u) ? [u] : e(n(s(u)));
  }
  return ds = o, ds;
}
var xg = wg(), Eg = /* @__PURE__ */ La(xg), Cg = {
  // access data field
  data: function(e) {
    var t = {
      field: "data",
    ...
    return e = ye({}, t, e), function(n, i) {
      var s = e, o = this, u = o.length !== void 0, l = u ? o : [o], v = u ? o[0] : o;
      if (he(n)) {
        var f = n.indexOf(".") !== -1, c = f && Eg(n);
        if (s.allowGetting && i === void 0) {
          var h;
          return v && (s.beforeGet(v), c && v._private[s.field][n] === void 0 ? h = vg(v._private[s.field], c) : h = v._private[s.field][n]), h;
          ...
          if (d) {
            ...
            for (var g = 0, p = l.length; g < p; g++) {
              var m = l[g];
              s.canSet(m) && (c && v._private[s.field][n] === void 0 ? mg(m._private[s.field], c, i) : m._private[s.field][n] = i);
            }
...
[Ah, Cg, Tg].forEach(function(r) {
  ye(Ne, r);
});
var Sg = {
  animate: Ne.animate(),
  animation: Ne.animation(),
  animated: Ne.animated(),
  clearQueue: Ne.clearQueue(),
  delay: Ne.delay(),
  delayAnimation: Ne.delayAnimation(),
  stop: Ne.stop()
}, un = {
  classes: function(e) {
    var t = this;
...
var Fe = function() {
  ...
  return Cc(r.selector, e.selector);
}), kg = (function() {
  for (var r = {}, e, t = 0; t < Ls.length; t++)
    e = Ls[t], r[e.selector] = e.matches;
  return r;
})(), Dg = function(e, t) {
  return kg[e](t);
}, Bg = "(" + Ls.map(function(r) {
  return r.selector;
}).join("|") + ")", Lt = function(e) {
  ...
  populate: function(e, t, a) {
    var n = Qe(a, 3), i = n[0], s = n[1], o = n[2], u = new RegExp("^" + Re.string + "$").exec(o) != null;
  ...
  populate: function(e, t, a) {
    var n = Qe(a, 3), i = n[0], s = n[1], o = n[2];
    t.checks.push({
  ...
  populate: function(e, t) {
    if (e.currentSubject == null) {
      var a = Fe(), n = Fe(), i = e[e.length - 1];
      return a.checks.push({
        type: ue.CHILD,
        parent: i,
        child: n
      }), et(e, t, a), e.compoundCount++, n;
    } else if (e.currentSubject === t) {
      var s = Fe(), o = e[e.length - 1], u = Fe(), l = Fe(), v = Fe(), f = Fe();
      return s.checks.push({
        ...
        child: v
        // empty for now
      }), et(e, o, s), e.currentSubject = l, e.compoundCount++, v;
    } else {
      var c = Fe(), h = Fe(), d = [{
        type: ue.PARENT,
        parent: c,
  ...
  populate: function(e, t) {
    if (e.currentSubject != null && e.currentSubject !== t)
      return ze("Redefinition of subject in selector `" + e.toString() + "`"), !1;
    e.currentSubject = t;
...
var Pg = function(e) {
  for (var t, a, n, i = 0; i < Is.length; i++) {
    var s = Is[i], o = s.name, u = e.match(s.regexObj);
    if (u != null) {
      a = u, t = s, n = o;
      var l = u[0];
  ...
  var t = this, a = t.inputText = e, n = t[0] = Fe();
  for (t.length = 1, a = Ag(a); ; ) {
    var i = Pg(a);
    if (i.expr == null)
      return ze("The selector `" + e + "`is invalid"), !1;
  ...
  for (var l = 0; l < t.length; l++) {
    ...
    if (v.compoundCount > 0 && v.edgeCount > 0)
      return ze("The selector `" + e + "` is invalid because it uses both a compound selector and an edge selector"), !1;
    if (v.edgeCount > 1)
      return ze("The selector `" + e + "` is invalid because it uses multiple edge selectors"), !1;
    v.edgeCount === 1 && ze("The selector `" + e + "` is deprecated.  Edge selectors do not take effect on changes to source and target nodes after an edge is added, for performance reasons.  Use a class or data selector on edges instead, updating the class or data of an edge when your app detects a change in source or target nodes.");
  }
  return !0;
}, Mg = function() {
...
var zg = function(e) {
  ...
  }) : he(e) ? this.parse(e) || (this.invalid = !0) : He("A selector must be created from a string; found "));
}, ft = vt.prototype;
[Lg, Vg].forEach(function(r) {
  return ye(ft, r);
});
ft.text = function() {
...
var Br = function(e, t) {
  return function(n, i, s, o) {
    ...
    if (u == null ? v = "" : Tr(u) && u.length === 1 && (v = u.id()), l.length === 1 && v) {
      var f = l[0]._private, c = f.traversalCache = f.traversalCache || {}, h = c[t] = c[t] || [], d = kt(v), y = h[d];
...
function oo(r, e, t, a) {
  for (var n = [], i = new jt(), s = r.cy(), o = s.hasCompoundNodes(), u = 0; u < r.length; u++) {
    var l = r[u];
...
ye(Vn, {
  degree: hs(function(r, e) {
    return e.source().same(e.target()) ? 2 : 1;
  }),
  indegree: hs(function(r, e) {
    return e.target().same(r) ? 1 : 0;
  }),
  outdegree: hs(function(r, e) {
  ...
  renderedPosition: function(e, t) {
    ...
    if (a && a.isNode())
      if (u)
        ...
        var f = a.position();
        return o = Ln(f, i, s), e === void 0 ? o : o[e];
      }
    else if (!u)
      return;
    return this;
...
gt.updateCompoundBounds = function() {
  ...
  function t(s) {
    ...
    function h(k, D, B) {
      var P = 0, A = 0, R = D + B;
      return k > 0 && R > 0 && (P = D / R * k, A = B / R * k), {
        biasDiff: P,
...
var Dr = function(e) {
  ...
  return t == null ? e : Lr(e, t.x1, t.y1, t.x2, t.y2);
}, la = function(e, t, a) {
  return xr(e, t, a);
}, Qa = function(e, t, a) {
  if (!t.cy().headless()) {
    ...
    if (o !== "none") {
      ...
      f.x1 = u - s, f.y1 = l - s, f.x2 = u + s, f.y2 = l + s, f.w = f.x2 - f.x1, f.h = f.y2 - f.y1, sn(f, 1), Lr(e, f.x1, f.y1, f.x2, f.y2);
    }
  }
}, gs = function(e, t, a) {
  if (!t.cy().headless()) {
    ...
    if (o) {
      var u = t.pstyle("text-halign"), l = t.pstyle("text-valign"), v = la(s, "labelWidth", a), f = la(s, "labelHeight", a), c = la(s, "labelX", a), h = la(s, "labelY", a), d = t.pstyle(n + "text-margin-x").pfValue, y = t.pstyle(n + "text-margin-y").pfValue, g = t.isEdge(), p = t.pstyle(n + "text-rotation"), m = t.pstyle("text-outline-width").pfValue, b = t.pstyle("text-border-width").pfValue, w = b / 2, E = t.pstyle("text-background-padding").pfValue, C = 2, x = f, T = v, k = T / 2, D = x / 2, B, P, A, R;
      if (g)
        B = c - k, P = c + k, A = h - D, R = h + D;
      else {
        switch (u.value) {
          case "left":
            B = c - T, P = c;
      ...
      var L = d - Math.max(m, w) - E - C, I = d + Math.max(m, w) + E + C, M = y - Math.max(m, w) - E - C, O = y + Math.max(m, w) + E + C;
      B += L, P += I, A += M, R += O;
      var q = a || "main", _ = i.labelBounds, N = _[q] = _[q] || {};
      N.x1 = B, N.y1 = A, N.x2 = P, N.y2 = R, N.w = P - B, N.h = R - A, N.leftPad = L, N.rightPad = I, N.topPad = M, N.botPad = O;
      var F = g && p.strValue === "autorotate", U = p.pfValue != null && p.pfValue !== 0;
      if (F || U) {
        var J = F ? la(i.rstyle, "labelAngle", a) : p.pfValue, Z = Math.cos(J), j = Math.sin(J), re = (B + P) / 2, ne = (A + R) / 2;
        if (!g) {
          switch (u.value) {
            case "left":
              re = P;
        ...
        var Q = function(we, me) {
          return we = we - re, me = me - ne, {
            x: we * Z - me * j + re,
            y: we * j + me * Z + ne
          };
        }, V = Q(B, A), H = Q(B, R), W = Q(P, A), Y = Q(P, R);
        B = Math.min(V.x, H.x, W.x, Y.x), P = Math.max(V.x, H.x, W.x, Y.x), A = Math.min(V.y, H.y, W.y, Y.y), R = Math.max(V.y, H.y, W.y, Y.y);
      }
      var te = q + "Rot", ce = _[te] = _[te] || {};
      ce.x1 = B, ce.y1 = A, ce.x2 = P, ce.y2 = R, ce.w = P - B, ce.h = R - A, Lr(e, B, A, P, R), Lr(i.labelBounds.all, B, A, P, R);
    }
    return e;
  }
}, il = function(e, t) {
  ...
  var a = e._private.cy, n = a.styleEnabled(), i = a.headless(), s = yr(), o = e._private, u = e.isNode(), l = e.isEdge(), v, f, c, h, d, y, g = o.rstyle, p = u && n ? e.pstyle("bounds-expansion").pfValue : [0], m = function(Be) {
  ...
  if (b) {
    ...
    var T = Math.max(E, x), k = 0, D = 0;
    if (n && (k = e.pstyle("width").pfValue, D = k / 2), u && t.includeNodes) {
      var B = e.position();
      d = B.x, y = B.y;
      var P = e.outerWidth(), A = P / 2, R = e.outerHeight(), L = R / 2;
      v = d - A, f = d + A, c = y - L, h = y + L, Lr(s, v, c, f, h), n && il(s, e), n && t.includeOutlines && !i && il(s, e), n && Hg(s, e);
    } else if (l && t.includeEdges)
      if (n && !i) {
        var I = e.pstyle("curve-style").strValue;
        if (v = Math.min(g.srcX, g.midX, g.tgtX), f = Math.max(g.srcX, g.midX, g.tgtX), c = Math.min(g.srcY, g.midY, g.tgtY), h = Math.max(g.srcY, g.midY, g.tgtY), v -= D, f += D, c -= D, h += D, Lr(s, v, c, f, h), I === "haystack") {
          var M = g.haystackPts;
          if (M && M.length === 2) {
            ...
            Lr(s, v - D, c - D, f + D, h + D);
          }
        } else if (I === "bezier" || I === "unbundled-bezier" || tt(I, "segments") || tt(I, "taxi")) {
          var _;
          switch (I) {
            case "bezier":
          ...
          if (_ != null)
            for (var N = 0; N < _.length; N++) {
              var F = _[N];
              v = F.x - D, f = F.x + D, c = F.y - D, h = F.y + D, Lr(s, v, c, f, h);
            }
        }
      } else {
        var U = e.source(), J = U.position(), Z = e.target(), j = Z.position();
        if (v = J.x, f = j.x, c = J.y, h = j.y, v > f) {
          var re = v;
          v = f, f = re;
        }
        if (c > h) {
        ...
        v -= D, f += D, c -= D, h += D, Lr(s, v, c, f, h);
      }
    if (n && t.includeEdges && l && (Qa(s, e, "mid-source"), Qa(s, e, "mid-target"), Qa(s, e, "source"), Qa(s, e, "target")), n) {
      var Q = e.pstyle("ghost").value === "yes";
      if (Q) {
        var V = e.pstyle("ghost-offset-x").pfValue, H = e.pstyle("ghost-offset-y").pfValue;
        Lr(s, s.x1 + V, s.y1 + H, s.x2 + V, s.y2 + H);
      }
    }
    var W = o.bodyBounds = o.bodyBounds || {};
    Wo(W, s), on(W, p), sn(W, 1), n && (v = s.x1, f = s.x2, c = s.y1, h = s.y2, Lr(s, v - T, c - T, f + T, h + T));
    var Y = o.overlayBounds = o.overlayBounds || {};
    Wo(Y, s), on(Y, p), sn(Y, 1);
    var te = o.labelBounds = o.labelBounds || {};
    te.all != null ? Sd(te.all) : te.all = yr(), n && t.includeLabels && (t.includeMainLabels && gs(s, e, null), l && (t.includeSourceLabels && gs(s, e, "source"), t.includeTargetLabels && gs(s, e, "target")));
  }
  return s.x1 = Dr(s.x1), s.y1 = Dr(s.y1), s.x2 = Dr(s.x2), s.y2 = Dr(s.y2), s.w = Dr(s.x2 - s.x1), s.h = Dr(s.y2 - s.y1), s.w > 0 && s.h > 0 && b && (on(s, p), sn(s, 1)), s;
}, Hv = function(e) {
  ...
  if (e.isEdge()) {
    ...
    return Fo([t(a.x), t(a.y), t(n.x), t(n.y)]);
  } else {
    var i = e.position();
    return Fo([t(i.x), t(i.y)]);
  }
}, sl = function(e, t) {
  var a = e._private, n, i = e.isEdge(), s = t == null ? ol : Hv(t), o = s === ol;
  if (a.bbCache == null ? (n = Wg(e, Da), a.bbCache = n, a.bbCachePosKey = Wv(e)) : n = a.bbCache, !o) {
    var u = e.isNode();
    n = yr(), (t.includeNodes && u || t.includeEdges && !u) && (t.includeOverlays ? rt(n, a.overlayBounds) : rt(n, a.bodyBounds)), t.includeLabels && (t.includeMainLabels && (!i || t.includeSourceLabels && t.includeTargetLabels) ? rt(n, a.labelBounds.all) : (t.includeMainLabels && rt(n, a.labelBounds.mainRot), t.includeSourceLabels && rt(n, a.labelBounds.sourceRot), t.includeTargetLabels && rt(n, a.labelBounds.targetRot))), n.w = n.x2 - n.x1, n.h = n.y2 - n.y1;
  }
  return n;
}, Da = {
  includeNodes: !0,
...
gt.boundingBox = function(r) {
  var e, t = r === void 0 || r.useCache === void 0 || r.useCache === !0, a = Yt(function(v) {
    var f = v._private;
    return f.bbCache == null || f.styleDirty || f.bbCachePosKey !== Wv(v);
  }, function(v) {
    return v.id();
  });
  if (t && this.length === 1 && !a(this[0]))
    r === void 0 ? r = Da : r = ul(r), e = sl(this[0], r);
  else {
    e = yr(), r = r || Da;
    var n = ul(r), i = this, s = i.cy(), o = s.styleEnabled();
    this.edges().forEach(a), this.nodes().forEach(a), o && this.recalculateRenderedStyle(t), this.updateCompoundBounds(!t);
    for (var u = 0; u < i.length; u++) {
      var l = i[u];
      a(l) && l.dirtyBoundingBoxCache(), rt(e, sl(l, n));
    }
  }
  return e.x1 = Dr(e.x1), e.y1 = Dr(e.y1), e.x2 = Dr(e.x2), e.y2 = Dr(e.y2), e.w = Dr(e.x2 - e.x1), e.h = Dr(e.y2 - e.y1), e;
};
...
pa = Fa = {};
var $v = function(e) {
  e.uppercaseName = Co(e.name), e.autoName = "auto" + e.uppercaseName, e.labelName = "label" + e.uppercaseName, e.outerName = "outer" + e.uppercaseName, e.uppercaseOuterName = Co(e.outerName), pa[e.name] = function() {
    ...
    if (a)
      if (s) {
        ...
        return 1;
  }, pa["outer" + e.uppercaseName] = function() {
    var a = this[0], n = a._private, i = n.cy, s = i._private.styleEnabled;
    if (a)
      if (s) {
        ...
        return 1;
  }, pa["rendered" + e.uppercaseName] = function() {
    var a = this[0];
    if (a) {
      var n = a[e.name]();
      return n * this.cy().zoom();
    }
  }, pa["rendered" + e.uppercaseOuterName] = function() {
    var a = this[0];
    if (a) {
      var n = a[e.outerName]();
      return n * this.cy().zoom();
...
var Ug = Fa, Kg = function(e, t) {
  if (e.isEdge() && e.takesUpSpace())
    return t(e);
}, Xg = function(e, t) {
  if (e.isEdge() && e.takesUpSpace()) {
    var a = e.cy();
    return Ln(t(e), a.zoom(), a.pan());
  }
}, Yg = function(e, t) {
  if (e.isEdge() && e.takesUpSpace()) {
...
}, tp = Object.keys(ll).reduce(function(r, e) {
  var t = ll[e], a = rp(e);
  return r[e] = function() {
...
Uv.prototype = {
  ...
  recycle: function(e, t) {
    if (this.isImmediatePropagationStopped = this.isPropagationStopped = this.isDefaultPrevented = va, e != null && e.preventDefault ? (this.type = e.type, this.isDefaultPrevented = e.defaultPrevented ? Ja : va) : e != null && e.type ? t = e : this.type = e, t != null && (this.originalEvent = t.originalEvent, this.type = t.type != null ? t.type : this.type, this.cy = t.cy, this.target = t.target, this.position = t.position, this.renderedPosition = t.renderedPosition, this.namespace = t.namespace, this.layout = t.layout), this.cy != null && this.position != null && this.renderedPosition == null) {
...
var Kv = /^([^.]+)(\.(?:[^.]+))?$/, np = ".*", Xv = {
  ...
  context: null
}, vl = Object.keys(Xv), ip = {};
function qn() {
  for (var r = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : ip, e = arguments.length > 1 ? arguments[1] : void 0, t = 0; t < vl.length; t++) {
    var a = vl[t];
    this[a] = r[a] || Xv[a];
  }
  this.context = e || this.context, this.listeners = [], this.emitting = 0;
}
var ct = qn.prototype, Yv = function(e, t, a, n, i, s, o) {
  $e(n) && (i = n, n = null), o && (s == null ? s = o : s = ye({}, s, o));
  ...
  return e.addEventFields(e.context, t), new Uv(t.type, t);
}, sp = function(e, t, a) {
  if (cc(a)) {
    t(e, a);
    return;
  ...
  for (var n = Ve(a) ? a : a.split(/\s+/), i = 0; i < n.length; i++) {
    ...
    if (!ot(s)) {
      var o = s.match(Kv);
      if (o) {
        var u = o[1], l = o[2] ? o[2] : null, v = fl(e, {
          type: u,
          namespace: l,
          target: e.context
        });
...
ct.on = ct.addListener = function(r, e, t, a, n) {
  return Yv(this, function(i, s, o, u, l, v, f) {
...
ct.removeListener = ct.off = function(r, e, t, a) {
  var n = this;
  this.emitting !== 0 && (this.listeners = Xc(this.listeners));
  for (var i = this.listeners, s = function(l) {
    var v = i[l];
    Yv(n, function(f, c, h, d, y, g) {
...
ct.emit = ct.trigger = function(r, e, t) {
  ...
  return this.emitting++, Ve(e) || (e = [e]), sp(this, function(i, s) {
    t != null && (a = [{
      event: s.event,
      type: s.type,
    ...
    for (var o = function() {
      var v = a[u];
      if (v.type === s.type && (!v.namespace || v.namespace === s.namespace || v.namespace === np) && i.eventMatches(i.context, v, s)) {
        var f = [s];
        e != null && Zc(f, e), i.beforeEmit(i.context, v, s), v.conf && v.conf.one && (i.listeners = i.listeners.filter(function(d) {
          return d !== v;
        }));
...
var op = {
  ...
  eventMatches: function(e, t, a) {
    var n = t.qualifier;
    return n != null ? e !== a.target && Ma(a.target) && n.matches(a.target) : !0;
  },
  ...
  return he(e) ? new vt(e) : e;
}, Zv = {
  createEmitter: function() {
    for (var e = 0; e < this.length; e++) {
      var t = this[e], a = t._private;
      a.emitter || (a.emitter = new qn(op, t));
    }
    return this;
  },
  emitter: function() {
  ...
  on: function(e, t, a) {
    for (var n = ja(t), i = 0; i < this.length; i++) {
      var s = this[i];
      s.emitter().on(e, n, a);
    }
    return this;
...
var up = {
  ...
  function i(v) {
    ...
    return f.value === "auto" ? n ? v.zDepth() : 0 : f.value === "bottom" ? -1 : f.value === "top" ? Zs : 0;
  }
  var s = i(e) - i(t);
  if (s !== 0)
    return s;
...
Cn.each = Cn.forEach;
var lp = function() {
  var e = "undefined", t = (typeof Symbol > "u" ? "undefined" : rr(Symbol)) != e && rr(Symbol.iterator) != e;
  t && (Cn[Symbol.iterator] = function() {
    var a = this, n = {
      value: void 0,
      done: !1
    }, i = 0, s = this.length;
...
var vp = vr({
  ...
  layoutPositions: function(e, t, a) {
    ...
    if (t.animate) {
      ...
      e.animations.forEach(function(E) {
        ...
        type: "layoutready",
        layout: e
      }), ea.all(e.animations.map(function(E) {
        return E.promise();
      })).then(function() {
  ...
  layout: function(e) {
    var t = this.cy();
    return t.makeLayout(ye({}, e, {
      eles: this
    }));
  }
};
ln.createLayout = ln.makeLayout = ln.layout;
function jv(r, e, t) {
...
function uo(r) {
  ...
  return function() {
    ...
    if (i) {
      ...
      return t(u) && (!s || ps(u, t)) && (u === l || t(l) && (!s || ps(l, t)));
    }
  };
}
var ra = _n("eleTakesUpSpace", function(r) {
  return r.pstyle("display").value === "element" && r.width() !== 0 && (r.isNode() ? r.height() !== 0 : !0);
});
ur.takesUpSpace = Gn("takesUpSpace", uo({
  ok: ra
}));
var fp = _n("eleInteractive", function(r) {
  return r.pstyle("events").value === "yes" && r.pstyle("visibility").value === "visible" && ra(r);
}), cp = _n("parentInteractive", function(r) {
  return r.pstyle("visibility").value === "visible" && ra(r);
});
ur.interactive = Gn("interactive", uo({
  ok: fp,
  parentOk: cp,
  edgeOkViaNode: ra
}));
ur.noninteractive = function() {
  var r = this[0];
  if (r)
    return !r.interactive();
};
var dp = _n("eleVisible", function(r) {
  return r.pstyle("visibility").value === "visible" && r.pstyle("opacity").pfValue !== 0 && ra(r);
}), hp = ra;
ur.visible = Gn("visible", uo({
  ok: dp,
  edgeOkViaNode: hp
}));
ur.hidden = function() {
...
ur.isBundledBezier = Gn("isBundledBezier", function() {
  return this.cy().styleEnabled() ? !this.removed() && this.pstyle("curve-style").value === "bezier" && this.takesUpSpace() : !1;
});
ur.bypass = ur.css = ur.style;
ur.renderedCss = ur.renderedStyle;
ur.removeBypass = ur.removeCss = ur.removeStyle;
ur.pstyle = ur.parsedStyle;
var st = {};
function cl(r) {
  return function() {
    var e = arguments, t = [];
...
ye(dr, {
  ...
  parallelEdges: Br(ml(), "parallelEdges"),
  codirectedEdges: Br(ml({
    codirected: !0
  }), "codirectedEdges")
});
function ml(r) {
...
var lr = function(e, t) {
  ...
  if (!t)
    t = [];
  else if (t.length > 0 && Me(t[0]) && !Ma(t[0])) {
    s = !0;
    for (var o = [], u = new jt(), l = 0, v = t.length; l < v; l++) {
      var f = t[l];
      f.data == null && (f.data = {});
      var c = f.data;
      if (c.id == null)
  ...
  this._private = {
    ...
    rebuildMap: function() {
      for (var b = this.lazyMap = new Kr(), w = this.eles, E = 0; E < w.length; E++) {
        var C = w[E];
        b.set(C.id(), {
          index: E,
          ele: C
...
}, _e = Mn.prototype = lr.prototype = Object.create(Array.prototype);
_e.instanceString = function() {
  return "collection";
};
_e.spawn = function(r, e) {
  return new lr(this.cy(), r, e);
};
...
_e.collection = function() {
  return jl(this) ? this : new lr(this._private.cy, [this]);
};
_e.unique = function() {
  return new lr(this._private.cy, this, !0);
};
...
_e.clone = function() {
  for (var r = this.cy(), e = [], t = 0; t < this.length; t++) {
    var a = this[t], n = a.json(), i = new Mn(r, n, !1);
    e.push(i);
  }
  return new lr(r, e);
};
...
_e.restore = function() {
  ...
  for (f = 0; f < o.length; f++) {
    ...
    if (h.clearTraversalCache(), !(!e && !d.removed)) {
      if (y.id === void 0)
        ...
        y.id = "" + y.id;
      else if (ot(y.id) || !he(y.id)) {
        He("Can not create element with invalid string ID `" + y.id + "`"), c();
        continue;
      } else if (a.hasElementWithId(y.id)) {
        He("Can not create second element with ID `" + y.id + "`"), c();
        continue;
      }
    }
    var g = y.id;
    ...
    if (h.isEdge()) {
      for (var m = h, b = ["source", "target"], w = b.length, E = !1, C = 0; C < w; C++) {
        var x = b[C], T = y[x];
        ae(T) && (T = y[x] = "" + y[x]), T == null || T === "" ? (He("Can not create edge `" + g + "` with unspecified " + x), E = !0) : a.hasElementWithId(T) || (He("Can not create edge `" + g + "` with nonexistent " + x + " `" + T + "`"), E = !0);
      }
      if (E) {
        c();
        continue;
      }
      var k = a.getElementById(y.source), D = a.getElementById(y.target);
      k.same(D) ? k._private.edges.push(m) : (k._private.edges.push(m), D._private.edges.push(m)), m._private.source = k, m._private.target = D;
    }
    d.map = new Kr(), d.map.set(g, {
      ele: h,
      index: 0
    }), d.removed = !1, e && a.addToPool(h);
  }
  for (var B = 0; B < i.length; B++) {
    var P = i[B], A = P._private.data;
    ...
    if (L || P._private.parent) {
      ...
      if (I.empty())
        ...
        ze("Node added with missing parent, reference to parent removed"), A.parent = void 0, P._private.parent = null;
      else {
  ...
  if (o.length > 0) {
    for (var q = o.length === t.length ? t : new lr(a, o), _ = 0; _ < q.length; _++) {
      var N = q[_];
      N.isNode() || (N.parallelEdges().clearTraversalCache(), N.source().clearTraversalCache(), N.target().clearTraversalCache());
    }
    var F;
    n.hasCompoundNodes ? F = a.collection().merge(q).merge(q.connectedNodes()).merge(q.parent()) : F = q, F.dirtyCompoundBoundsCache().dirtyBoundingBoxCache().updateStyle(r), r ? q.emitAndNotify("add") : e && q.emit("add");
  }
  return t;
};
_e.removed = function() {
...
_e.remove = function() {
  ...
  function y(R, L) {
    ...
    ut(I, L), L._private.parent = null, d.ids[M] || (d.ids[M] = !0, d.push(R));
  }
...
[Sv, Sg, un, it, Qt, _g, Vn, ap, Zv, Qv, up, Cn, ln, ur, st, dr].forEach(function(r) {
  ye(_e, r);
});
var gp = {
  add: function(e) {
    ...
    if (Tr(e)) {
      ...
      var u = e;
      t = new lr(a, u);
    } else if (Me(e) && (Ve(e.nodes) || Ve(e.edges))) {
...
function pp(r, e, t, a) {
  ...
  function w(D, B, P) {
    var A, R, L = 0;
    do
      R = B + (P - B) / 2, A = g(R, r, t) - D, A > 0 ? P = R : B = R;
    while (Math.abs(A) > s && ++L < o);
    return R;
  }
  function E(D) {
    for (var B = 0, P = 1, A = u - 1; P !== A && c[P] <= D; ++P)
      B += l;
    --P;
    var R = (D - c[P]) / (c[P + 1] - c[P]), L = B + R * l, I = p(L, r, t);
    return I >= i ? m(D, L) : I === 0 ? L : w(D, B, B + l);
  }
  var C = !1;
  function x() {
    C = !0, (r !== e || t !== a) && b();
...
function mp(r, e, t, a) {
  ...
  if (!s.easingImpl)
    if (o == null)
      ...
      if (he(o)) {
        ...
        f = o;
      var h, d;
      he(f) ? (h = f, d = []) : (h = f[1], d = f.slice(2).map(function(q) {
        return +q;
      })), d.length > 0 ? (h === "spring" && d.push(s.duration), s.easingImpl = vn[h].apply(null, d)) : s.easingImpl = vn[h];
    }
  ...
  if (s.duration === 0 ? g = 1 : g = (t - u) / s.duration, s.applying && (g = s.progress), g < 0 ? g = 0 : g > 1 && (g = 1), s.delay == null) {
    ...
    if (m && n && !r.locked()) {
      var b = {};
      fa(p.x, m.x) && (b.x = Ot(p.x, m.x, g, y)), fa(p.y, m.y) && (b.y = Ot(p.y, m.y, g, y)), r.position(b);
    }
    var w = s.startPan, E = s.pan, C = i.pan, x = E != null && a;
    x && (fa(w.x, E.x) && (C.x = Ot(w.x, E.x, g, y)), fa(w.y, E.y) && (C.y = Ot(w.y, E.y, g, y)), r.emit("pan"));
    var T = s.startZoom, k = s.zoom, D = k != null && a;
    D && (fa(T, k) && (i.zoom = Ta(i.minZoom, Ot(T, k, g, y), i.maxZoom)), r.emit("zoom")), (x || D) && r.emit("viewport");
    var B = s.style;
    if (B && B.length > 0 && n) {
      for (var P = 0; P < B.length; P++) {
        var A = B[P], R = A.name, L = A, I = s.startStyle[R], M = v.properties[I.name], O = Ot(I, L, g, y, M);
...
function xl(r, e) {
  ...
  function n(v, f) {
    ...
    for (var p = function(C) {
      ...
      !w.playing && !w.applying || (w.playing && w.applying && (w.applying = !1), w.started || bp(v, b, r), mp(v, b, r, f), w.applying && (w.applying = !1), p(w.frames), w.step != null && w.step(r), b.completed() && (h.splice(m, 1), w.hooked = !1, w.playing = !1, w.started = !1, p(w.completes)), y = !0);
    }
...
var wp = {
  ...
  startAnimationLoop: function() {
    ...
    if (e._private.animationsRunning = !0, !e.styleEnabled())
      return;
    function t() {
      e._private.animationsRunning && mn(function(i) {
        xl(i, e), t();
      });
    }
    var a = e.renderer();
  ...
  createEmitter: function() {
    var e = this._private;
    return e.emitter || (e.emitter = new qn(xp, this)), this;
  },
  emitter: function() {
    return this._private.emitter;
  },
  on: function(e, t, a) {
    return this.emitter().on(e, en(t), a), this;
  },
  removeListener: function(e, t, a) {
    return this.emitter().removeListener(e, en(t), a), this;
  },
  removeAllListeners: function() {
    return this.emitter().removeAllListeners(), this;
  },
  one: function(e, t, a) {
    return this.emitter().one(e, en(t), a), this;
  },
  once: function(e, t, a) {
    return this.emitter().one(e, en(t), a), this;
  },
...
var Ep = {
  ...
  initRenderer: function(e) {
    ...
    e.wheelSensitivity !== void 0 && ze("You have set a custom wheel sensitivity.  This will make your app zoom unnaturally when using mainstream mice.  You should change this value from the default only if you can guarantee that all your users will use the same hardware and OS configuration as your current machine.");
    var n = Cp(e);
...
Ns.invalidateDimensions = Ns.resize;
var cn = {
  // get a collection
  ...
  collection: function(e, t) {
    return he(e) ? this.$(e) : Tr(e) ? e.collection() : Ve(e) ? (t || (t = {}), new lr(this, e, t.unique, t.removed)) : new lr(this);
  },
  nodes: function(e) {
...
sr.getPropertiesDiff = function(r, e) {
  ...
  if (i)
    return i;
  for (var s = [], o = {}, u = 0; u < t.length; u++) {
    var l = t[u], v = r[u] === ma, f = e[u] === ma, c = v !== f, h = l.mappedProperties.length > 0;
    if (c || f && h) {
      var d = void 0;
...
sr.updateStyleHints = function(r) {
  var e = r._private, t = this, a = t.propertyGroupNames, n = t.propertyGroupKeys, i = function(W, Y, te) {
    return t.getPropertiesHash(W, Y, te);
  }, s = e.styleKey;
  if (r.removed())
    return !1;
  ...
  for (var f = function(W, Y) {
    return e.styleKeys[Y][0] = xa(W, e.styleKeys[Y][0]);
  }, c = function(W, Y) {
    return e.styleKeys[Y][1] = Ea(W, e.styleKeys[Y][1]);
  }, h = function(W, Y) {
    f(W, Y), c(W, Y);
  }, d = function(W, Y) {
    for (var te = 0; te < W.length; te++) {
      var ce = W.charCodeAt(te);
      f(ce, Y), c(ce, Y);
    }
  }, y = 2e9, g = function(W) {
    return -128 < W && W < 128 && Math.floor(W) !== W ? y - (W * 1024 | 0) : W;
  }, p = 0; p < a.length; p++) {
    var m = a[p], b = u[m];
    if (b != null) {
      ...
      var T = w.enums == null ? b.value : null, k = x != null, D = T != null, B = k || D, P = b.units;
  ...
  for (var R = [Ct, _t], L = 0; L < n.length; L++) {
    var I = n[L], M = e.styleKeys[I];
    R[0] = xa(M[0], R[0]), R[1] = Ea(M[1], R[1]);
  }
  e.styleKey = qc(R[0], R[1]);
  var O = e.styleKeys;
  e.labelDimsKey = jr(O.labelDimensions);
  var q = i(r, ["label"], O.labelDimensions);
  if (e.labelKey = jr(q), e.labelStyleKey = jr(Ua(O.commonLabel, q)), !o) {
    var _ = i(r, ["source-label"], O.labelDimensions);
    e.sourceLabelKey = jr(_), e.sourceLabelStyleKey = jr(Ua(O.commonLabel, _));
    var N = i(r, ["target-label"], O.labelDimensions);
    e.targetLabelKey = jr(N), e.targetLabelStyleKey = jr(Ua(O.commonLabel, N));
  }
  if (o) {
    var F = e.styleKeys, U = F.nodeBody, J = F.nodeBorder, Z = F.nodeOutline, j = F.backgroundImage, re = F.compound, ne = F.pie, Q = F.stripe, V = [U, J, Z, j, re, ne, Q].filter(function(H) {
      return H != null;
    }).reduce(Ua, [Ct, _t]);
    e.nodeKey = jr(V), e.hasPie = ne != null && ne[0] !== Ct && ne[1] !== _t, e.hasStripe = Q != null && Q[0] !== Ct && Q[1] !== _t;
  }
  return s !== e.styleKey;
};
...
sr.applyParsedProperty = function(r, e) {
  var t = this, a = e, n = r._private.style, i, s = t.types, o = t.properties[a.name].type, u = a.bypass, l = n[a.name], v = l && l.bypass, f = r._private, c = "mapping", h = function(U) {
    return U == null ? null : U.pfValue != null ? U.pfValue : U.value;
  }, d = function() {
    var U = h(l), J = h(a);
    t.checkTriggers(r, a.name, U, J);
  };
  ...
  var y = function() {
    ze("Do not assign mappings to elements without corresponding data (i.e. ele `" + r.id() + "` has no mapping for property `" + a.name + "` with data field `" + a.field + "`); try a `[" + a.field + "]` selector to limit scope to elements with `" + a.field + "` defined");
  };
  switch (a.mapped) {
    ...
    case s.mapData: {
      ...
      if (ae(p)) {
        ...
        return ze("Do not use continuous mappers without specifying numeric data (i.e. `" + a.field + ": " + p + "` for `" + r.id() + "` is non-numeric)"), !1;
      if (w < 0 ? w = 0 : w > 1 && (w = 1), o.color) {
        var C = a.valueMin[0], x = a.valueMax[0], T = a.valueMin[1], k = a.valueMax[1], D = a.valueMin[2], B = a.valueMax[2], P = a.valueMin[3] == null ? 1 : a.valueMin[3], A = a.valueMax[3] == null ? 1 : a.valueMax[3], R = [Math.round(C + (x - C) * w), Math.round(T + (k - T) * w), Math.round(D + (B - D) * w), Math.round(P + (A - P) * w)];
        i = {
    ...
    case s.fn: {
      ...
      if (a.prevFnValue = N, N == null)
        return ze("Custom function mappers may not return null (i.e. `" + a.name + "` for ele `" + r.id() + "` is null)"), !1;
      if (i = this.parse(a.name, N, a.bypass, c), !i)
        return ze("Custom function mappers may not return invalid values for the property type (i.e. `" + a.name + "` for ele `" + r.id() + "` is invalid)"), !1;
      i.mapping = qr(a), a = i;
      break;
    }
    case void 0:
  ...
  if (n.length > 0 && i > 0) {
    for (var o = {}, u = !1, l = 0; l < n.length; l++) {
      ...
      if (c) {
        ...
        d && (ae(d.pfValue) && ae(y.pfValue) ? (g = y.pfValue - d.pfValue, p = d.pfValue + m * g) : ae(d.value) && ae(y.value) ? (g = y.value - d.value, p = d.value + m * g) : Ve(d.value) && Ve(y.value) && (g = d.value[0] !== y.value[0] || d.value[1] !== y.value[1] || d.value[2] !== y.value[2], p = d.strValue), g && (o[v] = y.strValue, this.applyBypass(r, v, p), u = !0));
      }
    }
    if (!u)
      return;
    a.transitioning = !0, new ea(function(b) {
...
var Va = {};
Va.applyBypass = function(r, e, t, a) {
  var n = this, i = [], s = !0;
  if (e === "*" || e === "**") {
    if (t !== void 0)
...
Va.overrideBypass = function(r, e, t) {
  e = Xs(e);
...
Va.removeAllBypasses = function(r, e) {
  return this.removeBypasses(r, this.propertyNames, e);
};
Va.removeBypasses = function(r, e, t) {
...
_r.getRawStyle = function(r, e) {
  ...
  if (r = r[0], r) {
    for (var a = {}, n = 0; n < t.properties.length; n++) {
      ...
      s != null && (a[i.name] = s, a[An(i.name)] = s);
    }
    return a;
  }
};
...
_r.getPropsList = function(r) {
  ...
  if (a)
    for (var i = Object.keys(a), s = 0; s < i.length; s++) {
      var o = i[s], u = a[o], l = n[o] || n[Xs(o)], v = this.parse(l.name, u);
      v && t.push(v);
    }
  return t;
};
_r.getNonDefaultPropertiesHash = function(r, e, t) {
  ...
  for (u = 0; u < e.length; u++)
    if (n = e[u], i = r.pstyle(n, !1), i != null)
      if (i.pfValue != null)
        a[0] = xa(o, a[0]), a[1] = Ea(o, a[1]);
      else
        for (s = i.strValue, l = 0; l < s.length; l++)
          o = s.charCodeAt(l), a[0] = xa(o, a[0]), a[1] = Ea(o, a[1]);
  return a;
};
_r.getPropertiesHash = _r.getNonDefaultPropertiesHash;
var Hn = {};
Hn.appendFromJson = function(r) {
...
var vo = {};
vo.appendFromString = function(r) {
  ...
  for (; ; ) {
    ...
    if (!v) {
      ze("Halting stylesheet parsing: String stylesheet contains more to parse but no selector and block found in: " + a);
      break;
    }
    n = v[0];
    var f = v[1];
    if (f !== "core") {
      var c = new vt(f);
      if (c.invalid) {
        ze("Skipping parsing of block: Invalid selector found in string stylesheet: " + f), o();
        continue;
      }
    }
    var h = v[2], d = !1;
    ...
    for (var y = []; ; ) {
      ...
      if (!p) {
        ze("Skipping parsing of block: Invalid formatting of style property and value definitions found in:" + h), d = !0;
        break;
      }
      s = p[0];
      var m = p[1], b = p[2], w = e.properties[m];
      if (!w) {
        ze("Skipping property: Invalid property name in: " + s), u();
        continue;
      }
      var E = t.parse(m, b);
      if (!E) {
        ze("Skipping property: Invalid property definition in: " + s), u();
        continue;
      }
      y.push({
        name: m,
...
vo.fromString = function(r) {
  var e = this;
  return e.resetToDefault(), e.appendFromString(r), e;
};
var Ze = {};
(function() {
  var r = er, e = mc, t = wc, a = xc, n = Ec, i = function(H) {
    return "^" + H + "\\s*\\(\\s*([\\w\\.]+)\\s*\\)$";
  }, s = function(H) {
    var W = r + "|\\w+|" + e + "|" + t + "|" + a + "|" + n;
    return "^" + H + "\\s*\\(([\\w\\.]+)\\s*\\,\\s*(" + r + ")\\s*\\,\\s*(" + r + ")\\s*,\\s*(" + W + ")\\s*\\,\\s*(" + W + ")\\)$";
  }, o = [`^url\\s*\\(\\s*['"]?(.+?)['"]?\\s*\\)$`, "^(none)$", "^(.+)$"];
  Ze.types = {
    time: {
      number: !0,
    ...
    edgeEndpoint: {
      ...
      singleEnum: !0,
      validate: function(H, W) {
        switch (H.length) {
          case 2:
            return W[0] !== "deg" && W[0] !== "rad" && W[1] !== "deg" && W[1] !== "rad";
          case 1:
            return he(H[0]) || W[0] === "deg" || W[0] === "rad";
          default:
            return !1;
        }
      }
  ...
  var u = {
    zeroNonZero: function(H, W) {
      return (H == null || W == null) && H !== W || H == 0 && W != 0 ? !0 : H != 0 && W == 0;
    },
    any: function(H, W) {
      return H != W;
    },
    emptyNonEmpty: function(H, W) {
      var Y = ot(H), te = ot(W);
      return Y && !te || !Y && te;
    }
  }, l = Ze.types, v = [{
    ...
    triggersBoundsOfParallelEdges: function(H, W, Y) {
      return H === W ? !1 : Y.pstyle("curve-style").value === "bezier";
    }
  }, {
    name: "visibility",
    type: l.visibility,
    ...
    return W.value === "label" ? -H.poolIndex() : W.pfValue;
  }, E = [{
    name: "height",
    type: l.nodeSize,
    triggersBounds: u.any,
    ...
    type: l.curveStyle,
    triggersBounds: u.any,
    triggersBoundsOfParallelEdges: function(H, W) {
      return H === W ? !1 : H === "bezier" || // remove from bundle
      W === "bezier";
    }
  }, {
  ...
  for (var R = 1; R <= Ze.pieBackgroundN; R++)
    A.push({
  ...
  var L = [];
  Ze.stripeBackgroundN = 16, L.push({
    name: "stripe-size",
    type: l.sizeMaybePercent
  }), L.push({
  ...
  for (var I = 1; I <= Ze.stripeBackgroundN; I++)
    L.push({
  ...
  var M = [], O = Ze.arrowPrefixes = ["source", "mid-source", "target", "mid-target"];
  [{
    name: "arrow-shape",
    type: l.arrowShape,
    triggersBounds: u.any
    ...
    O.forEach(function(H) {
      var W = H + "-" + V.name, Y = V.type, te = V.triggersBounds;
      M.push({
        name: W,
        type: Y,
        triggersBounds: te
  ...
  var q = Ze.properties = [].concat(y, b, g, p, m, B, d, h, v, f, c, E, C, x, T, A, L, k, D, M, P), _ = Ze.propertyGroups = {
    // common to all eles
    behavior: y,
    transition: b,
    visibility: g,
    ...
    edgeArrow: M,
    core: P
  }, N = Ze.propertyGroupNames = {}, F = Ze.propertyGroupKeys = Object.keys(_);
  F.forEach(function(V) {
    N[V] = _[V].map(function(H) {
      return H.name;
  ...
  Ze.propertyNames = q.map(function(V) {
    return V.name;
  });
  ...
  for (var j = 0; j < U.length; j++) {
    var re = U[j], ne = q[re.pointsTo], Q = {
      name: re.name,
      alias: !0,
      pointsTo: ne
    };
    q.push(Q), q[re.name] = Q;
  }
})();
Ze.getDefaultProperty = function(r) {
...
Ze.getDefaultProperties = function() {
  ...
  for (var e = ye({
    ...
    for (var v = 1; v <= Ze.pieBackgroundN; v++) {
    ...
    for (var v = 1; v <= Ze.stripeBackgroundN; v++) {
      var f = l.name.replace("{{i}}", v), c = l.value;
      u[f] = c;
    }
    return u;
    ...
    return Ze.arrowPrefixes.forEach(function(v) {
...
var Wn = {};
Wn.parse = function(r, e, t, a) {
  var n = this;
  if ($e(e))
    return n.parseImplWarn(r, e, t, a);
  var i = a === "mapping" || a === !0 || a === !1 || a == null ? "dontcare" : a, s = t ? "t" : "f", o = "" + e, u = vv(r, o, s, i), l = n.propCache = n.propCache || [], v;
  return (v = l[u]) || (v = l[u] = n.parseImplWarn(r, e, t, a)), (t || a === "mapping") && (v = qr(v), v && (v.value = qr(v.value))), v;
};
Wn.parseImplWarn = function(r, e, t, a) {
  var n = this.parseImpl(r, e, t, a);
  return !n && e != null && ze("The style property `".concat(r, ": ").concat(e, "` is invalid")), n && (n.name === "width" || n.name === "height") && e === "label" && ze("The style value of `label` is deprecated for `" + n.name + "`"), n;
};
Wn.parseImpl = function(r, e, t, a) {
  var n = this;
  r = Xs(r);
  ...
  if (!(!u || a || e.length < 7 || e[1] !== "a")) {
    if (e.length >= 7 && e[0] === "d" && (v = new RegExp(o.data.regex).exec(e))) {
      ...
      if (d.pfValue === y.pfValue || d.strValue === y.strValue)
        return ze("`" + r + ": " + e + "` is not a valid mapper because the output range is zero; converting to `" + r + ": " + d.strValue + "`"), this.parse(r, d.strValue);
      if (l.color) {
  ...
  if (l.multiple && a !== "multiple") {
    var b;
    if (u ? b = e.split(/\s+/) : Ve(e) ? b = e : b = [e], l.evenMultiple && b.length % 2 !== 0)
      return null;
    for (var w = [], E = [], C = [], x = "", T = !1, k = 0; k < b.length; k++) {
      var D = n.parse(r, b[k], t, "multiple");
      T = T || he(D.value), w.push(D.value), C.push(D.pfValue != null ? D.pfValue : D.value), E.push(D.units), x += (k > 0 ? " " : "") + D.strValue;
    }
  ...
  if (l.number) {
    ...
    if (isNaN(e) && l.enums !== void 0)
      return e = s, B();
    if (l.integer && !fc(e) || l.min !== void 0 && (e < l.min || l.strictMin && e === l.min) || l.max !== void 0 && (e > l.max || l.strictMax && e === l.max))
      return null;
    var I = {
      name: r,
      value: e,
    ...
    return l.unitless || P !== "px" && P !== "em" ? I.pfValue = e : I.pfValue = P === "px" || !P ? e : this.getEmSizeInPixels() * e, (P === "ms" || P === "s") && (I.pfValue = P === "ms" ? e : 1e3 * e), (P === "deg" || P === "rad") && (I.pfValue = P === "rad" ? e : xd(e)), P === "%" && (I.pfValue = e / 100), I;
  } else if (l.propList) {
    var M = [], O = "" + e;
    if (O !== "none") {
      for (var q = O.split(/\s*,\s*|\s+/), _ = 0; _ < q.length; _++) {
        var N = q[_].trim();
        n.properties[N] ? M.push(N) : ze("`" + N + "` is not a valid property name");
      }
      if (M.length === 0)
        return null;
    }
    ...
    for (var J = l.regexes ? l.regexes : [l.regex], Z = 0; Z < J.length; Z++) {
      var j = new RegExp(J[Z]), re = j.exec(e);
      if (re)
        return {
          name: r,
...
hr.append = function(r) {
  return ev(r) ? r.appendToStyle(this) : Ve(r) ? this.appendFromJson(r) : he(r) && this.appendFromString(r), this;
};
...
[sr, Va, lo, _r, Hn, vo, Ze, Wn].forEach(function(r) {
  ye(hr, r);
});
ir.types = hr.types;
ir.properties = hr.properties;
ir.propertyGroups = hr.propertyGroups;
ir.propertyGroupNames = hr.propertyGroupNames;
ir.propertyGroupKeys = hr.propertyGroupKeys;
var Sp = {
  style: function(e) {
    if (e) {
  ...
  setStyle: function(e) {
    var t = this._private;
    return ev(e) ? t.style = e.generateStyle(this) : Ve(e) ? t.style = ir.fromJson(this, e) : he(e) ? t.style = ir.fromString(this, e) : t.style = ir(this), t.style;
  },
  ...
  selectionType: function(e) {
    var t = this._private;
    if (t.selectionType == null && (t.selectionType = kp), e !== void 0)
  ...
  getZoomedViewport: function(e) {
    ...
    if (t.zoomingEnabled || (o = !0), ae(e) ? s = e : Me(e) && (s = e.level, e.position != null ? i = Ln(e.position, n, a) : e.renderedPosition != null && (i = e.renderedPosition), i != null && !t.panningEnabled && (o = !0)), s = s > t.maxZoom ? t.maxZoom : s, s = s < t.minZoom ? t.minZoom : s, o || !ae(s) || s === n || i != null && (!ae(i.x) || !ae(i.y)))
      return null;
    if (i != null) {
      var u = a, l = n, v = s, f = {
        x: -v / l * (i.x - u.x) + i.x,
...
var Pa = function(e) {
  ...
  a && (a._cyreg = n), n.cy = t;
  var s = je !== void 0 && a !== void 0 && !e.headless, o = e;
  o.layout = ye({
    name: s ? "grid" : "null"
  }, o.layout), o.renderer = ye({
    name: s ? "canvas" : "null"
  }, o.renderer);
...
ye(Tn, {
  ...
  mount: function(e) {
    if (e != null) {
      ...
      return !yn(e) && yn(e[0]) && (e = e[0]), t.stopAnimationLoop(), t.destroyRenderer(), a.container = e, a.styleEnabled = !0, t.invalidateSize(), t.initRenderer(ye({}, n, n.renderer, {
      ...
      if (t.startBatch(), e.elements) {
        var s = {}, o = function(w, E) {
          for (var C = [], x = [], T = 0; T < w.length; T++) {
            var k = w[T];
            if (!k.data.id) {
              ze("cy.json() cannot handle elements without an ID attribute");
              continue;
            }
            var D = "" + k.data.id, B = t.getElementById(D);
            s[D] = !0, B.length !== 0 ? x.push({
              ele: B,
              json: k
...
Tn.$id = Tn.getElementById;
[gp, wp, ef, Os, fn, Ep, Ns, cn, Sp, Pt, Ba].forEach(function(r) {
  ye(Tn, r);
});
var Dp = {
  fit: !0,
...
function rf(r) {
  this.options = ye({}, Dp, Bp, r);
}
rf.prototype.run = function() {
  var r = this.options, e = r.cy, t = r.eles, a = t.nodes().filter(function(ge) {
    return ge.isChildless();
  ...
  if (Tr(r.roots))
    ...
    l = e.collection();
    for (var y = function() {
      var se = d[g], de = se.maxDegree(!1), fe = se.filter(function(xe) {
        return xe.degree(!1) === de;
      });
      l = l.add(fe);
    }, g = 0; g < d.length; g++)
      y();
  ...
  var p = [], m = {}, b = function(se, de) {
    ...
    var fe = Nt(se), xe = fe.depth, be = fe.index;
    p[xe][be] = null, se.isChildless() && b(se, de);
  };
  n.bfs({
    roots: l,
    directed: r.directed,
    visit: function(se, de, fe, xe, be) {
      var Se = se[0], De = Se.id();
      Se.isChildless() && b(Se, be), m[De] = !0;
    }
  });
  ...
  var T = function(se) {
    for (var de = p[se], fe = 0; fe < de.length; fe++) {
      var xe = de[fe];
      if (xe == null) {
        de.splice(fe, 1), fe--;
        continue;
    ...
    for (var fe = Nt(se), xe = se.incomers().filter(function(X) {
      return X.isNode() && t.has(X);
    }), be = -1, Se = se.id(), De = 0; De < xe.length; De++) {
      var Oe = xe[De], Le = Nt(Oe);
    ...
    if (fe.depth <= be) {
      if (!r.acyclic && de[Se])
        return null;
      var Ae = be + 1;
      return w(se, Ae), de[Se] = Ae, !0;
    }
    return !1;
  };
  if (i && s) {
    var D = [], B = {}, P = function(se) {
      return D.push(se);
    }, A = function() {
      return D.shift();
    };
    for (a.forEach(function(ge) {
      return D.push(ge);
    }); D.length > 0; ) {
      var R = A(), L = k(R, B);
      if (L)
        R.outgoers().filter(function(ge) {
          return ge.isNode() && t.has(ge);
        }).forEach(P);
      else if (L === null) {
        ze("Detected double maximal shift for node `" + R.id() + "`.  Bailing maximal adjustment due to cycle.  Use `options.maximal: true` only on DAGs.");
        break;
      }
    }
  }
  ...
  if (r.avoidOverlap)
    for (var M = 0; M < a.length; M++) {
      var O = a[M], q = O.layoutDimensions(r), _ = q.w, N = q.h;
      I = Math.max(I, _, N);
    }
  var F = {}, U = function(se) {
    if (F[se.id()])
      return F[se.id()];
    for (var de = Nt(se).depth, fe = se.neighborhood(), xe = 0, be = 0, Se = 0; Se < fe.length; Se++) {
      var De = fe[Se];
      if (!(De.isEdge() || De.isParent() || !a.has(De))) {
        var Oe = Nt(De);
        if (Oe != null) {
          var Le = Oe.index, Ae = Oe.depth;
          if (!(Le == null || Ae == null)) {
            var X = p[Ae].length;
            Ae < de && (xe += Le / X, be++);
          }
    ...
    return be = Math.max(1, be), xe = xe / be, be === 0 && (xe = 0), F[se.id()] = xe, xe;
  }, J = function(se, de) {
    var fe = U(se), xe = U(de), be = fe - xe;
    return be === 0 ? tv(se.id(), de.id()) : be;
  };
  r.depthSort !== void 0 && (J = r.depthSort);
  for (var Z = p.length, j = 0; j < Z; j++)
    p[j].sort(J), T(j);
  for (var re = [], ne = 0; ne < E.length; ne++)
    re.push(E[ne]);
  var Q = function() {
    for (var se = 0; se < Z; se++)
      T(se);
  };
  re.length && (p.unshift(re), Z = p.length, Q());
  for (var V = 0, H = 0; H < Z; H++)
    V = Math.max(p[H].length, V);
  var W = {
    x: u.x1 + u.w / 2,
    y: u.y1 + u.h / 2
  }, Y = a.reduce(function(ge, se) {
    return (function(de) {
      return {
        w: ge.w === -1 ? de.w : (ge.w + de.w) / 2,
        h: ge.h === -1 ? de.h : (ge.h + de.h) / 2
      };
    })(se.boundingBox({
    ...
    Z === 1 ? 0 : (
      ...
      o ? (u.h - r.padding * 2 - Y.h) / (Z - 1) : (u.h - r.padding * 2 - Y.h) / (Z + 1)
    ),
    I
  ), ce = p.reduce(function(ge, se) {
    return Math.max(ge, se.length);
  }, 0), Be = function(se) {
    var de = Nt(se), fe = de.depth, xe = de.index;
    if (r.circle) {
      var be = Math.min(u.w / 2 / Z, u.h / 2 / Z);
      be = Math.max(be, I);
      var Se = be * fe + be - (Z > 0 && p[0].length <= 3 ? be / 2 : 0), De = 2 * Math.PI / p[fe].length * xe;
      return fe === 0 && p[0].length === 1 && (Se = 1), {
        x: W.x + Se * Math.cos(De),
        y: W.y + Se * Math.sin(De)
      };
    } else {
      var Oe = p[fe].length, Le = Math.max(
        // only one depth
        Oe === 1 ? 0 : (
          // inside a bounding box, no need for left & right padding
          o ? (u.w - r.padding * 2 - Y.w) / ((r.grid ? ce : Oe) - 1) : (u.w - r.padding * 2 - Y.w) / ((r.grid ? ce : Oe) + 1)
        ),
        I
      ), Ae = {
        x: W.x + (xe + 1 - (Oe + 1) / 2) * Le,
        y: W.y + (fe + 1 - (Z + 1) / 2) * te
      };
      return Ae;
    }
  ...
  Object.keys(we).indexOf(r.direction) === -1 && He("Invalid direction '".concat(r.direction, "' specified for breadthfirst layout. Valid values are: ").concat(Object.keys(we).join(", ")));
  var me = function(se) {
    return Wc(Be(se), u, we[r.direction]);
  };
  return t.nodes().layoutPositions(this, r, me), this;
};
var Pp = {
  fit: !0,
  // whether to fit the viewport to the graph
...
tf.prototype.run = function() {
  ...
  var w = function(C, x) {
    var T = e.startAngle + x * l * (n ? 1 : -1), k = v * Math.cos(T), D = v * Math.sin(T), B = {
      x: o.x + k,
      y: o.y + D
    };
    return B;
...
af.prototype.run = function() {
  ...
  for (var D = 0, B = 0; B < p.length; B++) {
    var P = p[B], A = e.sweep === void 0 ? 2 * Math.PI - 2 * Math.PI / P.length : e.sweep, R = P.dTheta = A / Math.max(1, P.length - 1);
  ...
  if (e.equidistant) {
    for (var O = 0, q = 0, _ = 0; _ < p.length; _++) {
      var N = p[_], F = N.r - q;
      O = Math.max(O, F);
    }
    q = 0;
  ...
  for (var Z = {}, j = 0; j < p.length; j++)
    for (var re = p[j], ne = re.dTheta, Q = re.r, V = 0; V < re.length; V++) {
      var H = re[V], W = e.startAngle + (t ? 1 : -1) * ne * V, Y = {
        x: o.x + Q * Math.cos(W),
        y: o.y + Q * Math.sin(W)
      };
      Z[H.node.id()] = Y;
...
function $n(r) {
  this.options = ye({}, Rp, r), this.options.layout = this;
...
$n.prototype.run = function() {
  ...
  var a = Mp(e, t, r);
  ys && Ip(a), r.randomize && Op(a);
  var n = Xr(), i = function() {
    Np(a, e, r), r.fit === !0 && e.fit(r.padding);
  }, s = function(c) {
    return !(t.stopped || c >= r.numIter || (zp(a, r), a.temperature = a.temperature * r.coolingFactor, a.temperature < r.minTemp));
  }, o = function() {
  ...
  if (r.animate === !0) {
    var v = function() {
      ...
      if (!l)
        ...
        var h = Xr();
        h - n >= r.animationThreshold && i(), mn(v);
      }
    };
    v();
  } else {
...
var Mp = function(e, t, a) {
  ...
  for (var v = 0; v < o.nodeSize; v++) {
    ...
    g.isLocked = d.locked(), g.id = d.data("id"), g.parentId = d.data("parent"), g.cmptId = l[d.id()], g.children = [], g.positionX = d.position("x"), g.positionY = d.position("y"), g.offsetX = 0, g.offsetY = 0, g.height = y.w, g.width = y.h, g.maxX = g.positionX + g.width / 2, g.minX = g.positionX - g.width / 2, g.maxY = g.positionY + g.height / 2, g.minY = g.positionY - g.height / 2, g.padLeft = parseFloat(d.style("padding")), g.padRight = parseFloat(d.style("padding")), g.padTop = parseFloat(d.style("padding")), g.padBottom = parseFloat(d.style("padding")), g.nodeRepulsion = $e(a.nodeRepulsion) ? a.nodeRepulsion(d) : a.nodeRepulsion, o.layoutNodes.push(g), o.idToIndex[g.id] = v;
  }
  ...
  for (var v = 0; v < o.edgeSize; v++) {
    ...
    var A = $e(a.idealEdgeLength) ? a.idealEdgeLength(B) : a.idealEdgeLength, R = $e(a.edgeElasticity) ? a.edgeElasticity(B) : a.edgeElasticity, L = o.idToIndex[P.sourceId], I = o.idToIndex[P.targetId], M = o.indexToGraph[L], O = o.indexToGraph[I];
    if (M != O) {
      for (var q = Lp(P.sourceId, P.targetId, o), _ = o.graphSet[q], N = 0, g = o.layoutNodes[L]; _.indexOf(g.id) === -1; )
  ...
  for (var s = 0, o = 0; o < i.length; o++) {
    ...
    if (v.length !== 0) {
      var f = n.indexToGraph[n.idToIndex[v[0]]], c = nf(e, t, f, n);
      if (c.count !== 0)
        if (c.count === 1) {
          if (s++, s === 2)
            break;
  ...
  var n = a.layout, i = a.eles.nodes(), s = sf(e, a, i);
  i.positions(s), e.ready !== !0 && (e.ready = !0, n.one("layoutready", a.ready), n.emit({
    type: "layoutready",
    layout: this
  }));
}, zp = function(e, t, a) {
  Fp(e, t), _p(e), Gp(e, t), Hp(e), Wp(e);
}, Fp = function(e, t) {
  ...
  if (!(i !== s && !a.isCompound)) {
    ...
    o === 0 && u === 0 && (o = Cl(l), u = Cl(l));
    var v = qp(e, t, o, u);
    if (v > 0)
      var f = n.nodeOverlap * v, c = Math.sqrt(o * o + u * u), h = f * o / c, d = f * u / c;
    else
      var y = Sn(e, o, u), g = Sn(t, -1 * o, -1 * u), p = g.x - y.x, m = g.y - y.y, b = p * p + m * m, c = Math.sqrt(b), f = (e.nodeRepulsion + t.nodeRepulsion) / b, h = f * p / c, d = f * m / c;
  ...
  for (var a = 0; a < e.edgeSize; a++) {
    ...
    if (!(l === 0 && v === 0)) {
      var f = Sn(s, l, v), c = Sn(u, -1 * l, -1 * v), h = c.x - f.x, d = c.y - f.y, y = Math.sqrt(h * h + d * d), g = Math.pow(n.idealLength - y, 2) / n.elasticity;
      if (y !== 0)
        var p = g * h / y, m = g * d / y;
      else
        var p = 0, m = 0;
  ...
  for (var a = 0; a < e.nodeSize; a++) {
    ...
    if (!(0 < n.children.length || n.isLocked)) {
      var i = $p(n.offsetX, n.offsetY, e.temperature);
      n.positionX += i.x, n.positionY += i.y, n.offsetX = 0, n.offsetY = 0, n.minX = n.positionX - n.width, n.maxX = n.positionX + n.width, n.minY = n.positionY - n.height, n.maxY = n.positionY + n.height, of(n, e);
    }
  }
  for (var a = 0; a < e.nodeSize; a++) {
    var n = e.layoutNodes[a];
...
uf.prototype.run = function() {
  ...
  if (i.h === 0 || i.w === 0)
    ...
    var s = n.size(), o = Math.sqrt(s * i.h / i.w), u = Math.round(o), l = Math.round(i.w / i.h * o), v = function(J) {
      if (J == null)
        return Math.min(u, l);
      var Z = Math.min(u, l);
      Z == u ? u = J : l = J;
    ...
    if (e.condense && (m = 0, b = 0), e.avoidOverlap)
      for (var w = 0; w < n.length; w++) {
        ...
        var x = E.layoutDimensions(e), T = e.avoidOverlapPadding, k = x.w + T, D = x.h + T;
        m = Math.max(m, k), b = Math.max(b, D);
      }
    for (var B = {}, P = function(J, Z) {
      return !!B["c-" + J + "-" + Z];
    }, A = function(J, Z) {
      B["c-" + J + "-" + Z] = !0;
    }, R = 0, L = 0, I = function() {
    ...
    var F = function(J, Z) {
      ...
      var ne = M[J.id()];
      if (ne)
        j = ne.col * m + m / 2 + i.x1, re = ne.row * b + b / 2 + i.y1;
      else {
        for (; P(R, L); )
          I();
...
var co = {};
co.arrowShapeWidth = 0.3;
co.registerArrowShapes = function() {
...
Rt.findNearestElements = function(r, e, t, a) {
  ...
  function p(x) {
    var T = x.outerWidth() + 2 * f, k = x.outerHeight() + 2 * f, D = T / 2, B = k / 2, P = x.position(), A = x.pstyle("corner-radius").value === "auto" ? "auto" : x.pstyle("corner-radius").pfValue, R = x._private.rscratch;
  ...
  function m(x) {
    var T = x._private, k = T.rscratch, D = x.pstyle("width").pfValue, B = x.pstyle("arrow-scale").value, P = D / 2 + v, A = P * P, R = P * 2, O = T.source, q = T.target, L;
    if (k.edgeType === "segments" || k.edgeType === "straight" || k.edgeType === "haystack") {
      for (var I = k.allpts, M = 0; M + 3 < I.length; M += 2)
        if (Ad(r, e, I[M], I[M + 1], I[M + 2], I[M + 3], R) && A > (L = Od(r, e, I[M], I[M + 1], I[M + 2], I[M + 3])))
          return g(x, L), !0;
      ...
      for (var I = k.allpts, M = 0; M + 5 < k.allpts.length; M += 4)
        if (Rd(r, e, I[M], I[M + 1], I[M + 2], I[M + 3], I[M + 4], I[M + 5], R) && A > (L = Id(r, e, I[M], I[M + 1], I[M + 2], I[M + 3], I[M + 4], I[M + 5])))
          return g(x, L), !0;
    }
    for (var O = O || T.source, q = q || T.target, _ = n.getArrowWidth(D, B), N = [{
      name: "source",
      x: k.arrowStartX,
      y: k.arrowStartY,
      ...
      var F = N[M], U = i.arrowShapes[x.pstyle(F.name + "-arrow-shape").value], J = x.pstyle("width").pfValue;
      if (U.roughCollide(r, e, _, F.angle, {
        x: F.x,
        y: F.y
      }, J, v) && U.collide(r, e, _, F.angle, {
        x: F.x,
        y: F.y
      }, J, v))
        return g(x), !0;
    }
    l && o.length > 0 && (p(O), p(q));
  }
  function b(x, T, k) {
    return xr(x, T, k);
  }
  function w(x, T) {
    var k = x._private, D = c, B;
    T ? B = T + "-" : B = "", x.boundingBox();
    var P = k.labelBounds[T || "main"], A = x.pstyle(B + "label").value, R = x.pstyle("text-events").strValue === "yes";
    if (!(!R || !A)) {
      var L = b(k.rscratch, "labelX", T), I = b(k.rscratch, "labelY", T), M = b(k.rscratch, "labelAngle", T), O = x.pstyle(B + "text-margin-x").pfValue, q = x.pstyle(B + "text-margin-y").pfValue, _ = P.x1 - D - O, N = P.x2 + D - O, F = P.y1 - D - q, U = P.y2 + D - q;
      if (M) {
        var J = Math.cos(M), Z = Math.sin(M), j = function(Y, te) {
          return Y = Y - L, te = te - I, {
            x: Y * J - te * Z + L,
            y: Y * Z + te * J + I
          };
        }, re = j(_, F), ne = j(_, U), Q = j(N, F), V = j(N, U), H = [
...
Rt.getAllInBox = function(r, e, t, a) {
  ...
  function g(Y, te) {
    var ce = Y._private, Be = s, we = "";
    Y.boundingBox();
    var me = ce.labelBounds.main;
    if (!me)
      return null;
    var ge = y(ce.rscratch, "labelX", te), se = y(ce.rscratch, "labelY", te), de = y(ce.rscratch, "labelAngle", te), fe = Y.pstyle(we + "text-margin-x").pfValue, xe = Y.pstyle(we + "text-margin-y").pfValue, be = me.x1 - Be - fe, Se = me.x2 + Be - fe, De = me.y1 - Be - xe, Oe = me.y2 + Be - xe;
    if (de) {
      var Le = Math.cos(de), Ae = Math.sin(de), X = function(z, G) {
        return z = z - ge, G = G - se, {
          x: z * Le - G * Ae + ge,
          y: z * Ae + G * Le + se
        };
      };
      return [X(be, De), X(Se, De), X(Se, Oe), X(be, Oe)];
    } else
      return [{
        x: be,
        y: De
  ...
  function p(Y, te, ce, Be) {
    function we(me, ge, se) {
      return (se.y - me.y) * (ge.x - me.x) > (ge.y - me.y) * (se.x - me.x);
    }
    return we(Y, ce, Be) !== we(te, ce, Be) && we(Y, te, ce) !== we(Y, te, Be);
  }
  for (var m = 0; m < n.length; m++) {
    ...
    if (b.isNode()) {
      ...
      if (C === "contain") {
        ...
        if (x && E) {
          var B = g(w);
          B && gi(B, h) && (o.push(w), D = !0);
        }
        !D && yv(c, k) && o.push(w);
      } else if (C === "overlap" && ro(c, k)) {
        var P = w.boundingBox({
          includeNodes: !0,
          includeEdges: !0,
          includeLabels: !1,
      ...
      var L = b, I = L._private, M = I.rscratch, O = L.pstyle("box-selection").strValue;
      if (O === "none")
        continue;
      if (O === "contain") {
        if (M.startX != null && M.startY != null && !at(c, M.startX, M.startY) || M.endX != null && M.endY != null && !at(c, M.endX, M.endY))
          continue;
        if (M.edgeType === "bezier" || M.edgeType === "multibezier" || M.edgeType === "self" || M.edgeType === "compound" || M.edgeType === "segments" || M.edgeType === "haystack") {
          for (var q = I.rstyle.bezierPts || I.rstyle.linePts || I.rstyle.haystackPts, _ = !0, N = 0; N < q.length; N++)
            if (!$o(c, q[N])) {
              _ = !1;
              break;
            }
        ...
        var F = !1;
        if (M.startX != null && M.startY != null && M.endX != null && M.endY != null && (at(c, M.startX, M.startY) || at(c, M.endX, M.endY)))
          o.push(L), F = !0;
        else if (!F && M.edgeType === "haystack") {
          for (var U = I.rstyle.haystackPts, J = 0; J < U.length; J++)
            if ($o(c, U[J])) {
              o.push(L), F = !0;
              break;
            }
        ...
        if (!F) {
          var Z = I.rstyle.bezierPts || I.rstyle.linePts || I.rstyle.haystackPts;
          if ((!Z || Z.length < 2) && M.edgeType === "straight" && M.startX != null && M.startY != null && M.endX != null && M.endY != null && (Z = [{
            x: M.startX,
            y: M.startY
          }, {
            x: M.endX,
            y: M.endY
          }]), !Z || Z.length < 2) continue;
          for (var j = 0; j < Z.length - 1; j++) {
            for (var re = Z[j], ne = Z[j + 1], Q = 0; Q < d.length; Q++) {
              var V = Qe(d[Q], 2), H = V[0], W = V[1];
              if (p(re, ne, H, W)) {
                o.push(L), F = !0;
                break;
              }
...
var kn = {};
kn.calculateArrowAngles = function(r) {
  ...
  if (t && (p = (v + c) / 2, m = (f + h) / 2), u = c - v, l = h - f, i) {
    ...
    if (E.length / 2 % 2 === 0) {
      var D = d.length / 2 - 1, B = D + 2, P = B + 2;
      C = nr(d[D], d[B], d[P], 0), x = nr(d[D + 1], d[B + 1], d[P + 1], 0), T = nr(d[D], d[B], d[P], 1e-4), k = nr(d[D + 1], d[B + 1], d[P + 1], 1e-4);
    } else {
      var B = d.length / 2 - 1, D = B - 2, P = B + 2;
      C = nr(d[D], d[B], d[P], 0.4999), x = nr(d[D + 1], d[B + 1], d[P + 1], 0.4999), T = nr(d[D], d[B], d[P], 0.5), k = nr(d[D + 1], d[B + 1], d[P + 1], 0.5);
    }
    u = T - C, l = k - x;
  }
  if (e.midtgtArrowAngle = Ka(u, l), e.midDispX = u, e.midDispY = l, u *= -1, l *= -1, i) {
    var d = e.allpts;
    if (d.length / 2 % 2 !== 0) {
      if (!e.isRound) {
  ...
  if (e.midsrcArrowAngle = Ka(u, l), i)
    ...
    u = c - p, l = h - m;
  e.tgtArrowAngle = Ka(u, l);
};
kn.getArrowWidth = kn.getArrowHeight = function(r, e) {
  var t = this.arrowWidthCache = this.arrowWidthCache || {}, a = t[r + ", " + e];
  return a || (a = Math.max(Math.pow(r * 13.37, 0.9), 29) * e, t[r + ", " + e] = a, a);
};
var zs, Fs, Vr = {}, kr = {}, Dl, Bl, Tt, dn, $r, bt, Et, zr, zt, rn, cf, df, Vs, qs, Pl, Al = function(e, t, a) {
  ...
  if (e !== Pl ? Al(t, e, Vr) : Qp(kr, Vr), Al(t, a, kr), Dl = Vr.nx * kr.ny - Vr.ny * kr.nx, Bl = Vr.nx * kr.nx - Vr.ny * -kr.ny, $r = Math.asin(Math.max(-1, Math.min(1, Dl))), Math.abs($r) < 1e-6) {
    zs = t.x, Fs = t.y, Et = zt = 0;
    return;
  }
  Tt = 1, dn = !1, Bl < 0 ? $r < 0 ? $r = Math.PI + $r : ($r = Math.PI - $r, Tt = -1, dn = !0) : $r > 0 && (Tt = -1, dn = !0), t.radius !== void 0 ? zt = t.radius : zt = n, bt = $r / 2, rn = Math.min(Vr.len / 2, kr.len / 2), i ? (zr = Math.abs(Math.cos(bt) * zt / Math.sin(bt)), zr > rn ? (zr = rn, Et = Math.abs(zr * Math.sin(bt) / Math.cos(bt))) : Et = zt) : (zr = Math.min(rn, zt), Et = Math.abs(zr * Math.sin(bt) / Math.cos(bt))), Vs = t.x + kr.nx * zr, qs = t.y + kr.ny * zr, zs = Vs - kr.ny * Et * Tt, Fs = qs + kr.nx * Et * Tt, cf = t.x + Vr.nx * zr, df = t.y + Vr.ny * zr, Pl = t;
};
function hf(r, e) {
...
function ho(r, e, t, a) {
  ...
  return a === 0 || e.radius === 0 ? {
    ...
    endAngle: kr.ang - Math.PI / 2 * Tt,
    counterClockwise: dn
  });
}
var Aa = 0.01, jp = Math.sqrt(2 * Aa), gr = {};
gr.findMidptPtsEtc = function(r, e) {
  var t = e.posPts, a = e.intersectionPts, n = e.vectorNormInverse, i, s = r.pstyle("source-endpoint"), o = r.pstyle("target-endpoint"), u = s.units != null && o.units != null, l = function(E, C, x, T) {
    var k = T - C, D = x - E, B = Math.sqrt(D * D + k * k);
    return {
      x: -k / B,
      y: D / B
    };
  ...
  switch (v) {
    ...
    case "endpoints": {
      if (u) {
        var f = this.manualEndptToPx(r.source()[0], s), c = Qe(f, 2), h = c[0], d = c[1], y = this.manualEndptToPx(r.target()[0], o), g = Qe(y, 2), p = g[0], m = g[1], b = {
          x1: h,
          y1: d,
          x2: p,
          y2: m
        ...
        ze("Edge ".concat(r.id(), " has edge-distances:endpoints specified without manual endpoints specified via source-endpoint and target-endpoint.  Falling back on edge-distances:intersection (default).")), i = a;
      break;
    }
  }
  return {
...
gr.findHaystackPoints = function(r) {
...
gr.findSegmentsPoints = function(r, e) {
...
gr.findLoopPoints = function(r, e, t, a) {
...
gr.findCompoundLoopPoints = function(r, e, t, a) {
  ...
  var g = 50, p = {
    ...
    x: Math.min(p.x, m.x),
    y: Math.min(p.y, m.y)
  }, w = 0.5, E = Math.max(w, Math.log(o * Aa)), C = Math.max(w, Math.log(l * Aa));
  n.ctrlpts = [b.x, b.y - (1 + Math.pow(g, 1.12) / 100) * y * (d / 3 + 1) * E, b.x - (1 + Math.pow(g, 1.12) / 100) * y * (d / 3 + 1) * C, b.y];
};
gr.findStraightEdgePoints = function(r) {
  r._private.rscratch.edgeType = "straight";
};
gr.findBezierPoints = function(r, e, t, a, n) {
  ...
  for (var h = 0; h < l; h++) {
    var d = (0.5 - e.eles.length / 2 + t) * s * (n ? -1 : 1), y = void 0, g = eo(d);
...
gr.findTaxiPoints = function(r, e) {
  ...
  }, Z = J(N), j = J(Math.abs(M) - Math.abs(N)), re = Z || j;
  if (re && !_)
    if (I) {
      var ne = Math.abs(O) <= c / 2, Q = Math.abs(D) <= h / 2;
      if (ne) {
        var V = (v.x1 + v.x2) / 2, H = v.y1, W = v.y2;
        t.segpts = [V, H, V, W];
      } else if (Q) {
        var Y = (v.y1 + v.y2) / 2, te = v.x1, ce = v.x2;
        t.segpts = [te, Y, ce, Y];
      } else
        t.segpts = [v.x1, v.y2];
    } else {
      var Be = Math.abs(O) <= f / 2, we = Math.abs(B) <= d / 2;
      if (Be) {
        var me = (v.y1 + v.y2) / 2, ge = v.x1, se = v.x2;
        t.segpts = [ge, me, se, me];
      } else if (we) {
        var de = (v.x1 + v.x2) / 2, fe = v.y1, xe = v.y2;
        t.segpts = [de, fe, de, xe];
      } else
        t.segpts = [v.x2, v.y1];
    }
  else if (I) {
    var be = v.y1 + N + (g ? c / 2 * q : 0), Se = v.x1, De = v.x2;
    t.segpts = [Se, be, De, be];
  } else {
    var Oe = v.x1 + N + (g ? f / 2 * q : 0), Le = v.y1, Ae = v.y2;
    t.segpts = [Oe, Le, Oe, Ae];
  }
  if (t.isRound) {
    var X = r.pstyle("taxi-radius").value, S = r.pstyle("radius-type").value[0] === "arc-radius";
    t.radii = new Array(t.segpts.length / 2).fill(X), t.isArcRadius = new Array(t.segpts.length / 2).fill(S);
  }
};
gr.tryToCorrectInvalidPoints = function(r, e) {
  var t = r._private.rscratch;
  if (t.edgeType === "bezier") {
    ...
    if (p || m || k) {
      ...
      var M = {
        ...
        x: t.ctrlpts[0] - n.x,
        y: t.ctrlpts[1] - n.y
      }, O = Math.sqrt(M.x * M.x + M.y * M.y), q = {
        // normalised delta
        x: M.x / O,
        y: M.y / O
      }, _ = Math.max(i, s), N = {
        // *2 radius guarantees outside shape
        x: t.ctrlpts[0] + q.x * 2 * _,
        y: t.ctrlpts[1] + q.y * 2 * _
      }, F = v.intersectLine(n.x, n.y, o, u, N.x, N.y, 0, c, d);
      k ? (t.ctrlpts[0] = t.ctrlpts[0] + q.x * (E - T), t.ctrlpts[1] = t.ctrlpts[1] + q.y * (E - T)) : (t.ctrlpts[0] = F[0] + q.x * E, t.ctrlpts[1] = F[1] + q.y * E);
    }
    D && this.findEndpoints(r);
  }
};
gr.storeAllpts = function(r) {
...
gr.checkForInvalidEdgeWarning = function(r) {
  var e = r[0]._private.rscratch;
  e.nodesOverlap || ae(e.startX) && ae(e.startY) && ae(e.endX) && ae(e.endY) ? e.loggedErr = !1 : e.loggedErr || (e.loggedErr = !0, ze("Edge `" + r.id() + "` has invalid endpoints and so it is impossible to draw.  Adjust your edge style (e.g. control points) accordingly or use an alternative edge type.  This is expected behaviour when the source node and the target node overlap."));
};
gr.findEdgeControlPoints = function(r) {
  var e = this;
  if (!(!r || r.length === 0)) {
    for (var t = this, a = t.cy, n = a.hasCompoundNodes(), i = new Kr(), s = function(k, D) {
      return [].concat(pn(k), [D ? 1 : 0]).join("-");
      ...
      if (!(v.removed() || !v.takesUpSpace())) {
        ...
        var h = c === "unbundled-bezier" || tt(c, "segments") || c === "straight" || c === "straight-triangle" || tt(c, "taxi"), d = c === "unbundled-bezier" || c === "bezier", y = f.source, g = f.target, p = y.poolIndex(), m = g.poolIndex(), b = [p, m].sort(), w = s(b, h), E = i.get(w);
        E == null && (E = {
          eles: []
        }, o.push({
          pairId: b,
    ...
    for (var C = function() {
      ...
      for (var W = 0; W < A.eles.length; W++) {
        var Y = A.eles[W], te = Y[0]._private.rscratch, ce = Y.pstyle("curve-style").value, Be = ce === "unbundled-bezier" || tt(ce, "segments") || tt(ce, "taxi"), we = !M.same(Y.source());
        if (!A.calculatedIntersection && M !== O && (A.hasBezier || A.hasUnbundled)) {
          A.calculatedIntersection = !0;
          var me = j.intersectLine(_.x, _.y, F, U, N.x, N.y, 0, ne, H), ge = A.srcIntn = me, se = re.intersectLine(N.x, N.y, J, Z, _.x, _.y, 0, Q, V), de = A.tgtIntn = se, fe = A.intersectionPts = {
            x1: me[0],
            x2: se[0],
            y1: me[1],
            y2: se[1]
            ...
            y1: _.y,
            y2: N.y
          }, be = se[1] - me[1], Se = se[0] - me[0], De = Math.sqrt(Se * Se + be * be);
          ae(De) && De >= jp || (De = Math.sqrt(Math.max(Se * Se, Aa) + Math.max(be * be, Aa)));
          var Oe = A.vector = {
            x: Se,
            y: be
          }, Le = A.vectorNorm = {
          ...
          A.nodesOverlap = !ae(De) || re.checkPoint(me[0], me[1], 0, J, Z, N.x, N.y, Q, V) || j.checkPoint(se[0], se[1], 0, F, U, _.x, _.y, ne, H), A.vectorNormInverse = Ae, R = {
...
gr.getSegmentPoints = function(r) {
  var e = r[0]._private.rscratch;
...
gr.getControlPoints = function(r) {
  var e = r[0]._private.rscratch;
  this.recalculateRenderedStyle(r);
  var t = e.edgeType;
...
qa.findEndpoints = function(r) {
  ...
  var O, q, _, N, F = (e = (L == null || (t = L.pfValue) === null || t === void 0 ? void 0 : t.length) === 2 ? L.pfValue : null) !== null && e !== void 0 ? e : [0, 0], U = (a = (P == null || (n = P.pfValue) === null || n === void 0 ? void 0 : n.length) === 2 ? P.pfValue : null) !== null && a !== void 0 ? a : [0, 0];
  if (C) {
    var J = [m.ctrlpts[0], m.ctrlpts[1]], Z = x ? [m.ctrlpts[m.ctrlpts.length - 2], m.ctrlpts[m.ctrlpts.length - 1]] : J;
    O = Z, q = J;
  } else if (T) {
    var j = k ? m.segpts.slice(0, 2) : [v.x + F[0], v.y + F[1]], re = k ? m.segpts.slice(m.segpts.length - 2) : [l.x + U[0], l.y + U[1]];
    O = re, q = j;
  }
  if (I === "inside-to-node")
    s = [v.x, v.y];
    ...
    s = m.tgtIntn;
  else if (I === "outside-to-node" || I === "outside-to-node-or-label" ? _ = O : (I === "outside-to-line" || I === "outside-to-line-or-label") && (_ = [l.x, l.y]), s = i.nodeShapes[this.getNodeShape(u)].intersectLine(v.x, v.y, u.outerWidth(), u.outerHeight(), _[0], _[1], 0, M, g), I === "outside-to-node-or-label" || I === "outside-to-line-or-label") {
    var ne = u._private.rscratch, Q = ne.labelWidth, V = ne.labelHeight, H = ne.labelX, W = ne.labelY, Y = Q / 2, te = V / 2, ce = u.pstyle("text-valign").value;
    ce === "top" ? W -= te : ce === "bottom" && (W += te);
    var Be = u.pstyle("text-halign").value;
    Be === "left" ? H -= Y : Be === "right" && (H += Y);
    var we = Sa(_[0], _[1], [H - Y, W - te, H + Y, W - te, H + Y, W + te, H - Y, W + te], v.x, v.y);
    if (we.length > 0) {
      var me = l, ge = xt(me, Gt(s)), se = xt(me, Gt(we)), de = ge;
      if (se < ge && (s = we, de = se), we.length > 2) {
        var fe = xt(me, {
          x: we[2],
          y: we[3]
        });
  ...
  var xe = Xa(s, O, i.arrowShapes[f].spacing(r) + h), be = Xa(s, O, i.arrowShapes[f].gap(r) + h);
  if (m.endX = be[0], m.endY = be[1], m.arrowEndX = xe[0], m.arrowEndY = xe[1], A === "inside-to-node")
    s = [l.x, l.y];
  else if (P.units)
    s = this.manualEndptToPx(o, P);
  else if (A === "outside-to-line")
    s = m.srcIntn;
  else if (A === "outside-to-node" || A === "outside-to-node-or-label" ? N = q : (A === "outside-to-line" || A === "outside-to-line-or-label") && (N = [v.x, v.y]), s = i.nodeShapes[this.getNodeShape(o)].intersectLine(l.x, l.y, o.outerWidth(), o.outerHeight(), N[0], N[1], 0, R, y), A === "outside-to-node-or-label" || A === "outside-to-line-or-label") {
    var Se = o._private.rscratch, De = Se.labelWidth, Oe = Se.labelHeight, Le = Se.labelX, Ae = Se.labelY, X = De / 2, S = Oe / 2, z = o.pstyle("text-valign").value;
    z === "top" ? Ae -= S : z === "bottom" && (Ae += S);
    var G = o.pstyle("text-halign").value;
    G === "left" ? Le -= X : G === "right" && (Le += X);
    var $ = Sa(N[0], N[1], [Le - X, Ae - S, Le + X, Ae - S, Le + X, Ae + S, Le - X, Ae + S], l.x, l.y);
    if ($.length > 0) {
      var K = v, le = xt(K, Gt(s)), ee = xt(K, Gt($)), ie = le;
      if (ee < le && (s = [$[0], $[1]], ie = ee), $.length > 2) {
        var oe = xt(K, {
          x: $[2],
          y: $[3]
        });
  ...
  var pe = Xa(s, q, i.arrowShapes[c].spacing(r) + d), Ee = Xa(s, q, i.arrowShapes[c].gap(r) + d);
  m.startX = Ee[0], m.startY = Ee[1], m.arrowStartX = pe[0], m.arrowStartY = pe[1], D && (!ae(m.startX) || !ae(m.startY) || !ae(m.endX) || !ae(m.endY) ? m.badLine = !0 : m.badLine = !1);
};
...
go.storeEdgeProjections = function(r) {
  ...
  if (e.rstyle.bezierPts = null, e.rstyle.linePts = null, e.rstyle.haystackPts = null, a === "multibezier" || a === "bezier" || a === "self" || a === "compound") {
    ...
    for (var n = 0; n + 5 < t.allpts.length; n += 4)
      ey(this, r, t.allpts.slice(n, n + 6));
  } else if (a === "segments")
...
go.recalculateEdgeProjections = function(r) {
...
var pf = function(e, t) {
  ...
  var i = Ta(0, n - 1e-3, 1), s = Ta(0, n + 1e-3, 1), o = $t(e, t, a, i), u = $t(e, t, a, s);
  return yf(o, u);
};
Gr.recalculateEdgeLabelProjections = function(r) {
  ...
  if (i.mid || i.source || i.target) {
    ...
    var s = function(f, c, h) {
      Ur(t.rscratch, f, c, h), Ur(t.rstyle, f, c, h);
    };
    s("labelX", null, e.x), s("labelY", null, e.y);
    var o = pf(a.midDispX, a.midDispY);
    ...
    var u = function() {
      ...
      function m(x, T, k, D, B) {
        var P = Dt(T, k), A = x.segments[x.segments.length - 1], R = {
          p0: T,
          p1: k,
          t0: D,
          t1: B,
      ...
      if (i[f]) {
        ...
        switch (a.edgeType) {
          ...
          case "multibezier": {
            ...
            var T = g.cp, k = g.segment, D = (d - p) / k.length, B = k.t1 - k.t0, P = h ? k.t0 + B * D : k.t1 - B * D;
            P = Ta(0, P, 1), e = $t(T.p0, T.p1, T.p2, P), c = ry(T.p0, T.p1, T.p2, P);
            break;
          }
          case "straight":
          case "segments":
          case "haystack": {
            for (var A = 0, R, L, I, M, O = a.allpts.length, q = 0; q + 3 < O && (h ? (I = {
              x: a.allpts[q],
              y: a.allpts[q + 1]
            }, M = {
              x: a.allpts[q + 2],
              ...
              x: a.allpts[O - 4 - q],
              y: a.allpts[O - 3 - q]
            }), R = Dt(I, M), L = A, A += R, !(A >= d)); q += 2)
              ;
            var _ = d - L, N = _ / R;
            N = Ta(0, N, 1), e = Cd(I, M, N), c = yf(I, M);
            break;
          }
        }
...
Gr.applyPrefixedLabelDimensions = function(r, e) {
  ...
  if (xr(t.rscratch, "prefixedLabelDimsKey", e) !== n) {
    Ur(t.rscratch, "prefixedLabelDimsKey", e, n);
    var i = this.calculateLabelDimensions(r, a), s = r.pstyle("line-height").pfValue, o = r.pstyle("text-wrap").strValue, u = xr(t.rscratch, "labelWrapCachedLines", e) || [], l = o !== "wrap" ? 1 : Math.max(u.length, 1), v = i.height / l, f = v * s, c = i.width, h = i.height + (l - 1) * (s - 1) * v;
    Ur(t.rstyle, "labelWidth", e, c), Ur(t.rscratch, "labelWidth", e, c), Ur(t.rstyle, "labelHeight", e, h), Ur(t.rscratch, "labelHeight", e, h), Ur(t.rscratch, "labelLineHeight", e, f);
  }
};
Gr.getLabelText = function(r, e) {
  var t = r._private, a = e ? e + "-" : "", n = r.pstyle(a + "label").strValue, i = r.pstyle("text-transform").value, s = function(U, J) {
    return J ? (Ur(t.rscratch, U, e, J), J) : xr(t.rscratch, U, e);
  };
  if (!n)
    return "";
...
`), f = r.pstyle("text-max-width").pfValue, c = r.pstyle("text-overflow-wrap").value, h = c === "anywhere", d = [], y = /[\s\u200b]+|$/g, g = 0; g < v.length; g++) {
      ...
      if (b > f) {
        ...
        try {
          for (T.s(); !(k = T.n()).done; ) {
            var D = k.value, B = D[0], P = p.substring(x, D.index);
            x = D.index + B.length;
            var A = C.length === 0 ? P : C + P + B, R = this.calculateLabelDimensions(r, A), L = R.width;
...
`)), s("labelWrapKey", u);
    ...
    var I = r.pstyle("text-max-width").pfValue, M = "", O = "…", q = !1;
    if (this.calculateLabelDimensions(r, n).width < I)
      return n;
    for (var _ = 0; _ < n.length; _++) {
      var N = this.calculateLabelDimensions(r, M + n[_] + O).width;
      if (N > I)
        break;
      M += n[_], _ === n.length - 1 && (q = !0);
    }
    return q || (M += O), M;
  }
  return n;
...
Gr.calculateLabelDimensions = function(r, e) {
  var t = this, a = t.cy.window(), n = a.document, i = 0, s = r.pstyle("font-style").strValue, o = r.pstyle("font-size").pfValue, u = r.pstyle("font-family").strValue, l = r.pstyle("font-weight").strValue, v = this.labelCalcCanvas, f = this.labelCalcCanvasContext;
  if (!v) {
...
`), g = 0; g < y.length; g++) {
    var p = y[g], m = f.measureText(p), b = Math.ceil(m.width), w = o;
    h = Math.max(b, h), d += w;
  }
  return h += i, d += i, {
    width: h,
...
var mf = {}, Rl = 28, Ml = !1;
mf.getNodeShape = function(r) {
  var e = this, t = r.pstyle("shape").value;
  if (t === "cutrectangle" && (r.width() < Rl || r.height() < Rl))
    return Ml || (ze("The `cutrectangle` node shape can not be used at small sizes so `rectangle` is used instead"), Ml = !0), "rectangle";
  if (r.isParent())
...
var Un = {};
Un.registerCalculationListeners = function() {
...
Un.onUpdateEleCalcs = function(r) {
  var e = this.onUpdateEleCalcsFns = this.onUpdateEleCalcsFns || [];
  e.push(r);
};
Un.recalculateRenderedStyle = function(r, e) {
  var t = function(w) {
...
var Kn = {};
Kn.updateCachedGrabbedEles = function() {
...
Kn.invalidateCachedZSortedEles = function() {
  this.cachedZSortedEles = null;
};
Kn.getCachedZSortedEles = function(r) {
  if (r || !this.cachedZSortedEles) {
    var e = this.cy.mutableElements().toArray();
    e.sort(Jv), e.interactive = e.filter(function(t) {
...
var bf = {};
[Rt, kn, gr, qa, go, Gr, mf, Un, Kn].forEach(function(r) {
  ye(bf, r);
});
var wf = {};
wf.getCachedImage = function(r, e, t) {
...
aa.registerBinding = function(r, e, t, a) {
...
aa.binder = function(r) {
  var e = this, t = e.cy.window(), a = r === t || r === t.document || r === t.document.body || dc(r);
...
aa.nodeIsDraggable = function(r) {
  return r && r.isNode() && !r.locked() && r.grabbable();
};
aa.nodeIsGrabbable = function(r) {
...
aa.load = function() {
  var r = this, e = r.cy.window(), t = function(S) {
    ...
    var z = S.getRootNode();
    if (z && z.nodeType === 11 && z.host !== void 0)
      return z;
  }, n = function(S, z, G, $) {
    S == null && (S = r.cy);
    ...
    var G = z.addToList, $ = G.has(S);
    !$ && S.grabbable() && !S.locked() && (G.merge(S), ty(S));
  }, c = function(S, z) {
    if (S.cy().hasCompoundNodes() && !(z.inDragLayer == null && z.addToList == null)) {
      var G = S.descendants();
      z.inDragLayer && (G.forEach(o), G.connectedEdges().forEach(o)), z.addToList && f(G, z);
    }
  }, h = function(S, z) {
    z = z || {};
    var G = S.cy().hasCompoundNodes();
    z.inDragLayer && (S.forEach(o), S.neighborhood().stdFilter(function($) {
      return !G || $.isEdge();
    }).forEach(o)), z.addToList && S.forEach(function($) {
      f($, z);
    }), c(S, z), g(S, {
      inDragLayer: z.inDragLayer
    }), r.updateCachedGrabbedEles();
  }, d = h, y = function(S) {
    S && (r.getCachedZSortedEles().forEach(function(z) {
      ay(z), u(z), v(z);
    }), r.updateCachedGrabbedEles());
  }, g = function(S, z) {
    if (!(z.inDragLayer == null && z.addToList == null) && S.cy().hasCompoundNodes()) {
      var G = S.ancestors().orphans();
      if (!G.same(S)) {
        var $ = G.descendants().spawnSelf().merge(G).unmerge(S).unmerge(S.descendants()), K = $.connectedEdges();
        z.inDragLayer && (K.forEach(o), $.forEach(o)), z.addToList && $.forEach(function(le) {
          f(le, z);
        });
      }
    }
  ...
  m ? (r.removeObserver = new MutationObserver(function(X) {
    for (var S = 0; S < X.length; S++) {
      var z = X[S], G = z.removedNodes;
      if (G)
        for (var $ = 0; $ < G.length; $++) {
          var K = G[$];
          if (K === r.container) {
  ...
  E(r.container, function(X) {
    r.registerBinding(X, "transitionend", C), r.registerBinding(X, "animationend", C), r.registerBinding(X, "scroll", C);
  ...
  var x = function() {
    ...
    for (var z = r.findContainerClientCoords(), G = z[0], $ = z[1], K = z[2], le = z[3], ee = S.touches ? S.touches : [S], ie = !1, oe = 0; oe < ee.length; oe++) {
      var pe = ee[oe];
      if (G <= pe.clientX && pe.clientX <= G + K && $ <= pe.clientY && pe.clientY <= $ + le) {
        ie = !0;
        break;
      }
    }
    if (!ie)
      return !1;
    for (var Ee = r.container, Ce = S.target, ve = Ce.parentNode, ke = !1; ve; ) {
      if (ve === Ee) {
        ke = !0;
        break;
      }
  ...
  r.registerBinding(r.container, "mousedown", function(S) {
    if (T(S) && !(r.hoverData.which === 1 && S.which !== 1)) {
      ...
      var z = r.cy, G = [S.clientX, S.clientY], $ = r.projectIntoViewport(G[0], G[1]), K = r.selection, le = r.findNearestElements($[0], $[1], !0, !1), ee = le[0], ie = r.dragData.possibleDragElements;
      r.hoverData.mdownPos = $, r.hoverData.mdownGPos = G;
      var oe = function(Pe) {
        return {
          originalEvent: S,
          type: Pe,
        ...
        r.hoverData.tapholdCancelled = !1, clearTimeout(r.hoverData.tapholdTimeout), r.hoverData.tapholdTimeout = setTimeout(function() {
          if (!r.hoverData.tapholdCancelled) {
            ...
            Pe ? Pe.emit(oe("taphold")) : z.emit(oe("taphold"));
          }
        }, r.tapholdDuration);
      };
      if (S.which == 3) {
        ...
        ee ? (ee.activate(), ee.emit(Ee), r.hoverData.down = ee) : z.emit(Ee), r.hoverData.downTime = (/* @__PURE__ */ new Date()).getTime(), r.hoverData.cxtDragged = !1;
      } else if (S.which == 1) {
        ee && ee.activate();
        {
          if (ee != null && r.nodeIsGrabbable(ee)) {
            ...
            if (l(ee), !ee.selected())
              ie = r.dragData.possibleDragElements = z.collection(), d(ee, {
                addToList: ie
              }), ee.emit(oe("grabon")).emit(oe("grab"));
            else {
              ie = r.dragData.possibleDragElements = z.collection();
              var ve = z.$(function(ke) {
                return ke.isNode() && ke.selected() && r.nodeIsGrabbable(ke);
              });
              h(ve, {
                addToList: ie
              }), ee.emit(oe("grabon")), ve.forEach(Ce);
            }
            r.redrawHint("eles", !0), r.redrawHint("drag", !0);
          }
          r.hoverData.down = ee, r.hoverData.downs = le, r.hoverData.downTime = (/* @__PURE__ */ new Date()).getTime();
        }
        n(ee, ["mousedown", "tapstart", "vmousedown"], S, {
          x: $[0],
          y: $[1]
        }), ee == null ? (K[4] = 1, r.data.bgActivePosistion = {
          x: $[0],
          y: $[1]
        }, r.redrawHint("select", !0), r.redraw()) : ee.pannable() && (K[4] = 1), pe();
      }
      K[0] = K[2] = $[0], K[1] = K[3] = $[1];
    }
  }, !1);
  ...
  r.registerBinding([e, k], "mousemove", function(S) {
    var z = r.hoverData.capture;
    if (!(!z && !T(S))) {
      var G = !1, $ = r.cy, K = $.zoom(), le = [S.clientX, S.clientY], ee = r.projectIntoViewport(le[0], le[1]), ie = r.hoverData.mdownPos, oe = r.hoverData.mdownGPos, pe = r.selection, Ee = null;
      !r.hoverData.draggingEles && !r.hoverData.dragging && !r.hoverData.selecting && (Ee = r.findNearestElement(ee[0], ee[1], !0, !1));
      var Ce = r.hoverData.last, ve = r.hoverData.down, ke = [ee[0] - pe[2], ee[1] - pe[3]], Pe = r.dragData.possibleDragElements, ar;
      if (oe) {
        var Ue = le[0] - oe[0], Pr = Ue * Ue, Ke = le[1] - oe[1], Ye = Ke * Ke, Je = Pr + Ye;
        r.hoverData.isOverThresholdDrag = ar = Je >= r.desktopTapThreshold2;
      }
      var or = i(S);
      ar && (r.hoverData.tapholdCancelled = !0);
      var Nr = function() {
        var Sr = r.hoverData.dragDelta = r.hoverData.dragDelta || [];
        Sr.length === 0 ? (Sr.push(ke[0]), Sr.push(ke[1])) : (Sr[0] += ke[0], Sr[1] += ke[1]);
      };
      G = !0, n(Ee, ["mousemove", "vmousemove", "tapdrag"], S, {
        x: ee[0],
        y: ee[1]
      });
      var We = function(Sr) {
        ...
        r.data.bgActivePosistion = void 0, r.hoverData.selecting || $.emit(We("boxstart")), pe[4] = 1, r.hoverData.selecting = !0, r.redrawHint("select", !0), r.redraw();
      };
      if (r.hoverData.which === 3) {
        if (ar) {
          var Ar = We("cxtdrag");
          ve ? ve.emit(Ar) : $.emit(Ar), r.hoverData.cxtDragged = !0, (!r.hoverData.cxtOver || Ee !== r.hoverData.cxtOver) && (r.hoverData.cxtOver && r.hoverData.cxtOver.emit(We("cxtdragout")), r.hoverData.cxtOver = Ee, Ee && Ee.emit(We("cxtdragover")));
        }
      } else if (r.hoverData.dragging) {
        if (G = !0, $.panningEnabled() && $.userPanningEnabled()) {
          var Jr;
          if (r.hoverData.justStartedPan) {
            var Ha = r.hoverData.mdownPos;
            Jr = {
              x: (ee[0] - Ha[0]) * K,
              y: (ee[1] - Ha[1]) * K
          ...
          $.panBy(Jr), $.emit(We("dragpan")), r.hoverData.dragged = !0;
        }
        ee = r.projectIntoViewport(S.clientX, S.clientY);
      } else if (pe[4] == 1 && (ve == null || ve.pannable())) {
        if (ar) {
          if (!r.hoverData.dragging && $.boxSelectionEnabled() && (or || !$.panningEnabled() || !$.userPanningEnabled()))
            Wr();
          else if (!r.hoverData.selecting && $.panningEnabled() && $.userPanningEnabled()) {
            var mt = s(ve, r.hoverData.downs);
            mt && (r.hoverData.dragging = !0, r.hoverData.justStartedPan = !0, pe[4] = 0, r.data.bgActivePosistion = Gt(ie), r.redrawHint("select", !0), r.redraw());
          }
          ve && ve.pannable() && ve.active() && ve.unactivate();
        }
      } else {
        if (ve && ve.pannable() && ve.active() && ve.unactivate(), (!ve || !ve.grabbed()) && Ee != Ce && (Ce && n(Ce, ["mouseout", "tapdragout"], S, {
          x: ee[0],
          y: ee[1]
        }), Ee && n(Ee, ["mouseover", "tapdragover"], S, {
          x: ee[0],
          y: ee[1]
        }), r.hoverData.last = Ee), ve)
          if (ar) {
            if ($.boxSelectionEnabled() && or)
              ve && ve.grabbed() && (y(Pe), ve.emit(We("freeon")), Pe.emit(We("free")), r.dragData.didDrag && (ve.emit(We("dragfreeon")), Pe.emit(We("dragfree")))), Wr();
            else if (ve && ve.grabbed() && r.nodeIsDraggable(ve)) {
              var br = !r.dragData.didDrag;
              br && r.redrawHint("eles", !0), r.dragData.didDrag = !0, r.hoverData.draggingEles || h(Pe, {
                inDragLayer: !0
              });
              var cr = {
                x: 0,
              ...
              if (ae(ke[0]) && ae(ke[1]) && (cr.x += ke[0], cr.y += ke[1], br)) {
                var wr = r.hoverData.dragDelta;
                wr && ae(wr[0]) && ae(wr[1]) && (cr.x += wr[0], cr.y += wr[1]);
              }
              r.hoverData.draggingEles = !0, Pe.silentShift(cr).emit(We("position")).emit(We("drag")), r.redrawHint("drag", !0), r.redraw();
            }
          } else
            Nr();
        G = !0;
      }
      if (pe[2] = ee[0], pe[3] = ee[1], G)
  ...
  r.registerBinding(e, "mouseup", function(S) {
    if (!(r.hoverData.which === 1 && S.which !== 1 && r.hoverData.capture)) {
      ...
      if (z) {
        ...
        var G = r.cy, $ = r.projectIntoViewport(S.clientX, S.clientY), K = r.selection, le = r.findNearestElement($[0], $[1], !0, !1), ee = r.dragData.possibleDragElements, ie = r.hoverData.down, oe = i(S);
        r.data.bgActivePosistion && (r.redrawHint("select", !0), r.redraw()), r.hoverData.tapholdCancelled = !0, r.data.bgActivePosistion = void 0, ie && ie.unactivate();
        var pe = function(Ue) {
          return {
            originalEvent: S,
            type: Ue,
        ...
        if (r.hoverData.which === 3) {
          var Ee = pe("cxttapend");
          if (ie ? ie.emit(Ee) : G.emit(Ee), !r.hoverData.cxtDragged) {
            var Ce = pe("cxttap");
            ie ? ie.emit(Ce) : G.emit(Ce);
          }
          r.hoverData.cxtDragged = !1, r.hoverData.which = null;
        } else if (r.hoverData.which === 1) {
          if (n(le, ["mouseup", "tapend", "vmouseup"], S, {
            x: $[0],
            y: $[1]
          ...
          !r.hoverData.isOverThresholdDrag && (n(ie, ["click", "tap", "vclick"], S, {
            x: $[0],
            y: $[1]
          }), B = !1, S.timeStamp - P <= G.multiClickDebounceTime() ? (D && clearTimeout(D), B = !0, P = null, n(ie, ["dblclick", "dbltap", "vdblclick"], S, {
            x: $[0],
            y: $[1]
          })) : (D = setTimeout(function() {
            B || n(ie, ["oneclick", "onetap", "voneclick"], S, {
              x: $[0],
              y: $[1]
            });
          }, G.multiClickDebounceTime()), P = S.timeStamp)), ie == null && !r.dragData.didDrag && !r.hoverData.selecting && !r.hoverData.dragged && !i(S) && (G.$(t).unselect(["tapunselect"]), ee.length > 0 && r.redrawHint("eles", !0), r.dragData.possibleDragElements = ee = G.collection()), le == ie && !r.dragData.didDrag && !r.hoverData.selecting && le != null && le._private.selectable && (r.hoverData.dragging || (G.selectionType() === "additive" || oe ? le.selected() ? le.unselect(["tapunselect"]) : le.select(["tapselect"]) : oe || (G.$(t).unmerge(le).unselect(["tapunselect"]), le.select(["tapselect"]))), r.redrawHint("eles", !0)), r.hoverData.selecting) {
            var ve = G.collection(r.getAllInBox(K[0], K[1], K[2], K[3]));
            r.redrawHint("select", !0), ve.length > 0 && r.redrawHint("eles", !0), G.emit(pe("boxend"));
            var ke = function(Ue) {
              return Ue.selectable() && !Ue.selected();
            };
            G.selectionType() === "additive" || oe || G.$(t).unmerge(ve).unselect(), ve.emit(pe("box")).stdFilter(ke).select().emit(pe("boxselect")), r.redraw();
          }
          if (r.hoverData.dragging && (r.hoverData.dragging = !1, r.redrawHint("select", !0), r.redrawHint("eles", !0), r.redraw()), !K[4]) {
            ...
            y(ee), Pe && (ie.emit(pe("freeon")), ee.emit(pe("free")), r.dragData.didDrag && (ie.emit(pe("dragfreeon")), ee.emit(pe("dragfree"))));
          }
        }
  ...
  var A = [], R = 4, L, I = 1e5, M = function(S, z) {
    for (var G = 0; G < S.length; G++)
      if (S[G] % z !== 0)
        return !1;
    return !0;
  }, O = function(S) {
    for (var z = Math.abs(S[0]), G = 1; G < S.length; G++)
      if (Math.abs(S[G]) !== z)
        return !1;
    return !0;
  }, q = function(S) {
    var z = !1, G = S.deltaY;
    if (G == null && (S.wheelDeltaY != null ? G = S.wheelDeltaY / 4 : S.wheelDelta != null && (G = S.wheelDelta / 4)), G !== 0) {
      if (L == null)
        if (A.length >= R) {
          var $ = A;
          if (L = M($, 5), !L) {
          ...
          if (L)
            for (var le = 0; le < $.length; le++)
              I = Math.min(Math.abs($[le]), I);
        } else
          A.push(G), z = !0;
      else L && (I = Math.min(Math.abs(G), I));
      if (!r.scrollingPage) {
        var ee = r.cy, ie = ee.zoom(), oe = ee.pan(), pe = r.projectIntoViewport(S.clientX, S.clientY), Ee = [pe[0] * ie + oe.x, pe[1] * ie + oe.y];
        ...
        if (ee.panningEnabled() && ee.userPanningEnabled() && ee.zoomingEnabled() && ee.userZoomingEnabled()) {
          ...
          var Ce;
          z && Math.abs(G) > 5 && (G = eo(G) * 5), Ce = G / -250, L && (Ce /= I, Ce *= 3), Ce = Ce * r.wheelSensitivity;
          var ve = S.deltaMode === 1;
          ve && (Ce *= 33);
          var ke = ee.zoom() * Math.pow(10, Ce);
          S.type === "gesturechange" && (ke = r.gestureStartZoom * S.scale), ee.zoom({
            level: ke,
            renderedPosition: {
              x: Ee[0],
              y: Ee[1]
  ...
  r.registerBinding(r.container, "wheel", q, !0), r.registerBinding(e, "scroll", function(S) {
  ...
  }, !0), r.registerBinding(r.container, "gesturechange", function(X) {
    r.hasTouchStarted || q(X);
  }, !0), r.registerBinding(r.container, "mouseout", function(S) {
    var z = r.projectIntoViewport(S.clientX, S.clientY);
    r.cy.emit({
      originalEvent: S,
      type: "mouseout",
      position: {
  ...
  var _, N, F, U, J, Z, j, re, ne, Q, V, H, W, Y = function(S, z, G, $) {
    return Math.sqrt((G - S) * (G - S) + ($ - z) * ($ - z));
  }, te = function(S, z, G, $) {
    return (G - S) * (G - S) + ($ - z) * ($ - z);
  }, ce;
  r.registerBinding(r.container, "touchstart", ce = function(S) {
    if (r.hasTouchStarted = !0, !!T(S)) {
      ...
      var z = r.cy, G = r.touchData.now, $ = r.touchData.earlier;
      if (S.touches[0]) {
      ...
      if (S.touches[1]) {
        ...
        ne = ee[0], Q = ee[1], V = ee[2], H = ee[3], _ = S.touches[0].clientX - ne, N = S.touches[0].clientY - Q, F = S.touches[1].clientX - ne, U = S.touches[1].clientY - Q, W = 0 <= _ && _ <= V && 0 <= F && F <= V && 0 <= N && N <= H && 0 <= U && U <= H;
        var ie = z.pan(), oe = z.zoom();
        J = Y(_, N, F, U), Z = te(_, N, F, U), j = [(_ + F) / 2, (N + U) / 2], re = [(j[0] - ie.x) / oe, (j[1] - ie.y) / oe];
        var pe = 200, Ee = pe * pe;
        if (Z < Ee && !S.touches[2]) {
          var Ce = r.findNearestElement(G[0], G[1], !0, !0), ve = r.findNearestElement(G[2], G[3], !0, !0);
          Ce && Ce.isNode() ? (Ce.activate().emit(le("cxttapstart")), r.touchData.start = Ce) : ve && ve.isNode() ? (ve.activate().emit(le("cxttapstart")), r.touchData.start = ve) : z.emit(le("cxttapstart")), r.touchData.start && (r.touchData.start._private.grabbed = !1), r.touchData.cxt = !0, r.touchData.cxtDragged = !1, r.data.bgActivePosistion = void 0, r.redraw();
          return;
        }
      }
      if (S.touches[2])
        ...
        if (S.touches[0]) {
          var ke = r.findNearestElements(G[0], G[1], !0, !0), Pe = ke[0];
          if (Pe != null && (Pe.activate(), r.touchData.start = Pe, r.touchData.starts = ke, r.nodeIsGrabbable(Pe))) {
            var ar = r.dragData.touchDragEles = z.collection(), Ue = null;
            r.redrawHint("eles", !0), r.redrawHint("drag", !0), Pe.selected() ? (Ue = z.$(function(Je) {
              return Je.selected() && r.nodeIsGrabbable(Je);
            }), h(Ue, {
              addToList: ar
            })) : d(Pe, {
              addToList: ar
            }), l(Pe), Pe.emit(le("grabon")), Ue ? Ue.forEach(function(Je) {
              Je.emit(le("grab"));
            }) : Pe.emit(le("grab"));
          }
      ...
      if (S.touches.length >= 1) {
        for (var Pr = r.touchData.startPosition = [null, null, null, null, null, null], Ke = 0; Ke < G.length; Ke++)
          Pr[Ke] = $[Ke] = G[Ke];
        var Ye = S.touches[0];
        r.touchData.startGPosition = [Ye.clientX, Ye.clientY];
      }
    }
  }, !1);
  var Be;
  r.registerBinding(e, "touchmove", Be = function(S) {
    var z = r.touchData.capture;
    if (!(!z && !T(S))) {
      var G = r.selection, $ = r.cy, K = r.touchData.now, le = r.touchData.earlier, ee = $.zoom();
      if (S.touches[0]) {
      ...
      }, pe = r.touchData.startGPosition, Ee;
      if (z && S.touches[0] && pe) {
        for (var Ce = [], ve = 0; ve < K.length; ve++)
          Ce[ve] = K[ve] - le[ve];
        var ke = S.touches[0].clientX - pe[0], Pe = ke * ke, ar = S.touches[0].clientY - pe[1], Ue = ar * ar, Pr = Pe + Ue;
        Ee = Pr >= r.touchTapThreshold2;
      }
      if (z && r.touchData.cxt) {
        S.preventDefault();
        var Ke = S.touches[0].clientX - ne, Ye = S.touches[0].clientY - Q, Je = S.touches[1].clientX - ne, or = S.touches[1].clientY - Q, Nr = te(Ke, Ye, Je, or), We = Nr / Z, Wr = 150, Ar = Wr * Wr, Jr = 1.5, Ha = Jr * Jr;
        if (We >= Ha || Nr >= Ar) {
      ...
      if (z && r.touchData.cxt) {
        ...
        var br = r.findNearestElement(K[0], K[1], !0, !0);
        (!r.touchData.cxtOver || br !== r.touchData.cxtOver) && (r.touchData.cxtOver && r.touchData.cxtOver.emit(oe("cxtdragout")), r.touchData.cxtOver = br, br && br.emit(oe("cxtdragover")));
      } else if (z && S.touches[2] && $.boxSelectionEnabled())
        S.preventDefault(), r.data.bgActivePosistion = void 0, this.lastThreeTouch = +/* @__PURE__ */ new Date(), r.touchData.selecting || $.emit(oe("boxstart")), r.touchData.selecting = !0, r.touchData.didSelect = !0, G[4] = 1, !G || G.length === 0 || G[0] === void 0 ? (G[0] = (K[0] + K[2] + K[4]) / 3, G[1] = (K[1] + K[3] + K[5]) / 3, G[2] = (K[0] + K[2] + K[4]) / 3 + 1, G[3] = (K[1] + K[3] + K[5]) / 3 + 1) : (G[2] = (K[0] + K[2] + K[4]) / 3, G[3] = (K[1] + K[3] + K[5]) / 3), r.redrawHint("select", !0), r.redraw();
      else if (z && S.touches[1] && !r.touchData.didSelect && $.zoomingEnabled() && $.panningEnabled() && $.userZoomingEnabled() && $.userPanningEnabled()) {
        S.preventDefault(), r.data.bgActivePosistion = void 0, r.redrawHint("select", !0);
        var cr = r.dragData.touchDragEles;
        if (cr) {
          r.redrawHint("drag", !0);
          for (var wr = 0; wr < cr.length; wr++) {
            var ia = cr[wr]._private;
            ia.grabbed = !1, ia.rscratch.inDragLayer = !1;
          }
        }
        var Sr = r.touchData.start, Ke = S.touches[0].clientX - ne, Ye = S.touches[0].clientY - Q, Je = S.touches[1].clientX - ne, or = S.touches[1].clientY - Q, mo = Y(Ke, Ye, Je, or), Hf = mo / J;
        if (W) {
          var Wf = Ke - _, $f = Ye - N, Uf = Je - F, Kf = or - U, Xf = (Wf + Uf) / 2, Yf = ($f + Kf) / 2, sa = $.zoom(), Xn = sa * Hf, Wa = $.pan(), bo = re[0] * sa + Wa.x, wo = re[1] * sa + Wa.y, Zf = {
            x: -Xn / sa * (bo - Wa.x - Xf) + bo,
            y: -Xn / sa * (wo - Wa.y - Yf) + wo
          };
          if (Sr && Sr.active()) {
            var cr = r.dragData.touchDragEles;
            y(cr), r.redrawHint("drag", !0), r.redrawHint("eles", !0), Sr.unactivate().emit(oe("freeon")), cr.emit(oe("free")), r.dragData.didDrag && (Sr.emit(oe("dragfreeon")), cr.emit(oe("dragfree")));
          }
          $.viewport({
            zoom: Xn,
            pan: Zf,
            cancelOnFailedZoom: !0
          }), $.emit(oe("pinchzoom")), J = mo, _ = Ke, N = Ye, F = Je, U = or, r.pinching = !0;
        }
        if (S.touches[0]) {
          var ie = r.projectIntoViewport(S.touches[0].clientX, S.touches[0].clientY);
          K[0] = ie[0], K[1] = ie[1];
        ...
        var Rr = r.touchData.start, Yn = r.touchData.last, br;
        if (!r.hoverData.draggingEles && !r.swipePanning && (br = r.findNearestElement(K[0], K[1], !0, !0)), z && Rr != null && S.preventDefault(), z && Rr != null && r.nodeIsDraggable(Rr))
          if (Ee) {
            var cr = r.dragData.touchDragEles, xo = !r.dragData.didDrag;
            xo && h(cr, {
              inDragLayer: !0
            ...
            if (ae(Ce[0]) && ae(Ce[1]) && (oa.x += Ce[0], oa.y += Ce[1], xo)) {
              r.redrawHint("eles", !0);
              var Mr = r.touchData.dragDelta;
              Mr && ae(Mr[0]) && ae(Mr[1]) && (oa.x += Mr[0], oa.y += Mr[1]);
            }
            r.hoverData.draggingEles = !0, cr.silentShift(oa).emit(oe("position")).emit(oe("drag")), r.redrawHint("drag", !0), r.touchData.startPosition[0] == le[0] && r.touchData.startPosition[1] == le[1] && r.redrawHint("eles", !0), r.redraw();
          } else {
            var Mr = r.touchData.dragDelta = r.touchData.dragDelta || [];
            Mr.length === 0 ? (Mr.push(Ce[0]), Mr.push(Ce[1])) : (Mr[0] += Ce[0], Mr[1] += Ce[1]);
          }
        if (n(Rr || br, ["touchmove", "tapdrag", "vmousemove"], S, {
          x: K[0],
          y: K[1]
        }), (!Rr || !Rr.grabbed()) && br != Yn && (Yn && Yn.emit(oe("tapdragout")), br && br.emit(oe("tapdragover"))), r.touchData.last = br, z)
          for (var wr = 0; wr < K.length; wr++)
            K[wr] && r.touchData.startPosition[wr] && Ee && (r.touchData.singleTouchMoved = !0);
        if (z && (Rr == null || Rr.pannable()) && $.panningEnabled() && $.userPanningEnabled()) {
          var Qf = s(Rr, r.touchData.starts);
          Qf && (S.preventDefault(), r.data.bgActivePosistion || (r.data.bgActivePosistion = Gt(r.touchData.startPosition)), r.swipePanning ? ($.panBy({
            x: Ce[0] * ee,
            y: Ce[1] * ee
          }), $.emit(oe("dragpan"))) : Ee && (r.swipePanning = !0, $.panBy({
            x: ke * ee,
            y: ar * ee
          }), $.emit(oe("dragpan")), Rr && (Rr.unactivate(), r.redrawHint("select", !0), r.touchData.start = null)));
          var ie = r.projectIntoViewport(S.touches[0].clientX, S.touches[0].clientY);
          K[0] = ie[0], K[1] = ie[1];
        }
      }
      for (var ve = 0; ve < K.length; ve++)
        le[ve] = K[ve];
      z && S.touches.length > 0 && !r.hoverData.draggingEles && !r.swipePanning && r.data.bgActivePosistion != null && (r.data.bgActivePosistion = void 0, r.redrawHint("select", !0), r.redraw());
    }
  }, !1);
  var we;
  r.registerBinding(e, "touchcancel", we = function(S) {
    var z = r.touchData.start;
    r.touchData.capture = !1, z && z.unactivate();
  });
  var me, ge, se, de;
  if (r.registerBinding(e, "touchend", me = function(S) {
    var z = r.touchData.start, G = r.touchData.capture;
    if (G)
    ...
    var K = r.cy, le = K.zoom(), ee = r.touchData.now, ie = r.touchData.earlier;
    if (S.touches[0]) {
    ...
    var Ee;
    if (r.touchData.cxt) {
      if (Ee = pe("cxttapend"), z ? z.emit(Ee) : K.emit(Ee), !r.touchData.cxtDragged) {
        var Ce = pe("cxttap");
        z ? z.emit(Ce) : K.emit(Ce);
      }
    ...
    if (!S.touches[2] && K.boxSelectionEnabled() && r.touchData.selecting) {
      ...
      var ve = K.collection(r.getAllInBox($[0], $[1], $[2], $[3]));
      $[0] = void 0, $[1] = void 0, $[2] = void 0, $[3] = void 0, $[4] = 0, r.redrawHint("select", !0), K.emit(pe("boxend"));
      var ke = function(Ar) {
        return Ar.selectable() && !Ar.selected();
      };
      ve.emit(pe("box")).stdFilter(ke).select().emit(pe("boxselect")), ve.nonempty() && r.redrawHint("eles", !0), r.redraw();
    }
    if (z?.unactivate(), S.touches[2])
      ...
      if (!S.touches[0]) {
        if (!S.touches[0]) {
          ...
          if (z != null) {
            var ar = z._private.grabbed;
            y(Pe), r.redrawHint("drag", !0), r.redrawHint("eles", !0), ar && (z.emit(pe("freeon")), Pe.emit(pe("free")), r.dragData.didDrag && (z.emit(pe("dragfreeon")), Pe.emit(pe("dragfree")))), n(z, ["touchend", "tapend", "vmouseup", "tapdragout"], S, {
              x: ee[0],
              y: ee[1]
            }), z.unactivate(), r.touchData.start = null;
          } else {
            var Ue = r.findNearestElement(ee[0], ee[1], !0, !0);
            n(Ue, ["touchend", "tapend", "vmouseup", "tapdragout"], S, {
              x: ee[0],
              y: ee[1]
            });
          }
          var Pr = r.touchData.startPosition[0] - ee[0], Ke = Pr * Pr, Ye = r.touchData.startPosition[1] - ee[1], Je = Ye * Ye, or = Ke + Je, Nr = or * le * le;
          r.touchData.singleTouchMoved || (z || K.$(":selected").unselect(["tapunselect"]), n(z, ["tap", "vclick"], S, {
            x: ee[0],
            y: ee[1]
          }), ge = !1, S.timeStamp - de <= K.multiClickDebounceTime() ? (se && clearTimeout(se), ge = !0, de = null, n(z, ["dbltap", "vdblclick"], S, {
            x: ee[0],
            y: ee[1]
          })) : (se = setTimeout(function() {
            ge || n(z, ["onetap", "voneclick"], S, {
              x: ee[0],
              y: ee[1]
            });
          }, K.multiClickDebounceTime()), de = S.timeStamp)), z != null && !r.dragData.didDrag && z._private.selectable && Nr < r.touchTapThreshold2 && !r.pinching && (K.selectionType() === "single" ? (K.$(t).unmerge(z).unselect(["tapunselect"]), z.select(["tapselect"])) : z.selected() ? z.unselect(["tapunselect"]) : z.select(["tapselect"]), r.redrawHint("eles", !0)), r.touchData.singleTouchMoved = !0;
        }
      }
    }
    ...
    var fe = [], xe = function(S) {
      ...
      for (var z = 0; z < fe.length; z++) {
        var G = fe[z];
        if (G.event.pointerId === S.pointerId) {
          fe.splice(z, 1);
          return;
        }
      }
    }, Oe = function(S) {
      var z = fe.filter(function(G) {
        return G.event.pointerId === S.pointerId;
      })[0];
      z.event = S, z.touch = xe(S);
    }, Le = function(S) {
      S.touches = fe.map(function(z) {
        return z.touch;
      });
    }, Ae = function(S) {
    ...
    r.registerBinding(r.container, "pointerdown", function(X) {
      Ae(X) || (X.preventDefault(), Se(X), Le(X), ce(X));
      ...
      Ae(X) || (X.preventDefault(), Oe(X), Le(X), Be(X));
    });
  }
};
var Zr = {};
Zr.generatePolygon = function(r, e) {
  return this.nodeShapes[r] = {
    ...
    checkPoint: function(a, n, i, s, o, u, l, v) {
      return Yr(a, n, this.points, u, l, s, o, [0, -1], i);
    },
    hasMiterBounds: r !== "rectangle",
    miterBounds: function(a, n, i, s, o, u) {
      return Pd(this.points, a, n, i, s, o);
    }
  };
};
Zr.generateEllipse = function() {
...
Zr.generateRoundPolygon = function(r, e) {
  return this.nodeShapes[r] = {
    renderer: this,
    name: r,
    points: e,
    getOrCreateCorners: function(a, n, i, s, o, u, l) {
      ...
      for (y = c[m - 1], d = 0; d < m; d++)
        g = c[d % m], p = c[(d + 1) % m], u[l][d] = ho(y, g, p, o), y = g, g = p;
      return u[l];
    },
    ...
    intersectLine: function(a, n, i, s, o, u, l, v, f) {
      return Vd(o, u, this.points, a, n, i, s, l, this.getOrCreateCorners(a, n, i, s, v, f, "corners"));
    },
    checkPoint: function(a, n, i, s, o, u, l, v, f) {
      return Nd(a, n, this.points, u, l, s, o, this.getOrCreateCorners(u, l, s, o, v, f, "corners"));
    }
  };
};
Zr.generateRoundRectangle = function() {
  return this.nodeShapes["round-rectangle"] = this.nodeShapes.roundrectangle = {
    ...
    intersectLine: function(e, t, a, n, i, s, o, u) {
      return mv(i, s, e, t, a, n, o, u);
    },
    checkPoint: function(e, t, a, n, i, s, o, u) {
      var l = n / 2, v = i / 2;
      u = u === "auto" ? lt(n, i) : u, u = Math.min(l, v, u);
      var f = u * 2;
      return !!(Yr(e, t, this.points, s, o, n, i - f, [0, -1], a) || Yr(e, t, this.points, s, o, n - f, i, [0, -1], a) || St(e, t, f, f, s - l + u, o - v + u, a) || St(e, t, f, f, s + l - u, o - v + u, a) || St(e, t, f, f, s + l - u, o + v - u, a) || St(e, t, f, f, s - l + u, o + v - u, a));
    }
  };
};
Zr.generateCutRectangle = function() {
  return this.nodeShapes["cut-rectangle"] = this.nodeShapes.cutrectangle = {
    ...
    checkPoint: function(e, t, a, n, i, s, o, u) {
      ...
      if (Yr(e, t, this.points, s, o, n, i - 2 * l, [0, -1], a) || Yr(e, t, this.points, s, o, n - 2 * l, i, [0, -1], a))
        return !0;
...
Zr.generateBarrel = function() {
  return this.nodeShapes.barrel = {
    ...
    generateBarrelBezierPts: function(e, t, a, n) {
      var i = t / 2, s = e / 2, o = a - s, u = a + s, l = n - i, v = n + i, f = Bs(e, t), c = f.heightOffset, h = f.widthOffset, d = f.ctrlPtOffsetPct * e, y = {
    ...
    checkPoint: function(e, t, a, n, i, s, o, u) {
      var l = Bs(n, i), v = l.heightOffset, f = l.widthOffset;
      if (Yr(e, t, this.points, s, o, n, i - 2 * v, [0, -1], a) || Yr(e, t, this.points, s, o, n - 2 * f, i, [0, -1], a))
        return !0;
      for (var c = this.generateBarrelBezierPts(n, i, s, o), h = function(T, k, D) {
        var B = D[4], P = D[2], A = D[0], R = D[5], L = D[1], I = Math.min(B, A), M = Math.max(B, A), O = Math.min(R, L), q = Math.max(R, L);
        if (I <= T && T <= M && O <= k && k <= q) {
          var _ = qd(B, P, A), N = Md(_[0], _[1], _[2], T), F = N.filter(function(U) {
            return 0 <= U && U <= 1;
          });
          if (F.length > 0)
            return F[0];
...
Zr.generateBottomRoundrectangle = function() {
  return this.nodeShapes["bottom-round-rectangle"] = this.nodeShapes.bottomroundrectangle = {
    ...
    intersectLine: function(e, t, a, n, i, s, o, u) {
      var l = e - (a / 2 + o), v = t - (n / 2 + o), f = v, c = e + (a / 2 + o), h = nt(i, s, e, t, l, v, c, f, !1);
      return h.length > 0 ? h : mv(i, s, e, t, a, n, o, u);
    },
    checkPoint: function(e, t, a, n, i, s, o, u) {
      u = u === "auto" ? lt(n, i) : u;
      var l = 2 * u;
      if (Yr(e, t, this.points, s, o, n, i - l, [0, -1], a) || Yr(e, t, this.points, s, o, n - l, i, [0, -1], a))
        return !0;
      var v = n / 2 + 2 * a, f = i / 2 + 2 * a, c = [s - v, o - f, s - v, o, s + v, o, s + v, o - f];
      return !!(Er(e, t, c) || St(e, t, l, l, s + n / 2 - u, o + i / 2 - u, a) || St(e, t, l, l, s - n / 2 + u, o + i / 2 - u, a));
    }
  };
};
Zr.registerNodeShapes = function() {
  var r = this.nodeShapes = {}, e = this;
  this.generateEllipse(), this.generatePolygon("triangle", pr(3, 0)), this.generateRoundPolygon("round-triangle", pr(3, 0)), this.generatePolygon("rectangle", pr(4, 0)), r.square = r.rectangle, this.generateRoundRectangle(), this.generateCutRectangle(), this.generateBarrel(), this.generateBottomRoundrectangle();
  {
    var t = [0, 1, 1, 0, 0, -1, -1, 0];
    this.generatePolygon("diamond", t), this.generateRoundPolygon("round-diamond", t);
  }
  this.generatePolygon("pentagon", pr(5, 0)), this.generateRoundPolygon("round-pentagon", pr(5, 0)), this.generatePolygon("hexagon", pr(6, 0)), this.generateRoundPolygon("round-hexagon", pr(6, 0)), this.generatePolygon("heptagon", pr(7, 0)), this.generateRoundPolygon("round-heptagon", pr(7, 0)), this.generatePolygon("octagon", pr(8, 0)), this.generateRoundPolygon("round-octagon", pr(8, 0));
  var a = new Array(20);
  {
    var n = Ds(5, 0), i = Ds(5, Math.PI / 5), s = 0.5 * (3 - Math.sqrt(5));
    s *= 1.57;
...
var _a = {};
_a.timeToRender = function() {
  return this.redrawTotalTime / this.redrawCount;
};
_a.redraw = function(r) {
  r = r || hv();
  var e = this;
...
var ny = function(e) {
  this.init(e);
}, Ef = ny, na = Ef.prototype;
na.clientFunctions = ["redrawHint", "render", "renderTo", "matchCanvasSize", "nodeShapeImpl", "arrowShapeImpl"];
na.init = function(r) {
  var e = this;
  ...
  if (a) {
    ...
    f === "static" && ze("A Cytoscape container has style position:static and so can not use UI extensions properly");
  }
...
[co, bf, wf, aa, Zr, _a].forEach(function(r) {
  ye(na, r);
});
var ms = 1e3 / 60, Cf = {
    ...
    return function() {
      ...
      if (!a.dequeueingSetup) {
        ...
        var i = Na(function() {
          ...
          var f = Xr(), c = n.averageRedrawTime, h = n.lastRedrawTime, d = [], y = n.cy.extent(), g = n.getPixelRatio();
          for (l || n.flushRenderedStyleQueue(); ; ) {
            var p = Xr(), m = p - f, b = p - v;
            if (h < ms) {
              var w = ms - (l ? c : 0);
  ...
  function r(e) {
    var t = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : bn;
    dt(this, r), this.idsByKey = new Kr(), this.keyForId = new Kr(), this.cachesByLvl = new Kr(), this.lvls = [], this.getKey = e, this.doesEleInvalidateKey = t;
  }
  return ht(r, [{
    key: "getIdsFor",
    value: function(t) {
      t == null && He("Can not get id list for null key");
      var a = this.idsByKey, n = this.idsByKey.get(t);
      return n || (n = new jt(), a.set(t, n)), n;
    }
  }, {
    key: "addIdForKey",
    value: function(t, a) {
    ...
    value: function(t) {
      ...
      return i || (i = new Kr(), a.set(t, i), n.push(t)), i;
    }
  }, {
    key: "getCache",
    value: function(t, a) {
...
})(), Il = 25, tn = 50, hn = -4, _s = 3, Tf = 7.99, sy = 8, oy = 1024, uy = 1024, ly = 1024, vy = 0.2, fy = 0.8, cy = 10, dy = 0.15, hy = 0.1, gy = 0.9, py = 0.9, yy = 100, my = 1, Wt = {
  dequeue: "dequeue",
  downscale: "downscale",
  highQuality: "highQuality"
}, by = vr({
  getKey: null,
  doesEleInvalidateKey: bn,
  drawElement: null,
  getBoundingBox: null,
...
tr.getElement = function(r, e, t, a, n) {
  ...
  if (!e || e.w === 0 || e.h === 0 || isNaN(e.w) || isNaN(e.h) || !r.visible() || r.removed() || !i.allowEdgeTxrCaching && r.isEdge() || !i.allowParentTxrCaching && r.isParent())
    return null;
  if (a == null && (a = Math.ceil(js(o * t))), a < hn)
    a = hn;
  else if (o >= Tf || a > _s)
    return null;
  ...
  if (h && h.invalidated && (h.invalidated = !1, h.texture.invalidatedWidth -= h.width), h)
    return h;
  var d;
  if (v <= Il ? d = Il : v <= tn ? d = tn : d = Math.ceil(v / tn) * tn, v > ly || f > uy)
    return null;
  ...
  }, b = n && n === Wt.dequeue, w = n && n === Wt.highQuality, E = n && n === Wt.downscale, C, x = a + 1; x <= _s; x++) {
    var T = u.get(r, x);
    if (T) {
      C = T;
      break;
  ...
  var k = C && C.level === a + 1 ? C : null, D = function() {
  ...
  if (g.context.setTransform(1, 0, 0, 1, 0, 0), g.context.clearRect(g.usedWidth, 0, f, d), m(k))
    ...
    if (w) {
      for (var B = C.level; B > a; B--)
        k = i.getElement(r, e, t, B, Wt.downscale);
      D();
    } else
  ...
  return h = {
    ...
    height: v,
    scaledLabelShown: c
  }, g.usedWidth += Math.ceil(f + sy), g.eleCaches.push(h), u.set(r, a, h), i.checkTextureFullness(g), h;
};
tr.invalidateElements = function(r) {
  for (var e = 0; e < r.length; e++)
    this.invalidateElement(r[e]);
};
tr.invalidateElement = function(r) {
...
tr.checkTextureUtility = function(r) {
  r.invalidatedWidth >= vy * r.width && this.retireTexture(r);
};
tr.checkTextureFullness = function(r) {
  var e = this, t = e.getTextureQueue(r.height);
  r.usedWidth / r.width > fy && r.fullnessChecks >= cy ? ut(t, r) : r.fullnessChecks++;
};
tr.retireTexture = function(r) {
...
tr.addTexture = function(r, e) {
  var t = this, a = t.getTextureQueue(r), n = {};
  return a.push(n), n.eleCaches = [], n.height = r, n.width = Math.max(oy, e), n.usedWidth = 0, n.invalidatedWidth = 0, n.fullnessChecks = 0, n.canvas = t.renderer.makeOffscreenCanvas(n.width, n.height), n.context = n.canvas.getContext("2d"), n;
};
tr.recycleTexture = function(r, e) {
  for (var t = this, a = t.getTextureQueue(r), n = t.getRetiredTextureQueue(r), i = 0; i < n.length; i++) {
    var s = n[i];
    if (s.width >= e)
      return s.retired = !1, s.usedWidth = 0, s.invalidatedWidth = 0, s.fullnessChecks = 0, Js(s.eleCaches), s.context.setTransform(1, 0, 0, 1, 0, 0), s.context.clearRect(0, 0, s.width, s.height), ut(n, s), a.push(s), s;
  }
};
tr.queueElement = function(r, e) {
...
tr.dequeue = function(r) {
  for (var e = this, t = e.getElementQueue(), a = e.getElementKeyToQueue(), n = [], i = e.lookup, s = 0; s < my && t.size() > 0; s++) {
...
tr.removeFromQueue = function(r) {
  var e = this, t = e.getElementQueue(), a = e.getElementKeyToQueue(), n = this.getKey(r), i = a[n];
  i != null && (i.eles.length === 1 ? (i.reqs = Zs, t.updateItem(i), t.pop(), a[n] = null) : i.eles.unmerge(r));
};
tr.onDequeue = function(r) {
  this.onDequeues.push(r);
};
tr.offDequeue = function(r) {
  ut(this.onDequeues, r);
};
tr.setupDequeueing = Cf.setupDequeueing({
...
var wy = 1, ba = -4, Dn = 2, xy = 3.99, Ey = 50, Cy = 50, Ty = 0.15, Sy = 0.1, ky = 0.9, Dy = 0.9, By = 1, Ol = 250, Py = 4e3 * 4e3, Nl = 32767, Ay = !0, Sf = function(e) {
  var t = this, a = t.renderer = e, n = a.cy;
  t.layersByLevel = {}, t.firstGet = !0, t.lastInvalidationTime = Xr() - 2 * Ol, t.skipping = !1, t.eleTxrDeqs = n.collection(), t.scheduleElementRefinement = Na(function() {
    t.refineElementTextures(t.eleTxrDeqs), t.eleTxrDeqs.unmerge(t.eleTxrDeqs);
  }, Cy), a.beforeRender(function(s, o) {
    o - t.lastInvalidationTime <= Ol ? t.skipping = !0 : t.skipping = !1;
  }, a.beforeRenderPriorities.lyrTxrSkip);
  var i = function(o, u) {
    return u.reqs - o.reqs;
  };
  t.layersQueue = new za(i), t.setupDequeueing();
}, fr = Sf.prototype, zl = 0, Ry = Math.pow(2, 53) - 1;
fr.makeLayer = function(r, e) {
...
fr.getLayers = function(r, e, t) {
  ...
  var u = a.layersByLevel, l = Math.pow(2, t), v = u[t] = u[t] || [], f, c = a.levelIsComplete(t, r), h, d = function() {
    var D = function(L) {
      ...
      if (!h)
        for (var I = t + L; ba <= I && I <= Dn && !D(I); I += L)
          ;
    };
    B(1), B(-1);
  ...
  if (a.skipping && !o)
    return null;
  for (var p = null, m = r.length / wy, b = !o, w = 0; w < r.length; w++) {
    var E = r[w], C = E._private.rscratch, x = C.imgLayerCaches = C.imgLayerCaches || {}, T = x[t];
    if (T) {
      p = T;
      continue;
    }
    if ((!p || p.eles.length >= m || !yv(p.bb, E.boundingBox())) && (p = g({
      insert: !0,
      after: p
    }), !p))
      return null;
...
fr.getEleLevelForLayerLevel = function(r, e) {
  return r;
};
fr.drawEleInLayer = function(r, e, t, a) {
  var n = this, i = this.renderer, s = r.context, o = e.boundingBox();
  o.w === 0 || o.h === 0 || !e.visible() || (t = n.getEleLevelForLayerLevel(t, a), i.setImgSmoothing(s, !1), i.drawCachedElement(s, e, null, null, t, Ay), i.setImgSmoothing(s, !0));
};
fr.levelIsComplete = function(r, e) {
...
fr.validateLayersElesOrdering = function(r, e) {
...
fr.updateElementsInLayers = function(r, e) {
  for (var t = this, a = Ma(r[0]), n = 0; n < r.length; n++)
    for (var i = a ? null : r[n], s = a ? r[n] : r[n].ele, o = s._private.rscratch, u = o.imgLayerCaches = o.imgLayerCaches || {}, l = ba; l <= Dn; l++) {
      var v = u[l];
      v && (i && t.getEleLevelForLayerLevel(v.level) !== i.level || e(v, s, i));
    }
};
fr.haveLayers = function() {
  for (var r = this, e = !1, t = ba; t <= Dn; t++) {
...
fr.invalidateElements = function(r) {
  var e = this;
  r.length !== 0 && (e.lastInvalidationTime = Xr(), !(r.length === 0 || !e.haveLayers()) && e.updateElementsInLayers(r, function(a, n, i) {
    e.invalidateLayer(a);
  }));
};
fr.invalidateLayer = function(r) {
  if (this.lastInvalidationTime = Xr(), !r.invalid) {
...
fr.refineElementTextures = function(r) {
  var e = this;
...
fr.enqueueElementRefinement = function(r) {
  this.eleTxrDeqs.merge(r), this.scheduleElementRefinement();
};
fr.queueLayer = function(r, e) {
...
fr.applyLayerReplacement = function(r) {
...
fr.requestRedraw = Na(function() {
  var r = this.renderer;
  r.redrawHint("eles", !0), r.redrawHint("drag", !0), r.redraw();
}, 100);
fr.setupDequeueing = Cf.setupDequeueing({
...
Hr.drawCachedElement = function(r, e, t, a, n, i) {
  ...
  if (!(c.w === 0 || c.h === 0 || !e.visible()) && (!a || ro(c, a))) {
    var d = e.isEdge(), y = e.element()._private.rscratch.badLine;
    s.drawElementUnderlay(r, e), s.drawCachedElementPortion(r, e, u, t, n, h, Ny, qy), (!d || !y) && s.drawCachedElementPortion(r, e, l, t, n, h, zy, bs), d && !y && (s.drawCachedElementPortion(r, e, v, t, n, h, Fy, bs), s.drawCachedElementPortion(r, e, f, t, n, h, Vy, bs)), s.drawElementOverlay(r, e);
  }
};
...
Qr.drawEdge = function(r, e, t) {
  ...
  if (!(i && !e.visible()) && !(o.badLine || o.allpts == null || isNaN(o.allpts[0]))) {
    ...
    if (k) {
      var D = e.pstyle("ghost-offset-x").pfValue, B = e.pstyle("ghost-offset-y").pfValue, P = e.pstyle("ghost-opacity").value, A = p * P;
...
Qr.drawEdgeOverlay = Df("overlay");
Qr.drawEdgeUnderlay = Df("underlay");
Qr.drawEdgePath = function(r, e, t, a) {
...
Qr.drawEdgeTrianglePath = function(r, e, t) {
...
Qr.drawArrowheads = function(r, e, t) {
...
Qr.drawArrowhead = function(r, e, t, a, n, i, s) {
...
Qr.drawArrowShape = function(r, e, t, a, n, i, s, o, u) {
  ...
  if (v) {
    var m = l.arrowPathCache = l.arrowPathCache || [], b = kt(n), w = m[b];
...
var po = {};
po.safeDrawImage = function(r, e, t, a, n, i, s, o, u, l) {
  if (!(n <= 0 || i <= 0 || u <= 0 || l <= 0))
    try {
...
po.drawInscribedImage = function(r, e, t, a, n) {
  ...
  var D = T, B = k;
  if (v(t, "background-width", "value", a) !== "auto" && (v(t, "background-width", "units", a) === "%" ? D = v(t, "background-width", "pfValue", a) * g : D = v(t, "background-width", "pfValue", a)), v(t, "background-height", "value", a) !== "auto" && (v(t, "background-height", "units", a) === "%" ? B = v(t, "background-height", "pfValue", a) * p : B = v(t, "background-height", "pfValue", a)), !(D === 0 || B === 0)) {
    if (f === "contain") {
    ...
    I === "%" ? A += (g - D) * M : A += M;
    var O = u - p / 2, q = v(t, "background-position-y", "units", a), _ = v(t, "background-position-y", "pfValue", a);
    q === "%" ? O += (p - B) * _ : O += _;
    var N = v(t, "background-offset-y", "units", a), F = v(t, "background-offset-y", "pfValue", a);
    N === "%" ? O += (p - B) * F : O += F, m.pathCache && (A -= o, O -= u, o = 0, u = 0);
    var U = r.globalAlpha;
    r.globalAlpha = E;
    var J = i.getImgSmoothing(r), Z = !1;
    if (C === "no" && J ? (i.setImgSmoothing(r, !1), Z = !0) : C === "yes" && !J && (i.setImgSmoothing(r, !0), Z = !0), c === "no-repeat")
      w && (r.save(), m.pathCache ? r.clip(m.pathCache) : (i.nodeShapes[i.getNodeShape(t)].draw(r, o, u, g, p, x, m), r.clip())), i.safeDrawImage(r, e, 0, 0, T, k, A, O, D, B), w && r.restore();
    else {
      var j = r.createPattern(e, c);
      r.fillStyle = j, i.nodeShapes[i.getNodeShape(t)].draw(r, o, u, g, p, x, m), r.translate(A, O), r.fill(), r.translate(-A, -O);
    }
    r.globalAlpha = U, Z && i.setImgSmoothing(r, J);
  }
};
var Mt = {};
Mt.eleTextBiggerThanMin = function(r, e) {
  if (!e) {
    var t = r.cy().zoom(), a = this.getPixelRatio(), n = Math.ceil(js(t * a));
    e = Math.pow(2, n);
  }
...
Mt.drawElementText = function(r, e, t, a, n) {
  ...
  if (e.isNode()) {
    ...
    var l = e.element()._private.rscratch.badLine, v = e.pstyle("label"), f = e.pstyle("source-label"), c = e.pstyle("target-label");
    if (l || (!v || !v.value) && (!f || !f.value) && (!c || !c.value))
      return;
...
Mt.drawText = function(r, e, t) {
  ...
  if (!(n && (o === 0 || e.pstyle("text-opacity").value === 0))) {
    t === "main" && (t = null);
    var u = xr(s, "labelX", t), l = xr(s, "labelY", t), v, f, c = this.getLabelText(e, t);
    if (c != null && c !== "" && !isNaN(u) && !isNaN(l)) {
      this.setupTextStyle(r, e, n);
      var h = t ? t + "-" : "", d = xr(s, "labelWidth", t), y = xr(s, "labelHeight", t), g = e.pstyle(h + "text-margin-x").pfValue, p = e.pstyle(h + "text-margin-y").pfValue, m = e.isEdge(), b = e.pstyle("text-halign").value, w = e.pstyle("text-valign").value;
      m && (b = "center", w = "center"), u += g, l += p;
      var E;
      switch (a ? E = this.getTextAngle(e, t) : E = 0, E !== 0 && (v = u, f = l, r.translate(v, f), r.rotate(E), u = 0, l = 0), w) {
        case "top":
          break;
        case "center":
          l += y / 2;
      ...
      var C = e.pstyle("text-background-opacity").value, x = e.pstyle("text-border-opacity").value, T = e.pstyle("text-border-width").pfValue, k = e.pstyle("text-background-padding").pfValue, D = e.pstyle("text-background-shape").strValue, B = D === "round-rectangle" || D === "roundrectangle", P = D === "circle", A = 2;
      if (C > 0 || T > 0 && x > 0) {
        var R = r.fillStyle, L = r.strokeStyle, I = r.lineWidth, M = e.pstyle("text-background-color").value, O = e.pstyle("text-border-color").value, q = e.pstyle("text-border-style").value, _ = C > 0, N = T > 0 && x > 0, F = u - k;
        switch (b) {
          case "left":
            F -= d;
            break;
        ...
        var U = l - y - k, J = d + 2 * k, Z = y + 2 * k;
        if (_ && (r.fillStyle = "rgba(".concat(M[0], ",").concat(M[1], ",").concat(M[2], ",").concat(C * o, ")")), N && (r.strokeStyle = "rgba(".concat(O[0], ",").concat(O[1], ",").concat(O[2], ",").concat(x * o, ")"), r.lineWidth = T, r.setLineDash))
          switch (q) {
            case "dotted":
              r.setLineDash([1, 1]);
              break;
        ...
        if (B ? (r.beginPath(), ql(r, F, U, J, Z, A)) : P ? (r.beginPath(), _y(r, F, U, J, Z)) : (r.beginPath(), r.rect(F, U, J, Z)), _ && r.fill(), N && r.stroke(), N && q === "double") {
          var j = T / 2;
          r.beginPath(), B ? ql(r, F + j, U + j, J - 2 * j, Z - 2 * j, A) : r.rect(F + j, U + j, J - 2 * j, Z - 2 * j), r.stroke();
        }
      ...
      if (re > 0 && (r.lineWidth = re), e.pstyle("text-wrap").value === "wrap") {
        var ne = xr(s, "labelWrapCachedLines", t), Q = xr(s, "labelLineHeight", t), V = d / 2, H = this.getLabelJustification(e);
        switch (H === "auto" || (b === "left" ? H === "left" ? u += -d : H === "center" && (u += -V) : b === "center" ? H === "left" ? u += -V : H === "right" && (u += V) : b === "right" && (H === "center" ? u += V : H === "right" && (u += d))), w) {
          case "top":
            l -= (ne.length - 1) * Q;
            break;
          case "center":
        ...
        for (var W = 0; W < ne.length; W++)
          re > 0 && r.strokeText(ne[W], u, l), r.fillText(ne[W], u, l), l += Q;
      } else
        re > 0 && r.strokeText(c, u, l), r.fillText(c, u, l);
  ...
  if (!(!ae(f.x) || !ae(f.y)) && !(i && !e.visible())) {
    ...
    for (var m = e.pstyle("background-image"), b = m.value, w = new Array(b.length), E = new Array(b.length), C = 0, x = 0; x < b.length; x++) {
      ...
      if (k) {
        ...
        C++, E[x] = s.getCachedImage(T, D, function() {
          l.backgroundTimestamp = Date.now(), e.emitAndNotify("background");
        });
      }
    }
    var B = e.pstyle("background-blacken").value, P = e.pstyle("border-width").pfValue, A = e.pstyle("background-opacity").value * c, R = e.pstyle("border-color").value, L = e.pstyle("border-style").value, I = e.pstyle("border-join").value, M = e.pstyle("border-cap").value, O = e.pstyle("border-position").value, q = e.pstyle("border-dash-pattern").pfValue, _ = e.pstyle("border-dash-offset").pfValue, N = e.pstyle("border-opacity").value * c, F = e.pstyle("outline-width").pfValue, U = e.pstyle("outline-color").value, J = e.pstyle("outline-style").value, Z = e.pstyle("outline-opacity").value * c, j = e.pstyle("outline-offset").value, re = e.pstyle("corner-radius").value;
    re !== "auto" && (re = e.pstyle("corner-radius").pfValue);
    var ne = function() {
      var S = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : A;
      s.eleFillStyle(r, e, S);
    }, Q = function() {
      var S = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : N;
      s.colorStrokeStyle(r, R[0], R[1], R[2], S);
    }, V = function() {
      var S = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : Z;
      s.colorStrokeStyle(r, U[0], U[1], U[2], S);
    }, H = function(S, z, G, $) {
      var K = s.nodePathCache = s.nodePathCache || [], le = vv(G === "polygon" ? G + "," + $.join(",") : G, "" + z, "" + S, "" + re), ee = K[le], ie, oe = !1;
      return ee != null ? (ie = ee, oe = !0, v.pathCache = ie) : (ie = new Path2D(), K[le] = v.pathCache = ie), {
        path: ie,
        cacheHit: oe
      };
    }, W = e.pstyle("shape").strValue, Y = e.pstyle("shape-polygon-points").pfValue;
    if (h) {
      r.translate(f.x, f.y);
      var te = H(o, u, W, Y);
    ...
    var ce = function() {
      if (!y) {
        ...
        h && (S = {
          x: 0,
          y: 0
        }), s.nodeShapes[s.getNodeShape(e)].draw(d || r, S.x, S.y, o, u, re, v);
      }
      h ? r.fill(d) : r.fill();
    }, Be = function() {
      for (var S = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : c, z = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : !0, G = l.backgrounding, $ = 0, K = 0; K < E.length; K++) {
        var le = e.cy().style().getIndexedStyle(e, "background-image-containment", "value", K);
        if (z && le === "over" || !z && le === "inside") {
          $++;
          continue;
        }
        w[K] && E[K].complete && !E[K].error && ($++, s.drawInscribedImage(r, E[K], e, K, S));
      }
      l.backgrounding = $ !== C, G !== l.backgrounding && e.updateStyle(!1);
    }, we = function() {
      var S = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : !1, z = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : c;
      s.hasPie(e) && (s.drawPie(r, e, z), S && (h || s.nodeShapes[s.getNodeShape(e)].draw(r, f.x, f.y, o, u, re, v)));
    }, me = function() {
      var S = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : !1, z = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : c;
      s.hasStripe(e) && (r.save(), h ? r.clip(v.pathCache) : (s.nodeShapes[s.getNodeShape(e)].draw(r, f.x, f.y, o, u, re, v), r.clip()), s.drawStripe(r, e, z), r.restore(), S && (h || s.nodeShapes[s.getNodeShape(e)].draw(r, f.x, f.y, o, u, re, v)));
    }, ge = function() {
      var S = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : c, z = (B > 0 ? B : -B) * S, G = B > 0 ? 0 : 255;
      B !== 0 && (s.colorFillStyle(r, G, G, G, z), h ? r.fill(d) : r.fill());
    }, se = function() {
      if (P > 0) {
        if (r.lineWidth = P, r.lineCap = M, r.lineJoin = I, r.setLineDash)
          switch (L) {
            case "dotted":
              ...
              break;
            case "dashed":
              r.setLineDash(q), r.lineDashOffset = _;
              break;
            case "solid":
            case "double":
              r.setLineDash([]);
        ...
        if (O !== "center") {
          if (r.save(), r.lineWidth *= 2, O === "inside")
            ...
            var S = new Path2D();
            S.rect(-o / 2 - P, -u / 2 - P, o + 2 * P, u + 2 * P), S.addPath(d), r.clip(S, "evenodd");
          }
        ...
        if (L === "double") {
          r.lineWidth = P / 3;
          var z = r.globalCompositeOperation;
          r.globalCompositeOperation = "destination-out", h ? r.stroke(d) : r.stroke(), r.globalCompositeOperation = z;
        }
      ...
      if (F > 0) {
        ...
        var z = s.getNodeShape(e), G = P;
        O === "inside" && (G = 0), O === "outside" && (G *= 2);
        var $ = (o + G + (F + j)) / o, K = (u + G + (F + j)) / u, le = o * $, ee = u * K, ie = s.nodeShapes[z].points, oe;
        if (h) {
          var pe = H(le, ee, z, ie);
          oe = pe.path;
        }
        if (z === "ellipse")
          s.drawEllipsePath(oe || r, S.x, S.y, le, ee);
          ...
          var Ee = 0, Ce = 0, ve = 0;
          z === "round-diamond" ? Ee = (G + j + F) * 1.4 : z === "round-heptagon" ? (Ee = (G + j + F) * 1.075, ve = -(G / 2 + j + F) / 35) : z === "round-hexagon" ? Ee = (G + j + F) * 1.12 : z === "round-pentagon" ? (Ee = (G + j + F) * 1.13, ve = -(G / 2 + j + F) / 15) : z === "round-tag" ? (Ee = (G + j + F) * 1.12, Ce = (G / 2 + F + j) * 0.07) : z === "round-triangle" && (Ee = (G + j + F) * (Math.PI / 2), ve = -(G + j / 2 + F) / Math.PI), Ee !== 0 && ($ = (o + Ee) / o, le = o * $, ["round-hexagon", "round-tag"].includes(z) || (K = (u + Ee) / u, ee = u * K)), re = re === "auto" ? wv(le, ee) : re;
          for (var ke = le / 2, Pe = ee / 2, ar = re + (G + F + j) / 2, Ue = new Array(ie.length / 2), Pr = new Array(ie.length / 2), Ke = 0; Ke < ie.length / 2; Ke++)
            Ue[Ke] = {
              x: S.x + Ce + ke * ie[Ke * 2],
              y: S.y + ve + Pe * ie[Ke * 2 + 1]
            };
          var Ye, Je, or, Nr, We = Ue.length;
          for (Je = Ue[We - 1], Ye = 0; Ye < We; Ye++)
            or = Ue[Ye % We], Nr = Ue[(Ye + 1) % We], Pr[Ye] = ho(Je, or, Nr, ar), Je = or, or = Nr;
          s.drawRoundPolygonPath(oe || r, S.x + Ce, S.y + ve, o * $, u * K, ie, Pr);
        } else if (["roundrectangle", "round-rectangle"].includes(z))
          re = re === "auto" ? lt(le, ee) : re, s.drawRoundRectanglePath(oe || r, S.x, S.y, le, ee, re + (G + F + j) / 2);
        else if (["cutrectangle", "cut-rectangle"].includes(z))
          re = re === "auto" ? to() : re, s.drawCutRectanglePath(oe || r, S.x, S.y, le, ee, null, re + (G + F + j) / 4);
        else if (["bottomroundrectangle", "bottom-round-rectangle"].includes(z))
          re = re === "auto" ? lt(le, ee) : re, s.drawBottomRoundRectanglePath(oe || r, S.x, S.y, le, ee, re + (G + F + j) / 2);
        else if (z === "barrel")
          s.drawBarrelPath(oe || r, S.x, S.y, le, ee);
        else if (z.startsWith("polygon") || ["rhomboid", "right-rhomboid", "round-tag", "tag", "vee"].includes(z)) {
          var Wr = (G + F + j) / o;
          ie = wn(xn(ie, Wr)), s.drawPolygonPath(oe || r, S.x, S.y, o, u, ie);
        } else {
          var Ar = (G + F + j) / o;
          ie = wn(xn(ie, -Ar)), s.drawPolygonPath(oe || r, S.x, S.y, o, u, ie);
        }
        if (h ? r.stroke(oe) : r.stroke(), J === "double") {
          r.lineWidth = G / 3;
          var Jr = r.globalCompositeOperation;
          r.globalCompositeOperation = "destination-out", h ? r.stroke(oe) : r.stroke(), r.globalCompositeOperation = Jr;
        }
        r.setLineDash && r.setLineDash([]);
      }
    }, fe = function() {
    ...
    if (Se) {
      var De = e.pstyle("ghost-offset-x").pfValue, Oe = e.pstyle("ghost-offset-y").pfValue, Le = e.pstyle("ghost-opacity").value, Ae = Le * c;
      r.translate(De, Oe), V(), de(), ne(Le * A), ce(), Be(Ae, !0), Q(Le * N), se(), we(B !== 0 || P !== 0), me(B !== 0 || P !== 0), Be(Ae, !1), ge(Ae), r.translate(-De, -Oe);
    }
    h && r.translate(-f.x, -f.y), xe(), h && r.translate(f.x, f.y), V(), de(), ne(), ce(), Be(c, !0), Q(), se(), we(B !== 0 || P !== 0), me(B !== 0 || P !== 0), Be(c, !1), ge(), h && r.translate(-f.x, -f.y), be(), fe(), t && r.translate(p.x1, p.y1);
  }
};
var Bf = function(e) {
  if (!["overlay", "underlay"].includes(e))
...
pt.drawNodeOverlay = Bf("overlay");
pt.drawNodeUnderlay = Bf("underlay");
...
mr.createGradientStyleFor = function(r, e, t, a, n) {
  ...
  if (a === "radial-gradient")
    if (t.isEdge()) {
      var l = t.sourceEndpoint(), v = t.targetEndpoint(), f = t.midpoint(), c = Dt(l, f), h = Dt(v, f);
  ...
  if (!i) return null;
  for (var k = u.length === o.length, D = o.length, B = 0; B < D; B++)
    i.addColorStop(k ? u[B] : B / (D - 1), "rgba(" + o[B][0] + "," + o[B][1] + "," + o[B][2] + "," + n + ")");
  return i;
};
...
mr.render = function(r) {
  ...
  function B(Q, V, H, W, Y) {
    var te = Q.globalCompositeOperation;
    Q.globalCompositeOperation = "destination-out", e.colorFillStyle(Q, 255, 255, 255, e.motionBlurTransparency), Q.fillRect(V, H, W, Y), Q.globalCompositeOperation = te;
  }
  function P(Q, V) {
    var H, W, Y, te;
    !e.clearingMotionBlur && (Q === l.bufferContexts[e.MOTIONBLUR_BUFFER_NODE] || Q === l.bufferContexts[e.MOTIONBLUR_BUFFER_DRAG]) ? (H = {
      x: E.x * h,
      y: E.y * h
    }, W = b * h, Y = e.canvasWidth * h, te = e.canvasHeight * h) : (H = C, W = w, Y = e.canvasWidth, te = e.canvasHeight), Q.setTransform(1, 0, 0, 1, 0, 0), V === "motionBlur" ? B(Q, 0, 0, Y, te) : !a && (V === void 0 || V) && Q.clearRect(0, 0, Y, te), n || (Q.translate(H.x, H.y), Q.scale(W, W)), o && Q.translate(o.x, o.y), s && Q.scale(s, s);
  }
  ...
  var O = t.extent(), q = e.pinching || e.hoverData.dragging || e.swipePanning || e.data.wheelZooming || e.hoverData.draggingEles || e.cy.animated(), _ = e.hideEdgesOnViewport && q, N = [];
  if (N[e.NODE] = !v[e.NODE] && c && !e.clearedForMotionBlur[e.NODE] || e.clearingMotionBlur, N[e.NODE] && (e.clearedForMotionBlur[e.NODE] = !0), N[e.DRAG] = !v[e.DRAG] && c && !e.clearedForMotionBlur[e.DRAG] || e.clearingMotionBlur, N[e.DRAG] && (e.clearedForMotionBlur[e.DRAG] = !0), v[e.NODE] || n || i || N[e.NODE]) {
    var F = c && !N[e.NODE] && h !== 1, R = a || (F ? e.data.bufferContexts[e.MOTIONBLUR_BUFFER_NODE] : l.contexts[e.NODE]), U = c && !F ? "motionBlur" : void 0;
    P(R, U), _ ? e.drawCachedNodes(R, D.nondrag, u, O) : e.drawLayeredElements(R, D.nondrag, u, O), e.debug && e.drawDebugPoints(R, D.nondrag), !n && !c && (v[e.NODE] = !1);
  }
  if (!i && (v[e.DRAG] || n || N[e.DRAG])) {
    var F = c && !N[e.DRAG] && h !== 1, R = a || (F ? e.data.bufferContexts[e.MOTIONBLUR_BUFFER_DRAG] : l.contexts[e.DRAG]);
    P(R, c && !F ? "motionBlur" : void 0), _ ? e.drawCachedNodes(R, D.drag, u, O) : e.drawCachedElements(R, D.drag, u, O), e.debug && e.drawDebugPoints(R, D.drag), !n && !c && (v[e.DRAG] = !1);
  }
  if (this.drawSelectionRectangle(r, P), c && h !== 1) {
    var J = l.contexts[e.NODE], Z = e.data.bufferCanvases[e.MOTIONBLUR_BUFFER_NODE], j = l.contexts[e.DRAG], re = e.data.bufferCanvases[e.MOTIONBLUR_BUFFER_DRAG], ne = function(V, H, W) {
      V.setTransform(1, 0, 0, 1, 0, 0), W || !p ? V.clearRect(0, 0, e.canvasWidth, e.canvasHeight) : B(V, 0, 0, e.canvasWidth, e.canvasHeight);
      var Y = h;
      V.drawImage(
        H,
        // img
    ...
    (v[e.NODE] || N[e.NODE]) && (ne(J, Z, N[e.NODE]), v[e.NODE] = !1), (v[e.DRAG] || N[e.DRAG]) && (ne(j, re, N[e.DRAG]), v[e.DRAG] = !1);
  }
...
mr.drawSelectionRectangle = function(r, e) {
  ...
  if (t.showFps || !s && u[t.SELECT_BOX] && !o) {
    ...
    if (t.showFps && d) {
      ...
      if (v.setTransform(1, 0, 0, 1, 0, 0), v.fillStyle = "rgba(255, 0, 0, 0.75)", v.strokeStyle = "rgba(255, 0, 0, 0.75)", v.font = "30px Arial", !ca) {
        var p = v.measureText(g);
        ca = p.actualBoundingBoxAscent;
      }
      v.fillText(g, 0, ca);
      var m = 60;
      v.strokeRect(0, ca + 10, 250, 20), v.fillRect(0, ca + 10, 250 * Math.min(y / m, 1), 20);
    }
    o || (u[t.SELECT_BOX] = !1);
  }
};
...
function Jy(r, e, t, a) {
  var n = Pf(r, e), i = Qe(n, 2), s = i[0], o = i[1], u = Af(r, o, a), l = r.createBuffer();
...
function Fr(r, e, t, a) {
  var n = Pf(r, t), i = Qe(n, 3), s = i[0], o = i[1], u = i[2], l = Af(r, o, e * s), v = s * u, f = r.createBuffer();
...
var am = /* @__PURE__ */ (function() {
  ...
  return ht(r, [{
    ...
    value: function(t, a, n) {
      ...
      var s = this.texSize, o = this.texRows, u = this.texHeight, l = this.getScale(a), v = l.scale, f = l.texW, c = l.texH, h = function(b, w) {
        ...
        {
          var T = i.freePointer.x, k = i.freePointer.row * u, D = E;
          w.context.drawImage(b, 0, 0, D, x, T, k, D, x), d[0] = {
            x: T,
            y: k,
            w: D,
            h: c
        ...
        {
          var B = E, P = (i.freePointer.row + 1) * u, A = C;
          w && w.context.drawImage(b, B, 0, A, x, 0, P, A, x), d[1] = {
            x: 0,
            y: P,
            w: A,
            h: c
    ...
    key: "bufferIfNeeded",
    value: function(t) {
      this.texture || (this.texture = Zy(t, this.debugID)), this.needsBuffer && (this.texture.buffer(this.canvas), this.needsBuffer = !1, this.locked && (this.canvas = null, this.scratch = null));
    }
  }, {
    key: "dispose",
    value: function() {
  ...
  return ht(r, [{
    ...
    value: function() {
      ...
      try {
        var l = function() {
          var f = u.value, c = f.getKeys(), h = im(a, c);
          if (h.size === 0)
          ...
          try {
            for (d.s(); !(y = d.n()).done; ) {
              var g = y.value;
              if (!h.has(g)) {
                var p = f.getOffsets(g), m = Qe(p, 2), b = m[0], w = m[1];
                s.canFit({
                  w: b.w + w.w,
                  h: b.h
    ...
    value: function(t, a, n) {
      var i = a.getOffsets(t), s = Qe(i, 2), o = s[0], u = s[1];
      if (u.w === 0)
...
function im(r, e) {
  return r.intersection ? r.intersection(e) : new Set(pn(r).filter(function(t) {
    return e.has(t);
  }));
}
var sm = /* @__PURE__ */ (function() {
  ...
  return ht(r, [{
    ...
    value: function(t, a) {
      var n = this.globalOptions, i = n.webglTexSize, s = n.createTextureCanvas, o = a.texRows, u = this._cacheScratchCanvas(s), l = new nm(this.r, i, o, u);
    ...
    value: function(t, a) {
      ...
      var i = this.collections.get(n), s = ye({
        type: t,
        atlasCollection: i
      }, a);
              ...
              var m = function() {
                ...
                if (v(E)) {
                  ...
                  if (s)
                    ...
                    var k = w.getID ? w.getID(y) : y.id(), D = a._key(E, k), B = a.typeAndIdToKey.get(D);
                    B !== void 0 && !Xy(T, B) && (f = !0, a.typeAndIdToKey.delete(D), B.forEach(function(P) {
                      return C.markKeyForGC(P);
                    }));
                  }
                }
    ...
    value: function(t, a) {
      ...
      return o.map(function(u) {
        var l = i.getBoundingBox(t, u), v = n.getOrCreateAtlas(t, a, l, u), f = v.getOffsets(u), c = Qe(f, 2), h = c[0], d = c[1];
        return {
          atlas: v,
          tex: h,
          tex1: h,
    ...
    value: function() {
      ...
      try {
        for (a.s(); !(n = a.n()).done; ) {
          var i = Qe(n.value, 2), s = i[0], o = i[1], u = o.getCounts(), l = u.keyCount, v = u.atlasCount;
          t.push({
            type: s,
            keyCount: l,
            atlasCount: v
...
`, wa = {
  ...
  return ht(r, [{
    ...
    */
    ...
    key: "startFrame",
    value: function(t) {
      var a = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : wa.SCREEN;
        ...
        try {
          for (v.s(); !(f = v.n()).done; ) {
            ...
            for (var g = s.getAtlasIndexForBatch(h), p = 0, m = [[d, !0], [y, !1]]; p < m.length; p++) {
              var b = Qe(m[p], 2), w = b[0], E = b[1];
              if (w.w != 0) {
                var C = this.instanceCount;
                this.vertTypeBuffer.getView(C)[0] = xs;
                ...
                this.setTransformMatrix(t, D, o, c, E), this.instanceCount++, E || this.wrappedCount++, this.instanceCount >= this.maxInstances && this.endBatch();
              }
            }
          }
        } catch (B) {
      ...
      if (t.visible()) {
        ...
        if (n === "source" ? (s = i.arrowStartX, o = i.arrowStartY, u = i.srcArrowAngle) : (s = i.arrowEndX, o = i.arrowEndY, u = i.tgtArrowAngle), !(isNaN(s) || s == null || isNaN(o) || o == null || isNaN(u) || u == null)) {
          ...
          if (l !== "none") {
            ...
            Hl(m), gn(m, m, [s, o]), Gs(m, m, [g, g]), Wl(m, m, u), this.vertTypeBuffer.getView(p)[0] = Es;
        ...
        if (n) {
          ...
          if (n.length / 2 + this.instanceCount > this.maxInstances && this.endBatch(), n.length == 4) {
            ...
            for (var y = 0; y < n.length - 2; y += 2) {
              ...
              b[0] = o;
              var w = n[y - 2], E = n[y - 1], C = n[y], x = n[y + 1], T = n[y + 2], k = n[y + 3], D = n[y + 4], B = n[y + 5];
              y == 0 && (w = 2 * C - T + 1e-3, E = 2 * x - k + 1e-3), y == n.length - 4 && (D = 2 * T - C + 1e-3, B = 2 * k - x + 1e-3);
              var P = this.pointAPointBBuffer.getView(g);
              P[0] = w, P[1] = E, P[2] = C, P[3] = x;
              var A = this.pointCPointDBuffer.getView(g);
              A[0] = T, A[1] = k, A[2] = D, A[3] = B, this.instanceCount++, this.instanceCount >= this.maxInstances && this.endBatch();
            }
        }
      }
    }
    ...
    value: function() {
      ...
      if (i !== 0) {
        ...
        t.uniform1f(s.uZoom, $y(this.r)), t.uniformMatrix3fv(s.uPanZoomMatrix, !1, this.panZoomMatrix), t.uniform1i(s.uAtlasSize, this.batchManager.getAtlasSize());
...
Rf.initWebgl = function(r, e) {
  var t = this, a = t.data.contexts[t.WEBGL];
  r.bgColor = dm(t), r.webglTexSize = Math.min(r.webglTexSize, a.getParameter(a.MAX_TEXTURE_SIZE)), r.webglTexRows = Math.min(r.webglTexRows, 54), r.webglTexRowsNodes = Math.min(r.webglTexRowsNodes, 54), r.webglBatchSize = Math.min(r.webglBatchSize, 16384), r.webglTexPerBatch = Math.min(r.webglTexPerBatch, a.getParameter(a.MAX_TEXTURE_IMAGE_UNITS)), t.webglDebug = r.webglDebug, t.webglDebugShowAtlases = r.webglDebugShowAtlases, t.pickingFrameBuffer = em(a), t.pickingFrameBuffer.needsDraw = !0, t.drawing = new cm(t, a, r);
  var n = function(f) {
    return function(c) {
  ...
  t.drawing.addAtlasCollection("node", {
    ...
    collection: "label",
    getTexPickingMode: o,
    getKey: Cs(e.getLabelKey, null),
    getBoundingBox: Ts(e.getLabelBox, null),
    drawClipped: !0,
    ...
    collection: "label",
    getTexPickingMode: o,
    getKey: Cs(e.getSourceLabelKey, "source"),
    getBoundingBox: Ts(e.getSourceLabelBox, "source"),
    drawClipped: !0,
    ...
    collection: "label",
    getTexPickingMode: o,
    getKey: Cs(e.getTargetLabelKey, "target"),
    getBoundingBox: Ts(e.getTargetLabelBox, "target"),
    drawClipped: !0,
...
function Mf(r, e) {
  var t = r._private.rscratch;
  return xr(t, "labelWrapCachedLines", e) || [];
}
var Cs = function(e, t) {
  return function(a) {
    var n = e(a), i = Mf(a, t);
  ...
  return function(a, n) {
    ...
    if (typeof n == "string") {
      var s = n.indexOf("_");
      if (s > 0) {
        var o = Number(n.substring(s + 1)), u = Mf(a, t), l = i.h / u.length, v = l * o, f = i.y1 + v;
        return {
          x1: i.x1,
          w: i.w,
          y1: f,
...
function hm(r) {
  {
    ...
    r.render = function(i) {
      i = i || {};
      var s = r.cy;
      r.webgl && (s.zoom() > Tf ? (gm(r), e.call(r, i)) : (pm(r), If(r, i, wa.SCREEN)));
    };
  }
  {
...
function ym(r) {
  var e = r.canvasWidth, t = r.canvasHeight, a = yo(r), n = a.pan, i = a.zoom, s = ws();
  gn(s, s, [n.x, n.y]), Gs(s, s, [i, i]);
  var o = ws();
  tm(o, e, t);
  var u = ws();
  return rm(u, o, s), u;
...
function Lf(r, e) {
  var t = r.canvasWidth, a = r.canvasHeight, n = yo(r), i = n.pan, s = n.zoom;
...
function bm(r) {
  ...
  e.save(), Lf(r, e), e.strokeStyle = "rgba(0, 0, 0, 0.3)", e.beginPath(), e.moveTo(-1e3, 0), e.lineTo(1e3, 0), e.stroke(), e.beginPath(), e.moveTo(0, -1e3), e.lineTo(0, 1e3), e.stroke(), e.restore();
}
function wm(r) {
...
function xm(r, e, t, a, n) {
  var i, s, o, u, l = yo(r), v = l.pan, f = l.zoom;
  {
    var c = Uy(r, v, f, e, t), h = Qe(c, 2), d = h[0], y = h[1], g = 6;
    i = d - g / 2, s = y - g / 2, o = g, u = g;
  }
  if (o === 0 || u === 0)
    return [];
  var p = r.data.contexts[r.WEBGL];
  p.bindFramebuffer(p.FRAMEBUFFER, r.pickingFrameBuffer), r.pickingFrameBuffer.needsDraw && (p.viewport(0, 0, p.canvas.width, p.canvas.height), If(r, null, wa.PICKING), r.pickingFrameBuffer.needsDraw = !1);
  ...
  for (var w = /* @__PURE__ */ new Set(), E = 0; E < m; E++) {
    var C = b.slice(E * 4, E * 4 + 4), x = Yy(C) - 1;
    x >= 0 && w.add(x);
  }
  return w;
}
function Em(r, e, t) {
  var a = xm(r, e, t), n = r.getCachedZSortedEles(), i, s, o = Cr(a), u;
  try {
    for (o.s(); !(u = o.n()).done; ) {
      var l = u.value, v = n[l];
...
function If(r, e, t) {
  ...
  if (t.screen && r.data.canvasNeedsRedraw[r.SELECT_BOX] && mm(r, e), r.data.canvasNeedsRedraw[r.NODE] || t.picking) {
    ...
    var o = ym(r), u = r.getCachedZSortedEles();
    if (i = u.length, n.startFrame(o, t), t.screen) {
      ...
      for (var f = 0; f < u.length; f++)
        Ss(r, f, u[f]);
    n.endFrame(), t.screen && r.webglDebugShowAtlases && (bm(r), wm(r)), r.data.canvasNeedsRedraw[r.NODE] = !1, r.data.canvasNeedsRedraw[r.DRAG] = !1;
  }
  if (r.webglDebug) {
...
yt.drawRoundRectanglePath = function(r, e, t, a, n, i) {
  var s = a / 2, o = n / 2, u = i === "auto" ? lt(a, n) : Math.min(i, o, s);
...
yt.drawBottomRoundRectanglePath = function(r, e, t, a, n, i) {
  var s = a / 2, o = n / 2, u = i === "auto" ? lt(a, n) : i;
...
yt.drawBarrelPath = function(r, e, t, a, n) {
  var i = a / 2, s = n / 2, o = e - i, u = e + i, l = t - s, v = t + s, f = Bs(a, n), c = f.widthOffset, h = f.heightOffset, d = f.ctrlPtOffsetPct * c;
...
var Kl = Math.sin(0), Xl = Math.cos(0), Hs = {}, Ws = {}, Of = Math.PI / 40;
for (var qt = 0 * Math.PI; qt < 2 * Math.PI; qt += Of)
  Hs[qt] = Math.sin(qt), Ws[qt] = Math.cos(qt);
yt.drawEllipsePath = function(r, e, t, a, n) {
  if (r.beginPath && r.beginPath(), r.ellipse)
    r.ellipse(e, t, a / 2, n / 2, 0, 0, 2 * Math.PI);
  else
    for (var i, s, o = a / 2, u = n / 2, l = 0 * Math.PI; l < 2 * Math.PI; l += Of)
      i = e - o * Hs[l] * Kl + o * Ws[l] * Xl, s = t + u * Ws[l] * Kl + u * Hs[l] * Xl, l === 0 ? r.moveTo(i, s) : r.lineTo(i, s);
  r.closePath();
};
var Ga = {};
...
Ga.png = function(r) {
  return Nf(r, this.bufferCanvasImage(r), "image/png");
};
Ga.jpg = function(r) {
  return Nf(r, this.bufferCanvasImage(r), "image/jpeg");
};
var zf = {};
zf.nodeShapeImpl = function(r, e, t, a, n, i, s, o) {
  switch (r) {
    case "ellipse":
...
function Ff(r) {
  ...
  pc() && (u["-ms-touch-action"] = "none", u["touch-action"] = "none");
  for (var l = 0; l < Te.CANVAS_LAYERS; l++) {
    var v = e.data.canvases[l] = a.createElement("canvas"), f = Te.CANVAS_TYPES[l];
    e.data.contexts[l] = v.getContext(f), e.data.contexts[l] || He("Could not create canvas of type " + f), Object.keys(u).forEach(function(Q) {
      v.style[Q] = u[Q];
    }), v.style.position = "absolute", v.setAttribute("data-id", "layer" + l), v.style.zIndex = String(Te.CANVAS_LAYERS - l), e.data.canvasContainer.appendChild(v), e.data.canvasNeedsRedraw[l] = !1;
  }
  ...
  var c = yr(), h = function(V) {
    ...
    var H = V[0]._private, W = H.oldBackgroundTimestamp === H.backgroundTimestamp;
    return !W;
  }, g = function(V) {
  ...
  }, w = function(V, H, W, Y, te) {
    return e.drawElement(V, H, W, !1, !1, te);
  }, E = function(V, H, W, Y, te) {
    return e.drawElementText(V, H, W, Y, "main", te);
  }, C = function(V, H, W, Y, te) {
    return e.drawElementText(V, H, W, Y, "source", te);
  }, x = function(V, H, W, Y, te) {
    return e.drawElementText(V, H, W, Y, "target", te);
  }, T = function(V) {
    ...
    var Y = V ? V + "-" : "";
    return {
      x: H.x + W.pstyle(Y + "text-margin-x").pfValue,
      y: H.y + W.pstyle(Y + "text-margin-y").pfValue
    };
  }, L = function(V, H, W) {
    var Y = V[0]._private.rscratch;
    return {
      x: Y[H],
      y: Y[W]
    };
    ...
    getRotationOffset: N,
    isVisible: P
  }), re = e.data.lyrTxrCache = new Sf(e);
  e.onUpdateEleCalcs(function(V, H) {
    U.invalidateElements(H), J.invalidateElements(H), Z.invalidateElements(H), j.invalidateElements(H), re.invalidateElements(H);
  ...
  var ne = function(V) {
    for (var H = 0; H < V.length; H++)
      re.enqueueElementRefinement(V[H].ele);
  };
  U.onDequeue(ne), J.onDequeue(ne), Z.onDequeue(ne), j.onDequeue(ne), r.webgl && e.initWebgl(r, {
    getStyleKey: g,
    getLabelKey: p,
    getSourceLabelKey: m,
    getTargetLabelKey: b,
...
Te.makeOffscreenCanvas = function(r, e) {
  var t;
  if ((typeof OffscreenCanvas > "u" ? "undefined" : rr(OffscreenCanvas)) !== "undefined")
...
[kf, Hr, Qr, po, Mt, pt, mr, Rf, yt, Ga, zf].forEach(function(r) {
  ye(Te, r);
});
var km = [{
  name: "null",
...
function _f(r, e, t) {
  var a = t, n = function(T) {
    ze("Can not register `" + e + "` for `" + r + "` since `" + T + "` already exists in the prototype and can not be overridden");
  };
  if (r === "core") {
    if (Pa.prototype[e])
      return n(e);
    ...
    ye(s, {
      createEmitter: function() {
        return this._private.emitter = new qn(c, this), this;
      },
      emitter: function() {
        return this._private.emitter;
      },
    ...
    }), Ne.eventAliasesOn(s), a = i;
  } else if (r === "renderer" && e !== "null" && e !== "base") {
    var h = Gf("renderer", "base"), d = h.prototype, y = t, g = t.prototype, p = function() {
    ...
    d.clientFunctions.forEach(function(x) {
      m[x] = m[x] || function() {
        He("Renderer does not implement `renderer." + x + "()` on its prototype");
      };
    }), a = p;
  } else if (r === "__proto__" || r === "constructor" || r === "prototype")
    return He(r + " is an illegal type to be registered, possibly lead to prototype pollutions");
  return nv({
    map: Vf,
    keys: [r, e],
    value: a
...
At.css = function(r, e) {
  ...
  if (he(r))
    ...
    for (var a = r, n = Object.keys(a), i = 0; i < n.length; i++) {
      var s = n[i], o = a[s];
      if (o != null) {
        var u = ir.properties[s] || ir.properties[An(s)];
        if (u != null) {
          var l = u.name, v = o;
          this[t].properties.push({
            name: l,
...
Jt.use = function(r) {
  ...
  return e.unshift(Jt), r.apply(null, e), this;
};
Jt.warnings = function(r) {
  return cv(r);
};
Jt.version = Am;
Jt.stylesheet = Jt.Stylesheet = Pn;
export {
  Jt as c
};
