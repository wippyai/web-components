import { b as w, aF as F, w as j, u as Y, v as _, aD as r, a4 as H, bj as Q, b4 as V, an as U, ac as $, aQ as P, ak as q, al as z, aP as K, am as W } from "./mermaid.core-FRDjOodn.js";
import { Q as N, G as B } from "./graph-yNRfypD2.js";
import { b as Z, m as R, l as I } from "./layout-DivnQK5l.js";
var ee = 4;
function ne(e) {
  return Z(e, ee);
}
...
function te(e) {
  return R(e.nodes(), function(t) {
    ...
    return N(n) || (i.value = n), N(a) || (i.parent = a), i;
  });
}
function se(e) {
...
var d = /* @__PURE__ */ new Map(), y = /* @__PURE__ */ new Map(), A = /* @__PURE__ */ new Map(), re = /* @__PURE__ */ w(() => {
  y.clear(), A.clear(), d.clear();
  ...
  e !== a && i.push(e), r.warn("Copying (nodes) clusterId", e, "nodes", i), i.forEach((o) => {
    if (t.children(o).length > 0)
      ...
      r.debug("Copying Edges", u), u.forEach((c) => {
        ...
        try {
          ie(c, a) ? (r.info("Copying as ", c.v, c.w, m, c.name), n.setEdge(c.v, c.w, m, c.name), r.info("newGraph edges ", n.edges(), n.edge(n.edges()[0]))) : r.info(
  ...
  return i;
}, "findNonClusterChild"), k = /* @__PURE__ */ w((e) => !d.has(e) || !d.get(e).externalConnections ? e : d.has(e) ? d.get(e).id : e, "getAnchorId"), ae = /* @__PURE__ */ w((e, t) => {
  if (!e || t > 10) {
  ...
  }), r.warn("Adjusted Graph", b(e)), T(e, 0), r.trace(d);
}, "adjustClustersAndEdges"), T = /* @__PURE__ */ w((e, t) => {
  if (r.warn("extractor - ", t, b(e), e.children("D")), t > 10) {
    r.error("Bailing out");
    return;
  }
  let n = e.nodes(), a = !1;
  ...
  for (const i of n)
    if (r.debug(
      ...
      r.warn("Old graph before copy", b(e)), G(i, e, u, i), e.setNode(i, {
        clusterNode: !0,
        id: i,
        clusterData: d.get(i).clusterData,
        label: d.get(i).label,
        graph: u
      }), r.warn("New graph after copy node: (", i, ")", b(u)), r.debug("Old graph after copy", b(e));
    } else
      r.warn(
        "Cluster ** ",
        i,
  ...
  r.warn("Graph in recursive render:XAX", b(t), i);
  ...
  const c = u.insert("g").attr("class", "clusters"), m = u.insert("g").attr("class", "edgePaths"), h = u.insert("g").attr("class", "edgeLabels"), v = u.insert("g").attr("class", "nodes");
  await Promise.all(
...
Parent cluster`,
      ...
      if (r.info("(Insert) Node XXX" + f + ": " + JSON.stringify(t.node(f))), s?.clusterNode) {
        ...
        t.children(f).length > 0 ? (r.trace(
          ...
          "Graph:",
          t
        ), r.trace(C(s.id, t)), d.set(s.id, { id: C(s.id, t), node: s })) : (r.trace("Node - the non recursive path XAX", f, v, t.node(f), l), await U(v, t.node(f), { config: o, dir: l }));
    })
    ...
    await Promise.all(f);
  }, "processEdges"))(), r.info("Graph before layout:", JSON.stringify(b(t))), r.info("############################################# XXX"), r.info("###                Layout                 ### XXX"), r.info("############################################# XXX"), I(t), r.info("Graph after layout:", JSON.stringify(b(t)));
  let O = 0, { subGraphTitleTotalMargin: S } = $(o);
  return await Promise.all(
    ce(t).map(async function(f) {
      ...
      if (r.info(
        ...
        r.debug("OffsetY", p, "labelHeight", E, "halfPadding", g), await q(c, s), d.get(s.id).node = s;
      } else {
  ...
  F(a, e.markers, e.type, e.diagramId), j(), Y(), _(), re(), e.nodes.forEach((o) => {
    ...
    if (o.start === o.end) {
      ...
      const h = structuredClone(o), v = structuredClone(o), X = structuredClone(o);
      h.label = "", h.arrowTypeEnd = "none", h.endLabelLeft = "", h.endLabelRight = "", h.startLabelLeft = "", h.id = l + "-cyclic-special-1", v.startLabelRight = "", v.startLabelLeft = "", v.endLabelLeft = "", v.endLabelRight = "", v.arrowTypeStart = "none", v.arrowTypeEnd = "none", v.id = l + "-cyclic-special-mid", X.label = "", X.startLabelRight = "", X.startLabelLeft = "", X.arrowTypeStart = "none", m.isGroup && (h.fromCluster = l, X.toCluster = l), X.id = l + "-cyclic-special-2", X.arrowTypeStart = "none", n.setEdge(l, u, h, l + "-cyclic-special-0"), n.setEdge(u, c, v, l + "-cyclic-special-1"), n.setEdge(c, l, X, l + "-cyc<lic-special-2");
    } else
      n.setEdge(o.start, o.end, { ...o }, o.id);
  }), r.warn("Graph at first:", JSON.stringify(b(n))), ae(n), r.warn("Graph after XAX:", JSON.stringify(b(n)));
  const i = H();
  await M(
    a,
    n,
