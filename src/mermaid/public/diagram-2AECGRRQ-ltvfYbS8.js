import { b0 as k, a1 as R, a5 as E, b3 as I, a2 as D, b1 as F, b as l, a$ as _, t as z, s as y, a3 as C, S as G, aD as P, ae as W, E as B } from "./mermaid.core-FRDjOodn.js";
import { p as V } from "./chunk-4BX2VUAB-CLXd73Dk.js";
import { p as H } from "./wardley-L42UT6IY-C-B6soca.js";
var h = {
  showLegend: !0,
  ticks: 5,
  max: null,
  ...
  curves: [],
  options: h
}, x = structuredClone(b), j = G.radar, N = /* @__PURE__ */ l(() => y({
  ...j,
  ...C().radar
}), "getConfig"), w = /* @__PURE__ */ l(() => x.axes, "getAxes"), U = /* @__PURE__ */ l(() => x.curves, "getCurves"), X = /* @__PURE__ */ l(() => x.options, "getOptions"), Y = /* @__PURE__ */ l((a) => {
  x.axes = a.map((t) => ({
    name: t.name,
    label: t.label ?? t.name
  }));
}, "setAxes"), Z = /* @__PURE__ */ l((a) => {
  x.curves = a.map((t) => ({
    name: t.name,
    label: t.label ?? t.name,
    entries: q(t.entries)
...
}, "computeCurveEntries"), J = /* @__PURE__ */ l((a) => {
  const t = a.reduce(
    (e, r) => (e[r.name] = r, e),
    {}
  );
  x.options = {
    showLegend: t.showLegend?.value ?? h.showLegend,
    ticks: t.ticks?.value ?? h.ticks,
    max: t.max?.value ?? h.max,
    min: t.min?.value ?? h.min,
    graticule: t.graticule?.value ?? h.graticule
  };
}, "setOptions"), K = /* @__PURE__ */ l(() => {
  z(), x = structuredClone(b);
}, "clear"), $ = {
  getAxes: w,
  getCurves: U,
  getOptions: X,
  ...
  parse: /* @__PURE__ */ l(async (a) => {
    const t = await H("radar", a);
    P.debug(t), Q(t);
  }, "parse")
}, et = /* @__PURE__ */ l((a, t, e, r) => {
  const s = r.db, o = s.getAxes(), i = s.getCurves(), n = s.getOptions(), c = s.getConfig(), d = s.getDiagramTitle(), p = _(t), u = at(p, c), g = n.max ?? Math.max(...i.map((f) => Math.max(...f.entries))), m = n.min, v = Math.min(c.width, c.height) / 2;
  rt(u, o, v, n.ticks, n.graticule), st(u, o, v, c), M(u, o, i, m, g, n.graticule, c), T(u, i, n.showLegend, c), u.append("text").attr("class", "radarTitle").text(d).attr("x", 0).attr("y", -c.height / 2 - c.marginTop);
  ...
  return B(a, r, e, t.useMaxWidth ?? !0), a.attr("viewBox", `0 0 ${e} ${r}`), a.append("g").attr("transform", `translate(${s.x}, ${s.y})`);
}, "drawFrame"), rt = /* @__PURE__ */ l((a, t, e, r, s) => {
  if (s === "circle")
    for (let o = 0; o < r; o++) {
      const i = e * (o + 1) / r;
...
}, "drawGraticule"), st = /* @__PURE__ */ l((a, t, e, r) => {
  const s = t.length;
  for (let o = 0; o < s; o++) {
...
function M(a, t, e, r, s, o, i) {
  ...
  e.forEach((d, p) => {
    ...
    const u = d.entries.map((g, m) => {
      const v = 2 * Math.PI * m / n - Math.PI / 2, f = A(g, r, s, c), S = f * Math.cos(v), O = f * Math.sin(v);
      return { x: S, y: O };
    });
...
l(T, "drawLegend");
var nt = { draw: et }, ot = /* @__PURE__ */ l((a, t) => {
  let e = "";
  ...
  return e;
}, "genIndexStyles"), it = /* @__PURE__ */ l((a) => {
