import { b as w, ae as de, a3 as Q, s as J, a$ as he, E as ue, aD as K, bb as P, a_ as Y, b1 as pe, a2 as fe, b3 as me, a5 as ge, a1 as ye, b0 as Se, S as ve, av as xe, t as be } from "./mermaid.core-FRDjOodn.js";
import { s as we } from "./chunk-2J33WTMH-HCULbuMq.js";
import { p as Ce } from "./chunk-4BX2VUAB-CLXd73Dk.js";
import { p as Te } from "./wardley-L42UT6IY-C-B6soca.js";
import { f as I } from "./defaultLocale-Chz5Z13b.js";
...
function Fe(e, a) {
  for (var n = this, l = [n], r, o, d = -1; n = l.pop(); )
    if (e.call(a, n, ++d, this), r = n.children)
      for (o = r.length - 1; o >= 0; --o)
        l.push(r[o]);
  return this;
}
function Ne(e, a) {
  for (var n = this, l = [n], r = [], o, d, h, m = -1; n = l.pop(); )
...
function Ve(e) {
  return this.eachAfter(function(a) {
    for (var n = +e(a.data) || 0, l = a.children, r = l && l.length; --r >= 0; ) n += l[r].value;
    a.value = n;
  });
}
function _e(e) {
...
function ke(e) {
  for (var a = this, n = ze(a, e), l = [a]; a !== n; )
    a = a.parent, l.push(a);
  for (var r = l.length; e !== n; )
    l.splice(r, 0, e), e = e.parent;
  return l;
}
function ze(e, a) {
  if (e === a) return e;
  var n = e.ancestors(), l = a.ancestors(), r = null;
...
function ee(e, a) {
  e instanceof Map ? (e = [void 0, e], a === void 0 && (a = Ie)) : a === void 0 && (a = He);
  for (var n = new j(e), l, r = [n], o, d, h, m; l = r.pop(); )
    if ((d = a(l.data)) && (m = (d = Array.from(d)).length))
      for (l.children = d, h = m - 1; h >= 0; --h)
        r.push(o = d[h] = new j(d[h])), o.parent = l, o.depth = l.depth + 1;
...
function Ye(e, a, n, l, r) {
  for (var o = e.children, d, h = -1, m = o.length, c = e.value && (l - a) / e.value; ++h < m; )
    d = o[h], d.y0 = n, d.y1 = r, d.x0 = a, d.x1 = a += d.value * c;
}
function je(e, a, n, l, r) {
  for (var o = e.children, d, h = -1, m = o.length, c = e.value && (r - n) / e.value; ++h < m; )
    d = o[h], d.x0 = a, d.x1 = l, d.y0 = n, d.y1 = n += d.value * c;
}
var Ue = (1 + Math.sqrt(5)) / 2;
function Ze(e, a, n, l, r, o) {
  for (var d = [], h = a.children, m, c, u = 0, b = 0, s = h.length, x, S, v = a.value, p, g, M, N, z, E, V; u < s; ) {
    x = r - n, S = o - l;
    do
      p = h[b++].value;
    while (!p && b < s);
    for (g = M = p, E = Math.max(S / x, x / S) / (v * e), V = p * p * E, z = Math.max(M / V, V / g); b < s; ++b) {
...
function Ke() {
  var e = Je, a = !1, n = 1, l = 1, r = [0], o = O, d = O, h = O, m = O, c = O;
  function u(s) {
  ...
  function b(s) {
    ...
    p < S && (S = p = (S + p) / 2), g < v && (v = g = (v + g) / 2), s.x0 = S, s.y0 = v, s.x1 = p, s.y1 = g, s.children && (x = r[s.depth + 1] = o(s) / 2, S += c(s) - x, v += d(s) - x, p -= h(s) - x, g -= m(s) - x, p < S && (S = p = (S + p) / 2), g < v && (v = g = (v + g) / 2), e(s, S, v, p, g));
  }
  return u.round = function(s) {
    ...
    return arguments.length ? (e = qe(s), u) : e;
...
var ae = class {
  ...
  addClass(e, a) {
    ...
    l && l.forEach((r) => {
      xe(r) && (n?.textStyles ? n.textStyles.push(r) : n.textStyles = [r]), n?.styles ? n.styles.push(r) : n.styles = [r];
...
function ne(e) {
  ...
  return e.forEach((l) => {
    ...
    for (r.classSelector = l?.classSelector, l?.cssCompiledStyles && (r.cssCompiledStyles = l.cssCompiledStyles), l.type === "Leaf" && l.value !== void 0 && (r.value = l.value); n.length > 0 && n[n.length - 1].level >= l.level; )
      n.pop();
    if (n.length === 0)
      a.push(r);
    else {
...
var Qe = /* @__PURE__ */ w((e, a) => {
  ...
  for (const o of e.TreemapRows ?? []) {
    ...
    if (!d)
      continue;
    const h = o.indent ? parseInt(o.indent) : 0, m = et(d), c = d.classSelector ? a.getStylesForClass(d.classSelector) : [], u = c.length > 0 ? c : void 0, b = {
      level: h,
      name: m,
      type: d.$type,
      value: d.value,
  ...
  const l = ne(n), r = /* @__PURE__ */ w((o, d) => {
    for (const h of o)
      a.addNode(h, d), h.children && h.children.length > 0 && r(h.children, d + 1);
  }, "addNodesRecursively");
  r(l, 0);
}, "populate"), et = /* @__PURE__ */ w((e) => e.name ? String(e.name) : "", "getItemName"), le = {
  // @ts-expect-error - TreeMapDB is not assignable to DiagramDB
  parser: { yy: void 0 },
  parse: /* @__PURE__ */ w(async (e) => {
    try {
      const n = await Te("treemap", e);
      K.debug("Treemap AST:", n);
      const l = le.parser?.yy;
      if (!(l instanceof ae))
        throw new Error(
...
}, tt = 10, B = 10, q = 25, at = /* @__PURE__ */ w((e, a, n, l) => {
  ...
  const z = b.append("g").attr("transform", `translate(0, ${u})`).attr("class", "treemapContainer"), E = ee(m).sum((t) => t.value ?? 0).sort((t, i) => (i.value ?? 0) - (t.value ?? 0)), te = Ke().size([s, x]).paddingTop(
    (t) => t.children && t.children.length > 0 ? q + B : 0
  ...
  R.append("rect").attr("width", (t) => t.x1 - t.x0).attr("height", q).attr("class", "treemapSectionHeader").attr("fill", "none").attr("fill-opacity", 0.6).attr("stroke-width", 0.6).attr("style", (t) => t.depth === 0 ? "display: none;" : ""), R.append("clipPath").attr("id", (t, i) => `clip-section-${a}-${i}`).append("rect").attr("width", (t) => Math.max(0, t.x1 - t.x0 - 12)).attr("height", q), R.append("rect").attr("width", (t) => t.x1 - t.x0).attr("height", (t) => t.y1 - t.y0).attr("class", (t, i) => `treemapSection section${i}`).attr("fill", (t) => g(t.data.name)).attr("fill-opacity", 0.6).attr("stroke", (t) => M(t.data.name)).attr("stroke-width", 2).attr("stroke-opacity", 0.4).attr("style", (t) => {
    ...
    let $;
    o.showValues !== !1 && t.value ? $ = C - 10 - 30 - 10 - L : $ = C - L - 6;
  ...
  }), o.showValues !== !1 && R.append("text").attr("class", "treemapSectionValue").attr("x", (t) => t.x1 - t.x0 - 10).attr("y", q / 2).attr("text-anchor", "end").attr("dominant-baseline", "middle").text((t) => t.value ? p(t.value) : "").attr("font-style", "italic").attr("style", (t) => {
    if (t.depth === 0)
      return "display: none;";
  ...
  X.append("rect").attr("width", (t) => t.x1 - t.x0).attr("height", (t) => t.y1 - t.y0).attr("class", "treemapLeaf").attr("fill", (t) => t.parent ? g(t.parent.data.name) : g(t.data.name)).attr("style", (t) => P({ cssCompiledStyles: t.data.cssCompiledStyles }).nodeStyles).attr("fill-opacity", 0.3).attr("stroke", (t) => t.parent ? g(t.parent.data.name) : g(t.data.name)).attr("stroke-width", 3), X.append("clipPath").attr("id", (t, i) => `clip-${a}-${i}`).append("rect").attr("width", (t) => Math.max(0, t.x1 - t.x0 - 4)).attr("height", (t) => Math.max(0, t.y1 - t.y0 - 4)), X.append("text").attr("class", "treemapLabel").attr("x", (t) => (t.x1 - t.x0) / 2).attr("y", (t) => (t.y1 - t.y0) / 2).attr("style", (t) => {
  ...
  }), o.showValues !== !1 && X.append("text").attr("class", "treemapValue").attr("x", (i) => (i.x1 - i.x0) / 2).attr("y", function(i) {
    return (i.y1 - i.y0) / 2;
  }).attr("style", (i) => {
    ...
    const k = (i.y1 - i.y0) / 2 + $ / 2 + _;
    f.attr("y", k);
    const W = i.x1 - i.x0, oe = i.y1 - i.y0 - 4, ce = W - 8;
    f.node().getComputedTextLength() > ce || k + F > oe || F < y ? f.style("display", "none") : f.style("display", null);
  });
  const ie = o.diagramPadding ?? 8;
  we(b, ie, "flowchart", o?.useMaxWidth || !1);
}, "draw"), nt = /* @__PURE__ */ w(function(e, a) {
  ...
  const a = de(), n = Q(), l = J(a, n.themeVariables), r = J(rt, e), o = r.titleColor ?? l.titleColor, d = r.labelColor ?? l.textColor, h = r.valueColor ?? l.textColor;
  return `
  .treemapNode.section {
