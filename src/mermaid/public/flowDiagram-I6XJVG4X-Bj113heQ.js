import { g as He } from "./chunk-FMBD7UC4-BsNoqpHi.js";
import { b, b2 as Oe, aD as Q, a4 as g1, aa as qe, aV as Xe, bk as ie, b1 as Qe, b0 as Je, b3 as Ze, a2 as $e, a1 as et, a5 as tt, z as st, aC as it, J as rt, ay as at, a6 as te, a_ as se, aR as nt, t as ut, Q as ot, aY as lt } from "./mermaid.core-FRDjOodn.js";
import { c as ct } from "./chunk-ND2GUHAM-B58vhIOR.js";
import { g as ht } from "./chunk-55IACEB6-Q791aHQa.js";
import { s as dt } from "./chunk-2J33WTMH-HCULbuMq.js";
import { c as pt } from "./channel-AMGqEurk.js";
var ft = "flowchart-", gt = class {
  // cspell:ignore funs
  constructor() {
    this.vertexCounter = 0, this.config = g1(), this.diagramId = "", this.vertices = /* @__PURE__ */ new Map(), this.edges = [], this.classes = /* @__PURE__ */ new Map(), this.subGraphs = [], this.subGraphLookup = /* @__PURE__ */ new Map(), this.tooltips = /* @__PURE__ */ new Map(), this.subCount = 0, this.firstGraphFlag = !0, this.secCount = -1, this.posCrossRef = [], this.funs = [], this.setAccTitle = Qe, this.setAccDescription = Je, this.setDiagramTitle = Ze, this.getAccTitle = $e, this.getAccDescription = et, this.getDiagramTitle = tt, this.funs.push(this.setupToolTips.bind(this)), this.addVertex = this.addVertex.bind(this), this.firstGraph = this.firstGraph.bind(this), this.setDirection = this.setDirection.bind(this), this.addSubGraph = this.addSubGraph.bind(this), this.addLink = this.addLink.bind(this), this.setLink = this.setLink.bind(this), this.updateLink = this.updateLink.bind(this), this.addClass = this.addClass.bind(this), this.setClass = this.setClass.bind(this), this.destructLink = this.destructLink.bind(this), this.setClickEvent = this.setClickEvent.bind(this), this.setTooltip = this.setTooltip.bind(this), this.updateLinkInterpolate = this.updateLinkInterpolate.bind(this), this.setClickFun = this.setClickFun.bind(this), this.bindFunctions = this.bindFunctions.bind(this), this.lex = {
...
` + f + `
    ...
    const A = this.edges.find((E) => E.id === e);
    if (A) {
      const E = n;
      E?.animate !== void 0 && (A.animate = E.animate), E?.animation !== void 0 && (A.animation = E.animation), E?.curve !== void 0 && (A.interpolate = E.curve);
      return;
    }
    let S, g = this.vertices.get(e);
    if (g === void 0 && (i === void 0 && r === void 0 && a !== void 0 && a !== null && Q.warn(
      `Style applied to unknown node "${e}". This may indicate a typo. The node will be created automatically.`
    ), g = {
      id: e,
      labelType: "text",
      domId: ft + e + "-" + this.vertexCounter,
      styles: [],
      classes: []
    }, this.vertices.set(e, g)), this.vertexCounter++, i !== void 0 ? (this.config = g1(), S = this.sanitizeText(i.text.trim()), g.labelType = i.type, S.startsWith('"') && S.endsWith('"') && (S = S.substring(1, S.length - 1)), g.text = S) : g.text === void 0 && (g.text = e), r !== void 0 && (g.type = r), a?.forEach((E) => {
      g.styles.push(E);
    }), o?.forEach((E) => {
      g.classes.push(E);
    }), d !== void 0 && (g.dir = d), g.props === void 0 ? g.props = l : l !== void 0 && Object.assign(g.props, l), n !== void 0) {
      if (n.shape) {
        if (n.shape !== n.shape.toLowerCase() || n.shape.includes("_"))
          throw new Error(`No such shape: ${n.shape}. Shape names should be lowercase.`);
        if (!at(n.shape))
          throw new Error(`No such shape: ${n.shape}.`);
        g.type = n?.shape;
      }
      n?.label && (g.text = n?.label, g.labelType = this.sanitizeNodeLabelType(n?.labelType)), n?.icon && (g.icon = n?.icon, !n.label?.trim() && g.text === e && (g.text = "")), n?.form && (g.form = n?.form), n?.pos && (g.pos = n?.pos), n?.img && (g.img = n?.img, !n.label?.trim() && g.text === e && (g.text = "")), n?.constraint && (g.constraint = n.constraint), n.w && (g.assetWidth = Number(n.w)), n.h && (g.assetHeight = Number(n.h));
    }
  }
  /**
  ...
  addSingleLink(e, i, r, a) {
    ...
    Q.info("abc78 Got edge...", l);
    const f = r.text;
    if (f !== void 0 && (l.text = this.sanitizeText(f.text.trim()), l.text.startsWith('"') && l.text.endsWith('"') && (l.text = l.text.substring(1, l.text.length - 1)), l.labelType = this.sanitizeNodeLabelType(f.type)), r !== void 0 && (l.type = r.type, l.stroke = r.stroke, l.length = r.length > 10 ? 10 : r.length), a && !this.edges.some((n) => n.id === a))
      l.id = a, l.isUserDefinedId = !0;
    else {
      const n = this.edges.filter((A) => A.start === l.start && A.end === l.end);
      n.length === 0 ? l.id = te(l.start, l.end, { counter: 0, prefix: "L" }) : l.id = te(l.start, l.end, {
        counter: n.length + 1,
        prefix: "L"
      });
    }
    if (this.edges.length < (this.config.maxEdges ?? 500))
      Q.info("Pushing edge..."), this.edges.push(l);
    else
      throw new Error(
...
You have to call mermaid.initialize.`
  ...
  addLink(e, i, r) {
    ...
    for (const o of e)
      for (const d of i) {
        const l = o === e[e.length - 1], f = d === i[0];
        l && f ? this.addSingleLink(o, d, r, a) : this.addSingleLink(o, d, r, void 0);
      }
  }
  /**
  ...
  setClickFun(e, i, r) {
    ...
    if (typeof r == "string") {
      ...
      for (let d = 0; d < a.length; d++) {
        let l = a[d].trim();
        l.startsWith('"') && l.endsWith('"') && (l = l.substr(1, l.length - 2)), a[d] = l;
      }
    }
    a.length === 0 && a.push(e);
    const o = this.vertices.get(e);
    o && (o.haveCallback = !0, this.funs.push(() => {
      const d = this.lookUpDomId(e), l = document.querySelector(`[id="${d}"]`);
  ...
  setLink(e, i, r) {
    e.split(",").forEach((a) => {
      ...
      o !== void 0 && (o.link = ie.formatUrl(i, this.config), o.linkTarget = r);
  ...
  setupToolTips(e) {
    const i = ct();
    se(e).select("svg").selectAll("g.node").on("mouseover", (o) => {
      const d = se(o.currentTarget), l = d.attr("title");
      if (l === null)
        return;
      const f = o.currentTarget?.getBoundingClientRect();
      i.transition().duration(200).style("opacity", ".9"), i.text(d.attr("title")).style("left", window.scrollX + f.left + (f.right - f.left) / 2 + "px").style("top", window.scrollY + f.bottom + "px"), i.html(nt.sanitize(l)), d.classed("hover", !0);
    }).on("mouseout", (o) => {
      i.transition().duration(500).style("opacity", 0), se(o.currentTarget).classed("hover", !1);
    });
  }
  /**
   ...
   */
  clear(e = "gen-2") {
    this.vertices = /* @__PURE__ */ new Map(), this.classes = /* @__PURE__ */ new Map(), this.edges = [], this.funs = [this.setupToolTips.bind(this)], this.diagramId = "", this.subGraphs = [], this.subGraphLookup = /* @__PURE__ */ new Map(), this.subCount = 0, this.tooltips = /* @__PURE__ */ new Map(), this.firstGraphFlag = !0, this.version = e, this.config = g1(), ut();
  }
  setGen(e) {
  ...
  addSubGraph(e, i, r) {
    let a = e.text.trim(), o = r.text;
    e === r && /\s/.exec(r.text) && (a = void 0);
    const l = (/* @__PURE__ */ b((g) => {
      const E = { boolean: {}, number: {}, string: {} }, Z = [];
      let _;
      return { nodeList: g.filter(function(K) {
        const h1 = typeof K;
        return K.stmt && K.stmt === "dir" ? (_ = K.value, !1) : K.trim() === "" ? !1 : h1 in E ? E[h1].hasOwnProperty(K) ? !1 : E[h1][K] = !0 : Z.includes(K) ? !1 : Z.push(K);
      }), dir: _ };
    }, "uniq"))(i.flat()), f = l.nodeList;
    let n = l.dir;
    const A = g1().flowchart ?? {};
    if (n = n ?? (A.inheritDir ? this.getDirection() ?? g1().direction ?? void 0 : void 0), this.version === "gen-1")
      for (let g = 0; g < f.length; g++)
        f[g] = this.lookUpDomId(f[g]);
    ...
    return Q.info("Adding", S.id, S.nodes, S.dir), S.nodes = this.makeUniq(S, this.subGraphs).nodes, this.subGraphs.push(S), this.subGraphLookup.set(a, S), a;
  }
  getPosForId(e) {
  ...
  makeUniq(e, i) {
    const r = [];
    return e.nodes.forEach((a, o) => {
      this.exists(i, a) || r.push(e.nodes[o]);
    }), { nodes: r };
  }
  getTypeFromVertex(e) {
    if (e.img)
  ...
  addNodeFromVertex(e, i, r, a, o, d) {
    const l = r.get(e.id), f = a.get(e.id) ?? !1, n = this.findNode(i, e.id);
    if (n)
      n.cssStyles = e.styles, n.cssCompiledStyles = this.getCompiledStyles(e.classes), n.cssClasses = e.classes.join(" ");
    else {
      const A = {
        id: e.id,
        label: e.text,
  ...
  getData() {
    const e = g1(), i = [], r = [], a = this.getSubGraphs(), o = /* @__PURE__ */ new Map(), d = /* @__PURE__ */ new Map();
    for (let n = a.length - 1; n >= 0; n--) {
      const A = a[n];
      A.nodes.length > 0 && d.set(A.id, !0);
    ...
    this.getVertices().forEach((n) => {
      this.addNodeFromVertex(n, i, o, d, e, e.look || "classic");
    });
    const f = this.getEdges();
    return f.forEach((n, A) => {
      const { arrowTypeStart: S, arrowTypeEnd: g } = this.destructEdgeType(n.type), E = [...f.defaultStyle ?? []];
      n.style && E.push(...n.style);
      const Z = {
        id: te(n.start, n.end, { counter: A, prefix: "L" }, n.id),
        ...
        arrowTypeStart: n?.stroke === "invisible" || n?.type === "arrow_open" ? "none" : S,
        arrowTypeEnd: n?.stroke === "invisible" || n?.type === "arrow_open" ? "none" : g,
        ...
        curve: n.interpolate || this.edges.defaultInterpolate || e.flowchart?.curve
      };
      r.push(Z);
...
}, bt = /* @__PURE__ */ b(function(e, i) {
  return i.db.getClasses();
}, "getClasses"), At = /* @__PURE__ */ b(async function(e, i, r, a) {
  Q.info("REF0:"), Q.info("Drawing state diagram (v2)", i);
  const { securityLevel: o, flowchart: d, layout: l } = g1();
  a.db.setDiagramId(i), Q.debug("Before getData: ");
  const f = a.db.getData();
  Q.debug("Data: ", f);
  const n = ht(i, o), A = a.db.getDirection();
  f.type = a.type, f.layoutAlgorithm = qe(l), f.layoutAlgorithm === "dagre" && l === "elk" && Q.warn(
    "flowchart-elk was moved to an external package in Mermaid v11. Please refer [release notes](https://github.com/mermaid-js/mermaid/releases/tag/v11.0.0) for more details. This diagram will be rendered using `dagre` layout as a fallback."
  ), f.direction = A, f.nodeSpacing = d?.nodeSpacing || 50, f.rankSpacing = d?.rankSpacing || 50, f.markers = ["point", "circle", "cross"], f.diagramId = i, Q.debug("REF1:", f), await Xe(f, n);
  const S = f.config.flowchart?.diagramPadding ?? 8;
  ie.insertTitle(
    n,
    "flowchartTitleText",
    d?.titleTopMargin || 0,
    a.db.getDiagramTitle()
  ), dt(n, S, "flowchart", d?.useMaxWidth || !1);
}, "draw"), kt = {
  getClasses: bt,
  draw: At
}, re = (function() {
  var e = /* @__PURE__ */ b(function(f1, c, h, p) {
    ...
    performAction: /* @__PURE__ */ b(function(c, h, p, u, x, t, R1) {
      var s = t.length - 1;
      switch (x) {
        case 2:
          this.$ = [];
    ...
    defaultActions: {},
    parseError: /* @__PURE__ */ b(function(c, h) {
      if (h.recoverable)
        this.trace(c);
      else {
        var p = new Error(c);
    ...
    parse: /* @__PURE__ */ b(function(c) {
      var h = this, p = [0], u = [], x = [null], t = [], R1 = this.table, s = "", B = 0, Re = 0, We = 2, Ne = 1, Ke = t.slice.call(arguments, 1), M = Object.create(this.lexer), A1 = { yy: {} };
      for (var J1 in this.yy)
        Object.prototype.hasOwnProperty.call(this.yy, J1) && (A1.yy[J1] = this.yy[J1]);
      M.setInput(c, A1.yy), A1.yy.lexer = M, A1.yy.parser = this, typeof M.yylloc > "u" && (M.yylloc = {});
      var Z1 = M.yylloc;
      t.push(Z1);
      ...
      function Ye(q) {
        p.length = p.length - 2 * q, x.length = x.length - q, t.length = t.length - q;
      }
      b(Ye, "popStack");
      function Ge() {
        var q;
        return q = u.pop() || M.lex() || Ne, typeof q != "number" && (q instanceof Array && (u = q, q = u.pop()), q = h.symbols_[q] || q), q;
      }
      b(Ge, "lex");
      for (var j, k1, X, $1, w1 = {}, H1, c1, Pe, q1; ; ) {
        if (k1 = p[p.length - 1], this.defaultActions[k1] ? X = this.defaultActions[k1] : ((j === null || typeof j > "u") && (j = Ge()), X = R1[k1] && R1[k1][j]), typeof X > "u" || !X.length || !X[0]) {
          var ee = "";
          q1 = [];
          for (H1 in R1[k1])
            this.terminals_[H1] && H1 > We && q1.push("'" + this.terminals_[H1] + "'");
          M.showPosition ? ee = "Parse error on line " + (B + 1) + `:
` + M.showPosition() + `
Expecting ` + q1.join(", ") + ", got '" + (this.terminals_[j] || j) + "'" : ee = "Parse error on line " + (B + 1) + ": Unexpected " + (j == Ne ? "end of input" : "'" + (this.terminals_[j] || j) + "'"), this.parseError(ee, {
            text: M.match,
        ...
        if (X[0] instanceof Array && X.length > 1)
          throw new Error("Parse Error: multiple actions possible at state: " + k1 + ", token: " + j);
        switch (X[0]) {
          case 1:
            p.push(j), x.push(M.yytext), t.push(M.yylloc), p.push(X[1]), j = null, Re = M.yyleng, s = M.yytext, B = M.yylineno, Z1 = M.yylloc;
            break;
          case 2:
            if (c1 = this.productions_[X[1]][1], w1.$ = x[x.length - c1], w1._$ = {
              ...
              x,
              t
            ].concat(Ke)), typeof $1 < "u")
              return $1;
            c1 && (p = p.slice(0, -1 * c1 * 2), x = x.slice(0, -1 * c1), t = t.slice(0, -1 * c1)), p.push(this.productions_[X[1]][0]), x.push(w1.$), t.push(w1._$), Pe = R1[p[p.length - 2]][p[p.length - 1]], p.push(Pe);
            break;
          case 3:
            return !0;
        }
    ...
    var f1 = {
      EOF: 1,
      parseError: /* @__PURE__ */ b(function(h, p) {
        if (this.yy.parser)
      ...
      setInput: /* @__PURE__ */ b(function(c, h) {
      ...
      unput: /* @__PURE__ */ b(function(c) {
        ...
        }, this.options.ranges && (this.yylloc.range = [x[0], x[0] + this.yyleng - h]), this.yyleng = this.yytext.length, this;
      }, "unput"),
...
` + h + "^";
      ...
      test_match: /* @__PURE__ */ b(function(c, h) {
        var p, u, x;
      ...
      next: /* @__PURE__ */ b(function() {
        ...
        for (var x = this._currentRules(), t = 0; t < x.length; t++)
          if (p = this._input.match(this.rules[x[t]]), p && (!h || p[0].length > h[0].length)) {
            if (h = p, u = t, this.options.backtrack_lexer) {
              if (c = this.test_match(p, x[t]), c !== !1)
                return c;
              if (this._backtrack) {
                h = !1;
                continue;
        ...
        return h ? (c = this.test_match(h, x[u]), c !== !1 ? c : !1) : this._input === "" ? this.EOF : this.parseError("Lexical error on line " + (this.yylineno + 1) + `. Unrecognized text.
` + this.showPosition(), {
          text: "",
          token: null,
          line: this.yylineno
      ...
      options: {},
      performAction: /* @__PURE__ */ b(function(h, p, u, x) {
        switch (u) {
          case 0:
  ...
  return b(Y1, "Parser"), Y1.prototype = Q1, Q1.Parser = Y1, new Y1();
})();
re.parser = re;
var Me = re, Ue = Object.assign({}, Me);
Ue.parse = (e) => {
  const i = e.replace(/}\s*\n/g, `}
`);
  return Me.parse(i);
};
var mt = Ue, Ct = /* @__PURE__ */ b((e, i) => {
  const r = pt, a = r(e, "r"), o = r(e, "g"), d = r(e, "b");
  return lt(a, o, d, i);
}, "fade"), Dt = /* @__PURE__ */ b((e) => `.label {
