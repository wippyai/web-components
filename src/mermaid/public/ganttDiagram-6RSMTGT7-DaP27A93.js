import { R as on, aX as $n, T as cn, X as un, a as ln, aJ as ue, aj as On, a1 as Hn, b0 as Nn, a5 as Pn, b3 as Rn, a2 as Vn, b1 as zn, b as d, a4 as Ft, a_ as Bt, E as qn, O as rt, aD as Tt, z as Zn, V as Bn, t as Xn, bk as Gn } from "./mermaid.core-FRDjOodn.js";
import { g as oe } from "./index.js";
import { b as jn, t as Ne, c as Qn, a as Jn, l as Kn } from "./linear-Covz6sHd.js";
...
function fn(t, e) {
  ...
  function _(S) {
    var Z = r ?? (e.ticks ? e.ticks.apply(e, n) : e.domain()), A = i ?? (e.tickFormat ? e.tickFormat.apply(e, n) : rr), U = Math.max(a, 0) + m, I = e.range(), N = +I[0] + Y, W = +I[I.length - 1] + Y, q = (e.bandwidth ? or : ar)(e.copy(), Y), j = S.selection ? S.selection() : S, p = j.selectAll(".domain").data([null]), g = j.selectAll(".tick").data(Z, e).order(), y = g.exit(), h = g.enter().append("g").attr("class", "tick"), D = g.select("line"), w = g.select("text");
...
Et.every = (t) => (t = Math.floor(t), !isFinite(t) || !(t > 0) ? null : t > 1 ? et((e) => {
...
const wn = Mt(0), re = Mt(1), br = Mt(2), wr = Mt(3), It = Mt(4), Dr = Mt(5), Mr = Mt(6);
wn.range;
re.range;
br.range;
wr.range;
...
function Sr(t, e, n, r, i, a) {
  ...
  function Y(C, k, L) {
    ...
    if (S === 0) return Et.every(Math.max(Ne(C, k, L), 1));
...
function Yr(t) {
  var e = t.dateTime, n = t.date, r = t.time, i = t.periods, a = t.days, c = t.shortDays, m = t.months, Y = t.shortMonths, C = Wt(i), k = $t(i), L = Wt(a), _ = $t(a), S = Wt(c), Z = $t(c), A = Wt(m), U = $t(m), I = Wt(Y), N = $t(Y), W = {
    a: b,
    A: F,
    b: o,
    B: X,
...
function Wt(t) {
  return new RegExp("^(?:" + t.map(Ir).join("|") + ")", "i");
}
function $t(t) {
...
function bi(t, e) {
  return t = Sn(t), B(It.count(wt(t), t) + (wt(t).getUTCDay() === 4), e, 2);
}
function wi(t) {
  return t.getUTCDay();
}
...
function _i(t, e) {
  var n = t.getUTCDay();
  return t = n >= 4 || n === 0 ? It(t) : It.ceil(t), B(t.getUTCFullYear() % 1e4, e, 4);
}
function Fi() {
  return "+0000";
}
...
function _n(t, e, n, r, i, a, c, m, Y, C) {
  ...
  return k.invert = function(p) {
    ...
    return arguments.length ? _(Array.from(p, Ei)) : _().map(Ui);
  }, k.ticks = function(p) {
    var g = _();
    ...
    parse: /* @__PURE__ */ d(function(u) {
      ...
      for (var $, Q, G, it, at = {}, pt, ut, He, Zt; ; ) {
        if (Q = x[x.length - 1], this.defaultActions[Q] ? G = this.defaultActions[Q] : (($ === null || typeof $ > "u") && ($ = J()), G = X[Q] && X[Q][$]), typeof G > "u" || !G.length || !G[0]) {
          ...
          O.showPosition ? ce = "Parse error on line " + (E + 1) + `:
` + O.showPosition() + `
Expecting ` + Zt.join(", ") + ", got '" + (this.terminals_[$] || $) + "'" : ce = "Parse error on line " + (E + 1) + ": Unexpected " + ($ == P ? "end of input" : "'" + (this.terminals_[$] || $) + "'"), this.parseError(ce, {
            text: O.match,
...
rt.extend(Pi);
rt.extend(qi);
var rn = { friday: 5, saturday: 6 }, lt = "", Fe = "", Ye = void 0, Ue = "", Vt = [], zt = [], Ee = /* @__PURE__ */ new Map(), Ie = [], se = [], Lt = "", Le = "", Fn = ["active", "done", "crit", "milestone", "vert"], Ae = [], _t = "", qt = !1, We = !1, $e = "sunday", ae = "saturday", De = 0, Qi = /* @__PURE__ */ d(function() {
  Ie = [], se = [], Lt = "", Ae = [], te = 0, Ce = void 0, ee = void 0, tt = [], lt = "", Fe = "", Le = "", Ye = void 0, Ue = "", Vt = [], zt = [], qt = !1, We = !1, De = 0, Ee = /* @__PURE__ */ new Map(), _t = "", Xn(), $e = "sunday", ae = "saturday";
  ...
  const m = e.add(1e4, "d");
  for (; t <= e; ) {
    if (a || (c = e.toDate()), a = Yn(t, n, r, i), a && (e = e.add(1, "d"), e > m))
      throw new Error(
...
}, "getStartDate"), En = /* @__PURE__ */ d(function(t) {
  const e = /^(\d+(?:\.\d+)?)([Mdhmswy]|ms)$/.exec(t.trim());
  return e !== null ? [Number.parseFloat(e[1]), e[2]] : [NaN, "ms"];
}, "parseDuration"), In = /* @__PURE__ */ d(function(t, e, n, r = !1) {
  n = n.trim();
  ...
  return a && (i.endTime = In(i.startTime, lt, a, qt), i.manualEndTime = rt(a, "YYYY-MM-DD", !0).isValid(), Un(i, lt, zt, Vt)), i;
  ...
  const t = /* @__PURE__ */ d(function(n) {
    ...
    return tt[n].startTime && (tt[n].endTime = In(
      tt[n].startTime,
      lt,
...
}, "setClickEvent"), Es = /* @__PURE__ */ d(function(t) {
...
var Ls = /* @__PURE__ */ d(function() {
  ...
  const Z = m.select(`[id="${e}"]`), A = Ii().domain([
    nr(k, function(h) {
      return h.startTime;
    }),
    er(k, function(h) {
  ...
  d(U, "taskCompare"), k.sort(U), I(k, dt, S), qn(Z, S, dt, i.useMaxWidth), Z.append("text").text(r.db.getDiagramTitle()).attr("x", dt / 2).attr("y", i.titleTopMargin).attr("class", "titleText");
  function I(h, D, w) {
  ...
  function N(h, D, w, T, v, u, f) {
    ...
    if (F.append("rect").attr("id", function(s) {
      ...
      F.filter(function(z) {
        ...
        var V = E.querySelector("#" + CSS.escape(e + "-" + z.id)), P = E.querySelector("#" + CSS.escape(e + "-" + z.id + "-text"));
