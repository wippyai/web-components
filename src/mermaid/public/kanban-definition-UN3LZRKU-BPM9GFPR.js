import { b as o, aD as te, a4 as H, a$ as fe, ak as ye, an as be, aQ as me, b6 as ke, S as K, aZ as F, aC as Ee, J as _e, au as Se, az as ce, L as le } from "./mermaid.core-FRDjOodn.js";
import { g as Ne } from "./chunk-FMBD7UC4-BsNoqpHi.js";
var $ = (function() {
  var e = /* @__PURE__ */ o(function(O, s, n, r) {
    for (n = n || {}, r = O.length; r--; n[O[r]] = s) ;
    return n;
  }, "o"), h = [1, 4], p = [1, 13], i = [1, 12], d = [1, 15], k = [1, 16], m = [1, 20], l = [1, 19], D = [6, 7, 8], I = [1, 26], g = [1, 24], w = [1, 25], E = [6, 7, 11], G = [1, 31], N = [6, 7, 11, 24], V = [1, 6, 13, 16, 17, 20, 23], f = [1, 35], A = [1, 36], L = [1, 6, 7, 11, 13, 16, 17, 20, 23], M = [1, 38], T = {
    ...
    performAction: /* @__PURE__ */ o(function(s, n, r, a, u, t, U) {
      var c = t.length - 1;
      switch (u) {
        case 6:
        case 7:
    ...
    parse: /* @__PURE__ */ o(function(s) {
      var n = this, r = [0], a = [], u = [null], t = [], U = this.table, c = "", W = 0, ie = 0, ue = 2, re = 1, ge = t.slice.call(arguments, 1), b = Object.create(this.lexer), R = { yy: {} };
      for (var J in this.yy)
        Object.prototype.hasOwnProperty.call(this.yy, J) && (R.yy[J] = this.yy[J]);
      b.setInput(s, R.yy), R.yy.lexer = b, R.yy.parser = this, typeof b.yylloc > "u" && (b.yylloc = {});
      var Q = b.yylloc;
      t.push(Q);
      ...
      o(ae, "lex");
      for (var _, P, x, Z, j = {}, z, C, oe, X; ; ) {
        if (P = r[r.length - 1], this.defaultActions[P] ? x = this.defaultActions[P] : ((_ === null || typeof _ > "u") && (_ = ae()), x = U[P] && U[P][_]), typeof x > "u" || !x.length || !x[0]) {
          var q = "";
          X = [];
          for (z in U[P])
            this.terminals_[z] && z > ue && X.push("'" + this.terminals_[z] + "'");
          b.showPosition ? q = "Parse error on line " + (W + 1) + `:
` + b.showPosition() + `
Expecting ` + X.join(", ") + ", got '" + (this.terminals_[_] || _) + "'" : q = "Parse error on line " + (W + 1) + ": Unexpected " + (_ == re ? "end of input" : "'" + (this.terminals_[_] || _) + "'"), this.parseError(q, {
            text: b.match,
        ...
        switch (x[0]) {
          case 1:
            r.push(_), u.push(b.yytext), t.push(b.yylloc), r.push(x[1]), _ = null, ie = b.yyleng, c = b.yytext, W = b.yylineno, Q = b.yylloc;
            break;
          case 2:
            if (C = this.productions_[x[1]][1], j.$ = u[u.length - C], j._$ = {
              ...
              u,
              t
            ].concat(ge)), typeof Z < "u")
              return Z;
            C && (r = r.slice(0, -1 * C * 2), u = u.slice(0, -1 * C), t = t.slice(0, -1 * C)), r.push(this.productions_[x[1]][0]), u.push(j.$), t.push(j._$), oe = U[r[r.length - 2]][r[r.length - 1]], r.push(oe);
            break;
          case 3:
            return !0;
        }
    ...
    var O = {
      ...
      setInput: /* @__PURE__ */ o(function(s, n) {
...
` + n + "^";
      ...
      test_match: /* @__PURE__ */ o(function(s, n) {
        var r, a, u;
        ...
        }, this.options.ranges && (u.yylloc.range = this.yylloc.range.slice(0))), a = s[0].match(/(?:\r\n?|\n).*/g), a && (this.yylineno += a.length), this.yylloc = {
          first_line: this.yylloc.last_line,
          last_line: this.yylineno + 1,
          first_column: this.yylloc.last_column,
          last_column: a ? a[a.length - 1].length - a[a.length - 1].match(/\r?\n?/)[0].length : this.yylloc.last_column + s[0].length
        }, this.yytext += s[0], this.match += s[0], this.matches = s, this.yyleng = this.yytext.length, this.options.ranges && (this.yylloc.range = [this.offset, this.offset += this.yyleng]), this._more = !1, this._backtrack = !1, this._input = this._input.slice(s[0].length), this.matched += s[0], r = this.performAction.call(this, this.yy, this, n, this.conditionStack[this.conditionStack.length - 1]), this.done && this._input && (this.done = !1), r)
          return r;
        if (this._backtrack) {
          for (var t in u)
            this[t] = u[t];
      ...
      next: /* @__PURE__ */ o(function() {
        ...
        for (var u = this._currentRules(), t = 0; t < u.length; t++)
          if (r = this._input.match(this.rules[u[t]]), r && (!n || r[0].length > n[0].length)) {
            if (n = r, a = t, this.options.backtrack_lexer) {
              if (s = this.test_match(r, u[t]), s !== !1)
                return s;
              if (this._backtrack) {
                n = !1;
                continue;
        ...
        return n ? (s = this.test_match(n, u[a]), s !== !1 ? s : !1) : this._input === "" ? this.EOF : this.parseError("Lexical error on line " + (this.yylineno + 1) + `. Unrecognized text.
` + this.showPosition(), {
          text: "",
          token: null,
          line: this.yylineno
...
$.parser = $;
var xe = $, v = [], ne = [], ee = 0, se = {}, ve = /* @__PURE__ */ o(() => {
  v = [], ne = [], ee = 0, se = {};
  ...
  for (let i = v.length - 1; i >= 0; i--)
    if (v[i].level === h && !p && (p = v[i]), v[i].level < h)
      throw new Error('Items without section detected, found section ("' + v[i].label + '")');
  ...
  return { nodes: h, edges: e, other: {}, config: H() };
}, "getData"), Oe = /* @__PURE__ */ o((e, h, p, i, d) => {
  const k = H();
  let m = k.mindmap?.padding ?? K.mindmap.padding;
  switch (i) {
    case y.ROUNDED_RECT:
    case y.RECT:
    case y.HEXAGON:
  ...
  const l = {
    ...
    level: e,
    label: F(p, k),
    width: k.mindmap?.maxNodeWidth ?? K.mindmap.maxNodeWidth,
    padding: m,
    isGroup: !1
  };
  if (d !== void 0) {
...
` + d + `
...
}, "type2Str"), Te = /* @__PURE__ */ o(() => te, "getLogger"), Re = /* @__PURE__ */ o((e) => se[e], "getElementById"), Pe = {
  clear: ve,
  addNode: Oe,
  getSections: he,
  getData: Le,
  ...
  getLogger: Te,
  getElementById: Re
}, Ve = Pe, Be = /* @__PURE__ */ o(async (e, h, p, i) => {
  te.debug(`Rendering kanban diagram
` + e);
  const k = i.db.getData(), m = H();
  m.htmlLabels = !1;
  const l = fe(h);
  ...
  for (const f of g) {
    const A = G[V];
    V = V + 1;
    const L = m?.kanban?.sectionWidth || 200, M = -L * 3 / 2 + N;
    let T = M;
    const Y = k.nodes.filter((s) => s.parentId === f.id);
    for (const s of Y) {
      if (s.isGroup)
        throw new Error("Groups within groups are not allowed in Kanban diagrams");
      s.x = f.x, s.width = L - 1.5 * E;
      const r = (await be(I, s, { config: m })).node().getBBox();
      s.y = T + r.height / 2, await me(s), T = s.y + r.height / 2 + E / 2;
    }
    const B = A.cluster.select("rect"), O = Math.max(T - M + 3 * E, 50) + (N - 25);
    B.attr("height", O);
  }
  ke(
    void 0,
  ...
  for (let i = 0; i < e.THEME_COLOR_LIMIT; i++)
    e["lineColor" + i] = e["lineColor" + i] || e["cScaleInv" + i], Se(e["lineColor" + i]) ? e["lineColor" + i] = ce(e["lineColor" + i], 20) : e["lineColor" + i] = le(e["lineColor" + i], 20);
  const p = /* @__PURE__ */ o((i, d) => e.darkMode ? le(i, d) : ce(i, d), "adjuster");
  for (let i = 0; i < e.THEME_COLOR_LIMIT; i++) {
    const d = "" + (17 - 3 * i);
    h += `
    .section-${i - 1} rect, .section-${i - 1} path, .section-${i - 1} circle, .section-${i - 1} polygon, .section-${i - 1} path  {
      fill: ${p(e["cScale" + i], 10)};
      stroke: ${p(e["cScale" + i], 10)};
