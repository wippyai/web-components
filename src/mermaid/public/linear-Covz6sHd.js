import { G as j, ar as p, x as w, as as k, at as q } from "./mermaid.core-FRDjOodn.js";
import { i as D } from "./init-DjUOC4st.js";
import { e as g, b as F, a as x, f as z } from "./defaultLocale-Chz5Z13b.js";
function M(n, r) {
...
const V = R(M), $ = V.right;
R(P).center;
const G = Math.sqrt(50), O = Math.sqrt(10), T = Math.sqrt(2);
function v(n, r, t) {
  const e = (r - n) / Math.max(0, t), u = Math.floor(Math.log10(e)), f = e / Math.pow(10, u), a = f >= G ? 10 : f >= O ? 5 : f >= T ? 2 : 1;
  let o, c, i;
...
function an(n, r, t, e) {
  ...
  switch (e = F(e ?? ",f"), e.type) {
    case "s": {
      ...
      return e.precision == null && !isNaN(f = X(u, a)) && (e.precision = f), x(e, a);
    }
    case "":
    case "e":
    case "g":
