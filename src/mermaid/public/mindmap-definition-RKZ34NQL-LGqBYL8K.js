import { g as ae } from "./chunk-55IACEB6-Q791aHQa.js";
import { s as oe } from "./chunk-2J33WTMH-HCULbuMq.js";
import { b as l, aD as C, aa as ce, aV as le, a3 as he, S as G, a4 as B, aZ as F, ag as de, au as ge, az as ue, L as pe } from "./mermaid.core-FRDjOodn.js";
const E = [];
for (let e = 0; e < 256; ++e)
...
function _e(e, n, g) {
  e = e || {};
  const o = e.random ?? e.rng?.() ?? ye();
  if (o.length < 16)
    throw new Error("Random bytes length must be >= 16");
  return o[6] = o[6] & 15 | 64, o[8] = o[8] & 63 | 128, fe(o);
}
var Y = (function() {
  var e = /* @__PURE__ */ l(function(D, s, i, a) {
    for (i = i || {}, a = D.length; a--; i[D[a]] = s) ;
    return i;
  }, "o"), n = [1, 4], g = [1, 13], o = [1, 12], t = [1, 15], h = [1, 16], f = [1, 20], m = [1, 19], _ = [6, 7, 8], T = [1, 26], I = [1, 24], w = [1, 25], d = [6, 7, 11], R = [1, 6, 13, 15, 16, 19, 22], Z = [1, 33], q = [1, 34], A = [1, 6, 7, 11, 13, 15, 16, 19, 22], j = {
    ...
    performAction: /* @__PURE__ */ l(function(s, i, a, c, p, r, $) {
      var u = r.length - 1;
      switch (p) {
        case 6:
        case 7:
    ...
    parse: /* @__PURE__ */ l(function(s) {
      var i = this, a = [0], c = [], p = [null], r = [], $ = this.table, u = "", M = 0, J = 0, ne = 2, K = 1, ie = r.slice.call(arguments, 1), y = Object.create(this.lexer), L = { yy: {} };
      ...
      function re(k) {
        a.length = a.length - 2 * k, p.length = p.length - k, r.length = r.length - k;
      }
      l(re, "popStack");
      function Q() {
        var k;
        return k = c.pop() || y.lex() || K, typeof k != "number" && (k instanceof Array && (c = k, k = c.pop()), k = i.symbols_[k] || k), k;
      }
      l(Q, "lex");
      for (var b, v, S, W, O = {}, U, x, ee, V; ; ) {
        if (v = a[a.length - 1], this.defaultActions[v] ? S = this.defaultActions[v] : ((b === null || typeof b > "u") && (b = Q()), S = $[v] && $[v][b]), typeof S > "u" || !S.length || !S[0]) {
          var X = "";
          V = [];
          for (U in $[v])
...
` + y.showPosition() + `
Expecting ` + V.join(", ") + ", got '" + (this.terminals_[b] || b) + "'" : X = "Parse error on line " + (M + 1) + ": Unexpected " + (b == K ? "end of input" : "'" + (this.terminals_[b] || b) + "'"), this.parseError(X, {
            text: y.match,
        ...
        switch (S[0]) {
          case 1:
            a.push(b), p.push(y.yytext), r.push(y.yylloc), a.push(S[1]), b = null, J = y.yyleng, u = y.yytext, M = y.yylineno, z = y.yylloc;
            break;
          case 2:
            if (x = this.productions_[S[1]][1], O.$ = p[p.length - x], O._$ = {
              ...
              p,
              r
            ].concat(ie)), typeof W < "u")
              return W;
            x && (a = a.slice(0, -1 * x * 2), p = p.slice(0, -1 * x), r = r.slice(0, -1 * x)), a.push(this.productions_[S[1]][0]), p.push(O.$), r.push(O._$), ee = $[a[a.length - 2]][a[a.length - 1]], a.push(ee);
            break;
          case 3:
            return !0;
        }
    ...
    var D = {
      ...
      unput: /* @__PURE__ */ l(function(s) {
        ...
        return this.yylloc = {
          ...
          last_column: a ? (a.length === c.length ? this.yylloc.first_column : 0) + c[c.length - a.length].length - a[0].length : this.yylloc.first_column - i
        ...
        for (var p = this._currentRules(), r = 0; r < p.length; r++)
          if (a = this._input.match(this.rules[p[r]]), a && (!i || a[0].length > i[0].length)) {
            if (i = a, c = r, this.options.backtrack_lexer) {
              if (s = this.test_match(a, p[r]), s !== !1)
                return s;
              if (this._backtrack) {
                i = !1;
                continue;
...
` + this.showPosition(), {
      ...
      performAction: /* @__PURE__ */ l(function(i, a, c, p) {
        switch (c) {
          case 0:
...
var be = Y, ke = 12, N = {
  ...
  assignSections(e, n) {
    if (e.level === 0 ? e.section = void 0 : e.section = n, e.children)
      for (const [g, o] of e.children.entries()) {
        const t = e.level === 0 ? g % (ke - 1) : n;
        this.assignSections(o, t);
      }
  }
  /**
   ...
   */
  flattenNodes(e, n) {
    const g = B(), o = ["mindmap-node"];
    e.isRoot === !0 ? o.push("section-root", "section--1") : e.section !== void 0 && o.push(`section-${e.section}`), e.class && o.push(e.class);
    const t = o.join(" "), h = /* @__PURE__ */ l((m) => {
  ...
  generateEdges(e, n) {
    ...
    for (const o of e.children) {
      let t = "edge";
      o.section !== void 0 && (t += ` section-edge-${o.section}`);
      const h = e.level + 1;
      t += ` edge-depth-${h}`;
      const f = {
        id: `edge_${e.id}_${o.id}`,
        start: e.id.toString(),
        end: o.id.toString(),
        type: "normal",
        curve: "basis",
      ...
      n.push(f), this.generateEdges(o, n);
    }
  }
  /**
   ...
   */
  getData() {
    const e = this.getMindmap(), n = B(), o = de().layout !== void 0, t = n;
    if (o || (t.layout = "cose-bilkent"), !e)
      return {
        nodes: [],
        edges: [],
        config: t
...
}, xe = /* @__PURE__ */ l(async (e, n, g, o) => {
  C.debug(`Rendering mindmap diagram
` + e);
  const t = o.db, h = t.getData(), f = ae(n, h.config.securityLevel);
  if (h.type = o.type, h.layoutAlgorithm = ce(h.config.layout, {
  ...
  const { theme: n } = e, g = e.svgId, o = e.dropShadow ? e.dropShadow.replace("url(#drop-shadow)", `url(${g}-drop-shadow)`) : "none";
  return `
  .edge {
    stroke-width: 3;
  }
