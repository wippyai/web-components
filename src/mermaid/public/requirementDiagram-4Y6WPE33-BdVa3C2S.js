import { g as Ge } from "./chunk-55IACEB6-Q791aHQa.js";
import { s as ze } from "./chunk-2J33WTMH-HCULbuMq.js";
import { b as h, a3 as Ye, b1 as Xe, a2 as Je, b0 as Ze, a1 as et, b3 as tt, a5 as st, a4 as Te, aD as Ne, t as it, _ as rt, aa as nt, aV as at, bk as lt } from "./mermaid.core-FRDjOodn.js";
var qe = (function() {
  var e = /* @__PURE__ */ h(function($, r, a, c) {
    for (a = a || {}, c = $.length; c--; a[$[c]] = r) ;
    return a;
  }, "o"), u = [1, 3], o = [1, 4], n = [1, 5], i = [1, 6], f = [5, 6, 8, 9, 11, 13, 21, 22, 23, 24, 41, 42, 43, 44, 45, 46, 54, 72, 74, 77, 89, 90], _ = [1, 22], E = [2, 7], g = [1, 26], S = [1, 27], k = [1, 28], q = [1, 29], C = [1, 33], A = [1, 34], V = [1, 35], v = [1, 36], L = [1, 37], x = [1, 38], O = [1, 24], w = [1, 31], D = [1, 32], M = [1, 30], p = [1, 39], R = [1, 40], d = [5, 8, 9, 11, 13, 21, 22, 23, 24, 41, 42, 43, 44, 45, 46, 54, 72, 74, 77, 89, 90], P = [1, 61], X = [89, 90], Ce = [5, 8, 9, 11, 13, 21, 22, 23, 24, 27, 29, 41, 42, 43, 44, 45, 46, 54, 61, 63, 72, 74, 75, 76, 77, 80, 81, 82, 83, 84, 85, 86, 87, 88, 89, 90], de = [27, 29], Ae = [1, 70], Ve = [1, 71], ve = [1, 72], Le = [1, 73], xe = [1, 74], Oe = [1, 75], we = [1, 76], Z = [1, 83], U = [1, 80], ee = [1, 84], te = [1, 85], se = [1, 86], ie = [1, 87], re = [1, 88], ne = [1, 89], ae = [1, 90], le = [1, 91], ce = [1, 92], Ee = [5, 8, 9, 11, 13, 21, 22, 23, 24, 27, 41, 42, 43, 44, 45, 46, 54, 72, 74, 75, 76, 77, 80, 81, 82, 83, 84, 85, 86, 87, 88, 89, 90], Y = [63, 64], De = [1, 101], Me = [5, 8, 9, 11, 13, 21, 22, 23, 24, 41, 42, 43, 44, 45, 46, 54, 72, 74, 76, 77, 89, 90], T = [5, 8, 9, 11, 13, 21, 22, 23, 24, 41, 42, 43, 44, 45, 46, 54, 72, 74, 75, 76, 77, 80, 81, 82, 83, 84, 85, 86, 87, 88, 89, 90], B = [1, 110], Q = [1, 106], H = [1, 107], K = [1, 108], W = [1, 109], j = [1, 111], oe = [1, 116], he = [1, 117], ue = [1, 114], fe = [1, 115], _e = {
    ...
    performAction: /* @__PURE__ */ h(function(r, a, c, s, m, t, me) {
      var l = t.length - 1;
      switch (m) {
        case 4:
    ...
    parseError: /* @__PURE__ */ h(function(r, a) {
      if (a.recoverable)
        this.trace(r);
      else {
        var c = new Error(r);
    ...
    parse: /* @__PURE__ */ h(function(r) {
      var a = this, c = [0], s = [], m = [null], t = [], me = this.table, l = "", Re = 0, Fe = 0, He = 2, $e = 1, Ke = t.slice.call(arguments, 1), y = Object.create(this.lexer), G = { yy: {} };
      ...
      function je(I) {
        c.length = c.length - 2 * I, m.length = m.length - I, t.length = t.length - I;
      }
      h(je, "popStack");
      function Pe() {
        var I;
        return I = s.pop() || y.lex() || $e, typeof I != "number" && (I instanceof Array && (s = I, I = s.pop()), I = a.symbols_[I] || I), I;
      }
      h(Pe, "lex");
      for (var b, z, N, Ie, J = {}, ge, F, Ue, ye; ; ) {
        if (z = c[c.length - 1], this.defaultActions[z] ? N = this.defaultActions[z] : ((b === null || typeof b > "u") && (b = Pe()), N = me[z] && me[z][b]), typeof N > "u" || !N.length || !N[0]) {
          var ke = "";
          ye = [];
          for (ge in me[z])
...
Expecting ` + ye.join(", ") + ", got '" + (this.terminals_[b] || b) + "'" : ke = "Parse error on line " + (Re + 1) + ": Unexpected " + (b == $e ? "end of input" : "'" + (this.terminals_[b] || b) + "'"), this.parseError(ke, {
        ...
        switch (N[0]) {
          case 1:
            c.push(b), m.push(y.yytext), t.push(y.yylloc), c.push(N[1]), b = null, Fe = y.yyleng, l = y.yytext, Re = y.yylineno, be = y.yylloc;
            break;
          case 2:
            if (F = this.productions_[N[1]][1], J.$ = m[m.length - F], J._$ = {
              ...
              return Ie;
            F && (c = c.slice(0, -1 * F * 2), m = m.slice(0, -1 * F), t = t.slice(0, -1 * F)), c.push(this.productions_[N[1]][0]), m.push(J.$), t.push(J._$), Ue = me[c[c.length - 2]][c[c.length - 1]], c.push(Ue);
            break;
          case 3:
            return !0;
        }
    ...
    var $ = {
      EOF: 1,
      parseError: /* @__PURE__ */ h(function(a, c) {
        if (this.yy.parser)
      ...
      setInput: /* @__PURE__ */ h(function(r, a) {
...
` + a + "^";
      ...
      test_match: /* @__PURE__ */ h(function(r, a) {
        var c, s, m;
      ...
      next: /* @__PURE__ */ h(function() {
        ...
        for (var m = this._currentRules(), t = 0; t < m.length; t++)
          if (c = this._input.match(this.rules[m[t]]), c && (!a || c[0].length > a[0].length)) {
            if (a = c, s = t, this.options.backtrack_lexer) {
              if (r = this.test_match(c, m[t]), r !== !1)
                return r;
              if (this._backtrack) {
                a = !1;
                continue;
        ...
        return a ? (r = this.test_match(a, m[s]), r !== !1 ? r : !1) : this._input === "" ? this.EOF : this.parseError("Lexical error on line " + (this.yylineno + 1) + `. Unrecognized text.
` + this.showPosition(), {
          text: "",
          token: null,
          line: this.yylineno
      ...
      topState: /* @__PURE__ */ h(function(a) {
        return a = this.conditionStack.length - 1 - Math.abs(a || 0), a >= 0 ? this.conditionStack[a] : "INITIAL";
      }, "topState"),
      // alias for begin(condition)
      pushState: /* @__PURE__ */ h(function(a) {
        this.begin(a);
      }, "pushState"),
      ...
      performAction: /* @__PURE__ */ h(function(a, c, s, m) {
        switch (s) {
          case 0:
            return "title";
          case 1:
  ...
  return h(pe, "Parser"), pe.prototype = _e, _e.Parser = pe, new pe();
})();
qe.parser = qe;
var ct = qe, ot = class {
  constructor() {
    this.relations = [], this.latestRequirement = this.getInitialRequirement(), this.requirements = /* @__PURE__ */ new Map(), this.latestElement = this.getInitialElement(), this.elements = /* @__PURE__ */ new Map(), this.classes = /* @__PURE__ */ new Map(), this.direction = "TB", this.RequirementType = {
      ...
      REFINES: "refines",
      TRACES: "traces"
    }, this.setAccTitle = Xe, this.getAccTitle = Je, this.setAccDescription = Ze, this.getAccDescription = et, this.setDiagramTitle = tt, this.getDiagramTitle = st, this.getConfig = /* @__PURE__ */ h(() => Te().requirement, "getConfig"), this.clear(), this.setDirection = this.setDirection.bind(this), this.addRequirement = this.addRequirement.bind(this), this.setNewReqId = this.setNewReqId.bind(this), this.setNewReqRisk = this.setNewReqRisk.bind(this), this.setNewReqText = this.setNewReqText.bind(this), this.setNewReqVerifyMethod = this.setNewReqVerifyMethod.bind(this), this.addElement = this.addElement.bind(this), this.setNewElementType = this.setNewElementType.bind(this), this.setNewElementDocRef = this.setNewElementDocRef.bind(this), this.addRelationship = this.addRelationship.bind(this), this.setCssStyle = this.setCssStyle.bind(this), this.setClass = this.setClass.bind(this), this.defineClass = this.defineClass.bind(this), this.setAccTitle = this.setAccTitle.bind(this), this.setAccDescription = this.setAccDescription.bind(this);
  }
  static {
  ...
  setCssStyle(e, u) {
    for (const o of e) {
      const n = this.requirements.get(o) ?? this.elements.get(o);
      if (!u || !n)
        return;
      for (const i of u)
  ...
  setClass(e, u) {
    for (const o of e) {
      ...
      if (n)
        for (const i of u) {
          n.classes.push(i);
          const f = this.classes.get(i)?.styles;
          f && n.cssStyles.push(...f);
        }
    }
  }
  defineClass(e, u) {
    for (const o of e) {
      let n = this.classes.get(o);
      n === void 0 && (n = { id: o, styles: [], textStyles: [] }, this.classes.set(o, n)), u && u.forEach(function(i) {
        if (/color/.exec(i)) {
          const f = i.replace("fill", "bgFill");
          n.textStyles.push(f);
        }
        n.styles.push(i);
      }), this.requirements.forEach((i) => {
        i.classes.includes(o) && i.cssStyles.push(...u.flatMap((f) => f.split(",")));
  ...
  getData() {
    ...
    for (const n of this.requirements.values()) {
      const i = n;
      i.id = n.name, i.cssStyles = n.cssStyles, i.cssClasses = n.classes.join(" "), i.shape = "requirementBox", i.look = e.look, i.colorIndex = u.length, u.push(i);
    }
    for (const n of this.elements.values()) {
      const i = n;
      i.shape = "requirementBox", i.look = e.look, i.id = n.name, i.cssStyles = n.cssStyles, i.cssClasses = n.classes.join(" "), i.colorIndex = u.length, u.push(i);
    }
    for (const n of this.relations) {
      let i = 0;
      const f = n.type === this.Relationships.CONTAINS, _ = {
        id: `${n.src}-${n.dst}-${i}`,
        ...
        style: ["fill:none", f ? "" : "stroke-dasharray: 10,7"],
        labelpos: "c",
        thickness: "normal",
        type: "normal",
        pattern: f ? "normal" : "dashed",
        arrowTypeStart: f ? "requirement_contains" : "",
        arrowTypeEnd: f ? "" : "requirement_arrow",
        look: e.look,
        labelType: "markdown"
      };
      o.push(_), i++;
  ...
  const u = Ye(), { themeVariables: o, look: n } = u, { bkgColorArray: i, borderColorArray: f } = o;
  if (!f?.length)
    return "";
  let _ = "";
  for (let E = 0; E < e.THEME_COLOR_LIMIT; E++)
    ...
    `;
  return _;
}, "genColor"), ut = /* @__PURE__ */ h((e) => {
  const u = Ye(), { look: o, themeVariables: n } = u, { requirementEdgeLabelBackground: i } = n;
  return `
  ${ht(e)}
  marker {
...
var mt = /* @__PURE__ */ h(async function(e, u, o, n) {
  Ne.info("REF0:"), Ne.info("Drawing requirement diagram (unified)", u);
  const { securityLevel: i, state: f, layout: _, look: E } = Te(), g = n.db.getData(), S = Ge(u, i);
  g.type = n.type, g.layoutAlgorithm = nt(_), g.nodeSpacing = f?.nodeSpacing ?? 50, g.rankSpacing = f?.rankSpacing ?? 50, g.markers = E === "neo" ? ["requirement_contains_neo", "requirement_arrow_neo"] : ["requirement_contains", "requirement_arrow"], g.diagramId = u, await at(g, S);
  const k = 8;
  lt.insertTitle(
    S,
  ...
  ), ze(S, k, "requirementDiagram", f?.useMaxWidth ?? !0);
}, "draw"), Rt = {
  parser: ct,
  get db() {
    return new ot();
