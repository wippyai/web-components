import { b as g, b2 as tr, a4 as $, a_ as Mt, aD as at, V as Ce, E as er, k as rr, z as P, b1 as ke, b0 as ar, b3 as sr, a2 as ir, a1 as nr, a5 as or, aC as cr, J as lr, t as hr, aZ as Bt, bk as Z, ai as Q, o as wt, aM as Me, Z as dr, a3 as Yt, af as Tr, aW as Be } from "./mermaid.core-FRDjOodn.js";
import { d as pr, h as ee, g as dt, e as Er, a as re, b as ae } from "./chunk-ND2GUHAM-B58vhIOR.js";
import { I as ur } from "./chunk-QZHKN3VN-CrvmLzNa.js";
var $t = (function() {
  var e = /* @__PURE__ */ g(function(ut, w, v, k) {
    for (v = v || {}, k = ut.length; k--; v[ut[k]] = w) ;
    return v;
  }, "o"), t = [1, 2], a = [1, 3], r = [1, 4], i = [2, 4], o = [1, 9], s = [1, 11], n = [1, 12], E = [1, 14], T = [1, 15], l = [1, 17], x = [1, 18], u = [1, 19], O = [1, 25], p = [1, 26], f = [1, 27], _ = [1, 28], I = [1, 29], L = [1, 30], b = [1, 31], S = [1, 32], A = [1, 33], N = [1, 34], B = [1, 35], V = [1, 36], H = [1, 37], U = [1, 38], G = [1, 39], X = [1, 40], j = [1, 42], q = [1, 43], st = [1, 44], tt = [1, 45], it = [1, 46], Y = [1, 47], C = [1, 4, 5, 10, 14, 15, 17, 19, 22, 24, 30, 31, 32, 34, 36, 37, 38, 39, 40, 42, 44, 45, 47, 48, 49, 50, 51, 53, 54, 56, 61, 62, 63, 64, 73], Nt = [1, 74], m = [1, 80], D = [1, 81], lt = [1, 82], et = [1, 83], W = [1, 84], se = [1, 85], ie = [1, 86], ne = [1, 87], oe = [1, 88], ce = [1, 89], le = [1, 90], he = [1, 91], de = [1, 92], Te = [1, 93], pe = [1, 94], Ee = [1, 95], ue = [1, 96], fe = [1, 97], _e = [1, 98], ge = [1, 99], xe = [1, 100], Ie = [1, 101], ye = [1, 102], Re = [1, 103], Oe = [1, 104], Le = [1, 105], be = [2, 78], mt = [4, 5, 17, 51, 53, 54], Pt = [4, 5, 10, 14, 15, 17, 19, 22, 24, 30, 31, 32, 34, 36, 37, 38, 39, 40, 42, 44, 45, 47, 51, 53, 54, 56, 61, 62, 63, 64, 73], me = [4, 5, 10, 14, 15, 17, 19, 22, 24, 30, 31, 32, 34, 36, 37, 38, 39, 40, 42, 44, 45, 47, 50, 51, 53, 54, 56, 61, 62, 63, 64, 73], qt = [4, 5, 10, 14, 15, 17, 19, 22, 24, 30, 31, 32, 34, 36, 37, 38, 39, 40, 42, 44, 45, 47, 49, 51, 53, 54, 56, 61, 62, 63, 64, 73], Ae = [4, 5, 10, 14, 15, 17, 19, 22, 24, 30, 31, 32, 34, 36, 37, 38, 39, 40, 42, 44, 45, 47, 48, 51, 53, 54, 56, 61, 62, 63, 64, 73], zt = [5, 52], K = [70, 71, 72, 73], ot = [1, 151], Ut = {
    ...
    performAction: /* @__PURE__ */ g(function(w, v, k, y, z, c, At) {
      var d = c.length - 1;
      switch (z) {
        case 3:
        ...
        case 16:
          ...
          break;
        case 17:
          c[d - 1].unshift({ type: "boxStart", boxData: y.parseBoxData(c[d - 2]) }), c[d - 1].push({ type: "boxEnd", boxText: c[d - 2] }), this.$ = c[d - 1];
          break;
        case 19:
          this.$ = { type: "sequenceIndex", sequenceIndex: Number(c[d - 2]), sequenceIndexStep: Number(c[d - 1]), sequenceVisible: !0, signalType: y.LINETYPE.AUTONUMBER };
          break;
        case 20:
          this.$ = { type: "sequenceIndex", sequenceIndex: Number(c[d - 1]), sequenceIndexStep: 1, sequenceVisible: !0, signalType: y.LINETYPE.AUTONUMBER };
          break;
        case 21:
        ...
        case 34:
          ...
          break;
        case 35:
          c[d - 1].unshift({ type: "loopStart", loopText: y.parseMessage(c[d - 2]), signalType: y.LINETYPE.LOOP_START }), c[d - 1].push({ type: "loopEnd", loopText: c[d - 2], signalType: y.LINETYPE.LOOP_END }), this.$ = c[d - 1];
          break;
        case 36:
          c[d - 1].unshift({ type: "rectStart", color: y.parseMessage(c[d - 2]), signalType: y.LINETYPE.RECT_START }), c[d - 1].push({ type: "rectEnd", color: y.parseMessage(c[d - 2]), signalType: y.LINETYPE.RECT_END }), this.$ = c[d - 1];
          break;
        case 37:
          c[d - 1].unshift({ type: "optStart", optText: y.parseMessage(c[d - 2]), signalType: y.LINETYPE.OPT_START }), c[d - 1].push({ type: "optEnd", optText: y.parseMessage(c[d - 2]), signalType: y.LINETYPE.OPT_END }), this.$ = c[d - 1];
          break;
        case 38:
          c[d - 1].unshift({ type: "altStart", altText: y.parseMessage(c[d - 2]), signalType: y.LINETYPE.ALT_START }), c[d - 1].push({ type: "altEnd", signalType: y.LINETYPE.ALT_END }), this.$ = c[d - 1];
          break;
        case 39:
          c[d - 1].unshift({ type: "parStart", parText: y.parseMessage(c[d - 2]), signalType: y.LINETYPE.PAR_START }), c[d - 1].push({ type: "parEnd", signalType: y.LINETYPE.PAR_END }), this.$ = c[d - 1];
          break;
        case 40:
          c[d - 1].unshift({ type: "parStart", parText: y.parseMessage(c[d - 2]), signalType: y.LINETYPE.PAR_OVER_START }), c[d - 1].push({ type: "parEnd", signalType: y.LINETYPE.PAR_END }), this.$ = c[d - 1];
          break;
        case 41:
          c[d - 1].unshift({ type: "criticalStart", criticalText: y.parseMessage(c[d - 2]), signalType: y.LINETYPE.CRITICAL_START }), c[d - 1].push({ type: "criticalEnd", signalType: y.LINETYPE.CRITICAL_END }), this.$ = c[d - 1];
          break;
        case 42:
          c[d - 1].unshift({ type: "breakStart", breakText: y.parseMessage(c[d - 2]), signalType: y.LINETYPE.BREAK_START }), c[d - 1].push({ type: "breakEnd", optText: y.parseMessage(c[d - 2]), signalType: y.LINETYPE.BREAK_END }), this.$ = c[d - 1];
          break;
        case 44:
          this.$ = c[d - 3].concat([{ type: "option", optionText: y.parseMessage(c[d - 1]), signalType: y.LINETYPE.CRITICAL_OPTION }, c[d]]);
          break;
        case 46:
          this.$ = c[d - 3].concat([{ type: "and", parText: y.parseMessage(c[d - 1]), signalType: y.LINETYPE.PAR_AND }, c[d]]);
          break;
        case 48:
          this.$ = c[d - 3].concat([{ type: "else", altText: y.parseMessage(c[d - 1]), signalType: y.LINETYPE.ALT_ELSE }, c[d]]);
          break;
        case 49:
          c[d - 3].draw = "participant", c[d - 3].type = "addParticipant", c[d - 3].description = y.parseMessage(c[d - 1]), this.$ = c[d - 3];
          break;
        case 50:
          c[d - 1].draw = "participant", c[d - 1].type = "addParticipant", this.$ = c[d - 1];
          break;
        case 51:
          c[d - 3].draw = "actor", c[d - 3].type = "addParticipant", c[d - 3].description = y.parseMessage(c[d - 1]), this.$ = c[d - 3];
          break;
        case 52:
        case 57:
        ...
        case 58:
          ...
          break;
        case 59:
          c[d - 2] = [].concat(c[d - 1], c[d - 1]).slice(0, 2), c[d - 2][0] = c[d - 2][0].actor, c[d - 2][1] = c[d - 2][1].actor, this.$ = [c[d - 1], { type: "addNote", placement: y.PLACEMENT.OVER, actor: c[d - 2].slice(0, 2), text: c[d] }];
          break;
        case 60:
        ...
        case 70:
          this.$ = [
            c[d - 4],
            c[d - 1],
            { type: "addMessage", from: c[d - 4].actor, to: c[d - 1].actor, signalType: c[d - 3], msg: c[d], activate: !0 },
        ...
        case 72:
          this.$ = [
            c[d - 4],
            c[d - 1],
            { type: "addMessage", from: c[d - 4].actor, to: c[d - 1].actor, signalType: c[d - 3], msg: c[d], activate: !0, centralConnection: y.LINETYPE.CENTRAL_CONNECTION },
        ...
        case 73:
          this.$ = [
            c[d - 4],
            c[d - 1],
            { type: "addMessage", from: c[d - 4].actor, to: c[d - 1].actor, signalType: c[d - 2], msg: c[d], activate: !1, centralConnection: y.LINETYPE.CENTRAL_CONNECTION_REVERSE },
            { type: "centralConnectionReverse", signalType: y.LINETYPE.CENTRAL_CONNECTION_REVERSE, actor: c[d - 4].actor }
          ];
          break;
        case 74:
          this.$ = [
            c[d - 5],
            c[d - 1],
            { type: "addMessage", from: c[d - 5].actor, to: c[d - 1].actor, signalType: c[d - 3], msg: c[d], activate: !0, centralConnection: y.LINETYPE.CENTRAL_CONNECTION_DUAL },
            { type: "centralConnection", signalType: y.LINETYPE.CENTRAL_CONNECTION, actor: c[d - 1].actor },
            { type: "centralConnectionReverse", signalType: y.LINETYPE.CENTRAL_CONNECTION_REVERSE, actor: c[d - 5].actor }
          ];
          break;
        case 75:
    ...
    parse: /* @__PURE__ */ g(function(w) {
      var v = this, k = [0], y = [], z = [null], c = [], At = this.table, d = "", Dt = 0, Se = 0, Ze = 2, we = 1, Qe = c.slice.call(arguments, 1), J = Object.create(this.lexer), gt = { yy: {} };
      for (var Gt in this.yy)
        Object.prototype.hasOwnProperty.call(this.yy, Gt) && (gt.yy[Gt] = this.yy[Gt]);
      J.setInput(w, gt.yy), gt.yy.lexer = J, gt.yy.parser = this, typeof J.yylloc > "u" && (J.yylloc = {});
      var Xt = J.yylloc;
      c.push(Xt);
      ...
      function je(nt) {
        k.length = k.length - 2 * nt, z.length = z.length - nt, c.length = c.length - nt;
      }
      g(je, "popStack");
      function Ne() {
        var nt;
        return nt = y.pop() || J.lex() || we, typeof nt != "number" && (nt instanceof Array && (y = nt, nt = y.pop()), nt = v.symbols_[nt] || nt), nt;
      }
      g(Ne, "lex");
      for (var rt, xt, ct, Jt, Ot = {}, vt, Tt, Pe, Ct; ; ) {
        if (xt = k[k.length - 1], this.defaultActions[xt] ? ct = this.defaultActions[xt] : ((rt === null || typeof rt > "u") && (rt = Ne()), ct = At[xt] && At[xt][rt]), typeof ct > "u" || !ct.length || !ct[0]) {
          var Zt = "";
          Ct = [];
          for (vt in At[xt])
            this.terminals_[vt] && vt > Ze && Ct.push("'" + this.terminals_[vt] + "'");
          J.showPosition ? Zt = "Parse error on line " + (Dt + 1) + `:
` + J.showPosition() + `
Expecting ` + Ct.join(", ") + ", got '" + (this.terminals_[rt] || rt) + "'" : Zt = "Parse error on line " + (Dt + 1) + ": Unexpected " + (rt == we ? "end of input" : "'" + (this.terminals_[rt] || rt) + "'"), this.parseError(Zt, {
            text: J.match,
        ...
        switch (ct[0]) {
          case 1:
            k.push(rt), z.push(J.yytext), c.push(J.yylloc), k.push(ct[1]), rt = null, Se = J.yyleng, d = J.yytext, Dt = J.yylineno, Xt = J.yylloc;
            break;
          case 2:
            if (Tt = this.productions_[ct[1]][1], Ot.$ = z[z.length - Tt], Ot._$ = {
            ...
            ]), Jt = this.performAction.apply(Ot, [
              d,
              Se,
              Dt,
              gt.yy,
              ...
              z,
              c
            ].concat(Qe)), typeof Jt < "u")
              return Jt;
            Tt && (k = k.slice(0, -1 * Tt * 2), z = z.slice(0, -1 * Tt), c = c.slice(0, -1 * Tt)), k.push(this.productions_[ct[1]][0]), z.push(Ot.$), c.push(Ot._$), Pe = At[k[k.length - 2]][k[k.length - 1]], k.push(Pe);
            break;
          case 3:
            return !0;
        }
...
` + v + "^";
      ...
      next: /* @__PURE__ */ g(function() {
        ...
        for (var z = this._currentRules(), c = 0; c < z.length; c++)
          if (k = this._input.match(this.rules[z[c]]), k && (!v || k[0].length > v[0].length)) {
            if (v = k, y = c, this.options.backtrack_lexer) {
              if (w = this.test_match(k, z[c]), w !== !1)
                return w;
              if (this._backtrack) {
                v = !1;
                continue;
...
` + this.showPosition(), {
  ...
  return g(kt, "Parser"), kt.prototype = Ut, Ut.Parser = kt, new kt();
})();
$t.parser = $t;
var fr = $t, _r = {
  SOLID: 0,
  ...
  addActor(e, t, a, r, i) {
    let o = this.state.records.currentBox, s;
    if (i !== void 0) {
      let E;
      i.includes(`
`) ? E = i + `
...
` + i + `
    ...
    if (n) {
      ...
      if (o = n.box ? n.box : this.state.records.currentBox, n.box = o, n && t === n.name && a == null)
        return;
    }
    if (a?.text == null && (a = { text: t, type: r }), (r == null || a.text == null) && (a = { text: t, type: r }), this.state.records.actors.set(e, {
      ...
      const E = this.state.records.actors.get(this.state.records.prevActor);
      E && (E.nextActor = e);
    }
  ...
  addSignal(e, t, a, r, i = !1, o) {
    if (r === this.LINETYPE.ACTIVE_END && this.activationCount(e ?? "") < 1) {
      const n = new Error("Trying to inactivate an inactive participant (" + e + ")");
      throw n.hash = {
        text: "->>-",
        token: "->>-",
        line: "1",
  ...
  parseBoxData(e) {
    ...
    const { wrap: i, cleanedText: o } = this.extractWrap(r);
    return {
      text: o ? Bt(o, $()) : void 0,
      color: a,
      wrap: i
  ...
  addALink(e, t) {
    ...
    try {
      ...
      const s = i.slice(0, o - 1).trim(), n = i.slice(o + 1).trim();
      r[s] = n, this.insertLinks(a, r);
    } catch (r) {
      at.error("error while parsing actor link text", r);
    }
  }
  ...
  addProperties(e, t) {
    const a = this.getActor(e);
    try {
      const r = Bt(t.text, $()), i = JSON.parse(r);
  ...
  addDetails(e, t) {
    ...
    try {
      const i = r.innerHTML, o = JSON.parse(i);
      o.properties && this.insertProperties(a, o.properties), o.links && this.insertLinks(a, o.links);
    } catch (i) {
...
`;
}, "getStyles"), Rr = yr, It = 36, ft = "actor-top", _t = "actor-bottom", Kt = "actor-box", yt = "actor-man", pt = /* @__PURE__ */ new Set(["redux-color", "redux-dark-color"]), St = /* @__PURE__ */ g(function(e, t) {
  const a = Er(e, t);
  return Yt().look === "neo" && a.attr("data-look", "neo"), a;
}, "drawRect"), Or = /* @__PURE__ */ g(function(e, t, a, r, i) {
  if (t.links === void 0 || t.links === null || Object.keys(t.links).length === 0)
    return { height: 0, width: 0 };
  const o = t.links, s = t.actorCnt, n = t.rectData;
  var E = "none";
  i && (E = "block !important");
  const T = e.append("g");
  T.attr("id", "actor" + s + "_popup"), T.attr("class", "actorPopupMenu"), T.attr("display", E);
  var l = "";
  n.class !== void 0 && (l = " " + n.class);
  let x = n.width > a ? n.width : a;
  const u = T.append("rect");
  if (u.attr("class", "actorPopupMenuPanel" + l), u.attr("x", n.x), u.attr("y", n.height), u.attr("fill", n.fill), u.attr("stroke", n.stroke), u.attr("width", x), u.attr("height", n.height), u.attr("rx", n.rx), u.attr("ry", n.ry), o != null) {
    var O = 20;
    for (let _ in o) {
      var p = T.append("a"), f = Ce.sanitizeUrl(o[_]);
      p.attr("xlink:href", f), p.attr("target", "_blank"), Ur(r)(
        _,
        p,
        n.x + 10,
        n.height + O,
  ...
  return u.attr("height", O), { height: n.height + O, width: x };
}, "drawPopup"), Ft = /* @__PURE__ */ g(function(e) {
  return "var pu = document.getElementById('" + e + "'); if (pu != null) { pu.style.display = pu.style.display == 'block' ? 'none' : 'block'; }";
}, "popupMenuToggle"), Wt = /* @__PURE__ */ g(async function(e, t, a = null) {
  let r = e.append("foreignObject");
  const i = await Be(t.text, Yt()), s = r.append("xhtml:div").attr("style", "width: fit-content;").attr("xmlns", "http://www.w3.org/1999/xhtml").html(i).node().getBoundingClientRect();
  if (r.attr("height", Math.round(s.height)).attr("width", Math.round(s.width)), t.class === "noteText") {
    const n = e.node().firstChild;
    n.setAttribute("height", s.height + 2 * t.textMargin);
    const E = n.getBBox();
    r.attr("x", Math.round(E.x + E.width / 2 - s.width / 2)).attr("y", Math.round(E.y + E.height / 2 - s.height / 2));
  } else if (a) {
    let { startx: n, stopx: E, starty: T } = a;
    if (n > E) {
      const l = n;
      n = E, E = l;
    }
    r.attr("x", Math.round(n + Math.abs(n - E) / 2 - s.width / 2)), t.class === "loopText" ? r.attr("y", Math.round(T)) : r.attr("y", Math.round(T - s.height));
  }
  return [r];
}, "drawKatex"), bt = /* @__PURE__ */ g(function(e, t) {
  let a = 0, r = 0;
  const i = t.text.split(P.lineBreakRegex), [o, s] = Me(t.fontSize);
  let n = [], E = 0, T = /* @__PURE__ */ g(() => t.y, "yfunc");
  if (t.valign !== void 0 && t.textMargin !== void 0 && t.textMargin > 0)
    switch (t.valign) {
      case "top":
      case "start":
        T = /* @__PURE__ */ g(() => Math.round(t.y + t.textMargin), "yfunc");
        break;
      case "middle":
      case "center":
        T = /* @__PURE__ */ g(() => Math.round(t.y + (a + r + t.textMargin) / 2), "yfunc");
        break;
      case "bottom":
      case "end":
        T = /* @__PURE__ */ g(() => Math.round(
  ...
  for (let [l, x] of i.entries()) {
    t.textMargin !== void 0 && t.textMargin === 0 && o !== void 0 && (E = l * o);
    const u = e.append("text");
    u.attr("x", t.x), u.attr("y", T()), t.anchor !== void 0 && u.attr("text-anchor", t.anchor).attr("dominant-baseline", t.dominantBaseline).attr("alignment-baseline", t.alignmentBaseline), t.fontFamily !== void 0 && u.style("font-family", t.fontFamily), s !== void 0 && u.style("font-size", s), t.fontWeight !== void 0 && u.style("font-weight", t.fontWeight), t.fill !== void 0 && u.attr("fill", t.fill), t.class !== void 0 && u.attr("class", t.class), t.dy !== void 0 ? u.attr("dy", t.dy) : E !== 0 && u.attr("dy", E);
    const O = x || dr;
    if (t.tspan) {
      ...
      u.text(O);
    t.valign !== void 0 && t.textMargin !== void 0 && t.textMargin > 0 && (r += (u._groups || u)[0][0].getBBox().height, a = r), n.push(u);
  }
  return n;
}, "drawText"), Ve = /* @__PURE__ */ g(function(e, t) {
  function a(i, o, s, n, E) {
    return i + "," + o + " " + (i + s) + "," + o + " " + (i + s) + "," + (o + n - E) + " " + (i + s - E * 1.2) + "," + (o + n) + " " + i + "," + (o + n);
  }
  g(a, "genPoints");
  const r = e.append("polygon");
  return r.attr("points", a(t.x, t.y, t.width, t.height, 7)), r.attr("class", "labelBox"), t.y = t.y + t.height / 2, bt(e, t), r;
}, "drawLabel"), M = -1, Ye = /* @__PURE__ */ g((e, t, a, r) => {
  e.select && a.forEach((i) => {
    const o = t.get(i), s = e.select("#actor" + o.actorCnt);
    !r.mirrorActors && o.stopy ? s.attr("y2", o.stopy + o.height / 2) : r.mirrorActors && s.attr("y2", o.stopy);
  });
}, "fixLifeLineHeights"), Lr = /* @__PURE__ */ g(function(e, t, a, r, i) {
  const o = r ? t.stopy : t.starty, s = t.x + t.width / 2, n = o + t.height, { look: E, theme: T, themeVariables: l } = a, { bkgColorArray: x, borderColorArray: u } = l, O = e.append("g").lower();
  var p = O;
  r || (M++, Object.keys(t.links || {}).length && !a.forceMenus && p.attr("onclick", Ft(`actor${M}_popup`)).attr("cursor", "pointer"), p.append("line").attr("id", "actor" + M).attr("x1", s).attr("y1", n).attr("x2", s).attr("y2", 2e3).attr("class", "actor-line 200").attr("stroke-width", "0.5px").attr("stroke", "#999").attr("name", t.name).attr("data-et", "life-line").attr("data-id", t.name), p = O.append("g"), t.actorCnt = M, t.links != null && p.attr("id", "root-" + M), E === "neo" && p.attr("data-look", "neo"));
  const f = dt();
  var _ = "actor";
  t.properties?.class ? _ = t.properties.class : f.fill = "#eaeaea", r ? _ += ` ${_t}` : _ += ` ${ft}`, f.x = t.x, f.y = o, f.width = t.width, f.height = t.height, f.class = _, f.rx = 3, f.ry = 3, f.name = t.name, E === "neo" && (f.rx = 6, f.ry = 6);
  const I = St(p, f), L = i.get(t.name) ?? 0;
  if (pt.has(T) && (I.style("stroke", u[L % u.length]), I.style("fill", x[L % u.length])), E === "neo" && I.attr("filter", "url(#drop-shadow)"), t.rectData = f, t.properties?.icon) {
    const S = t.properties.icon.trim();
    S.charAt(0) === "@" ? re(p, f.x + f.width - 20, f.y + 10, S.substr(1)) : ae(p, f.x + f.width - 20, f.y + 10, S);
  }
  r || (p.attr("data-et", "participant"), p.attr("data-type", "participant"), p.attr("data-id", t.name)), Et(a, Q(t.description))(
    t.description,
    p,
    f.x,
    f.y,
  ...
  return b;
}, "drawActorTypeParticipant"), br = /* @__PURE__ */ g(function(e, t, a, r, i) {
  const o = r ? t.stopy : t.starty, s = t.x + t.width / 2, n = o + t.height, { look: E, theme: T, themeVariables: l } = a, { bkgColorArray: x, borderColorArray: u } = l, O = e.append("g").lower();
  var p = O;
  r || (M++, Object.keys(t.links || {}).length && !a.forceMenus && p.attr("onclick", Ft(`actor${M}_popup`)).attr("cursor", "pointer"), p.append("line").attr("id", "actor" + M).attr("x1", s).attr("y1", n).attr("x2", s).attr("y2", 2e3).attr("class", "actor-line 200").attr("stroke-width", "0.5px").attr("stroke", "#999").attr("name", t.name).attr("data-et", "life-line").attr("data-id", t.name), p = O.append("g"), t.actorCnt = M, t.links != null && p.attr("id", "root-" + M), E === "neo" && p.attr("data-look", "neo"));
  const f = dt();
  var _ = "actor";
  t.properties?.class ? _ = t.properties.class : f.fill = "#eaeaea", r ? _ += ` ${_t}` : _ += ` ${ft}`, f.x = t.x, f.y = o, f.width = t.width, f.height = t.height, f.class = _, f.name = t.name;
  const I = 6, L = {
    ...f,
    x: f.x + -I,
    y: f.y + +I,
  ...
  if (pt.has(T) && (b.style("stroke", u[A % u.length]), b.style("fill", x[A % u.length]), S.style("stroke", u[A % u.length]), S.style("fill", x[A % u.length])), t.properties?.icon) {
    const B = t.properties.icon.trim();
    B.charAt(0) === "@" ? re(p, f.x + f.width - 20, f.y + 10, B.substr(1)) : ae(p, f.x + f.width - 20, f.y + 10, B);
  }
...
}, "drawActorTypeCollections"), mr = /* @__PURE__ */ g(function(e, t, a, r, i) {
  const o = r ? t.stopy : t.starty, s = t.x + t.width / 2, n = o + t.height, { look: E, theme: T, themeVariables: l } = a, { bkgColorArray: x, borderColorArray: u } = l, O = e.append("g").lower();
  let p = O;
  r || (M++, Object.keys(t.links || {}).length && !a.forceMenus && p.attr("onclick", Ft(`actor${M}_popup`)).attr("cursor", "pointer"), p.append("line").attr("id", "actor" + M).attr("x1", s).attr("y1", n).attr("x2", s).attr("y2", 2e3).attr("class", "actor-line 200").attr("stroke-width", "0.5px").attr("stroke", "#999").attr("name", t.name).attr("data-et", "life-line").attr("data-id", t.name), p = O.append("g"), t.actorCnt = M, t.links != null && p.attr("id", "root-" + M), E === "neo" && p.attr("data-look", "neo"));
  const f = dt();
  let _ = "actor";
  t.properties?.class ? _ = t.properties.class : f.fill = "#eaeaea", r ? _ += ` ${_t}` : _ += ` ${ft}`, p.attr("class", _), f.x = t.x, f.y = o, f.width = t.width, f.height = t.height, f.name = t.name;
  ...
  if (pt.has(T) && (b.style("stroke", u[N % u.length]), b.style("fill", x[N % u.length]), S.style("stroke", u[N % u.length]), S.style("fill", x[N % u.length])), t.properties?.icon) {
    const H = t.properties.icon.trim(), U = f.x + f.width - 20, G = f.y + 10;
    H.charAt(0) === "@" ? re(p, U, G, H.substr(1)) : ae(p, U, G, H);
  }
  Et(a, Q(t.description))(
    t.description,
    p,
...
}, "drawActorTypeQueue"), Ar = /* @__PURE__ */ g(function(e, t, a, r, i, o) {
  const s = r ? t.stopy : t.starty, n = t.x + t.width / 2, E = s + 75, { look: T, theme: l, themeVariables: x } = a, { bkgColorArray: u, borderColorArray: O, actorBorder: p, actorBkg: f } = x, _ = e.append("g").lower();
  r || (M++, _.append("line").attr("id", "actor" + M).attr("x1", n).attr("y1", E).attr("x2", n).attr("y2", 2e3).attr("class", "actor-line 200").attr("stroke-width", "0.5px").attr("stroke", "#999").attr("name", t.name).attr("data-et", "life-line").attr("data-id", t.name), t.actorCnt = M);
  const I = e.append("g");
  let L = yt;
  ...
  const B = o.get(t.name) ?? 0;
  pt.has(l) ? (I.style("stroke", O[B % O.length]), I.style("fill", u[B % O.length])) : (I.style("stroke", p), I.style("fill", f));
...
}, "drawActorTypeControl"), Sr = /* @__PURE__ */ g(function(e, t, a, r, i) {
  const o = r ? t.stopy : t.starty, s = t.x + t.width / 2, n = o + 75, { look: E, theme: T, themeVariables: l } = a, { bkgColorArray: x, borderColorArray: u } = l, O = e.append("g").lower(), p = e.append("g");
  let f = "actor";
  r ? f += ` ${_t}` : f += ` ${ft}`, p.attr("class", f), p.attr("name", t.name);
  const _ = dt();
  _.x = t.x, _.y = o, _.fill = "#eaeaea", _.width = t.width, _.height = t.height, _.class = "actor";
  const I = t.x + t.width / 2, L = o + (r ? 10 : 25), b = 22;
  ...
  pt.has(T) && (p.style("stroke", u[S % u.length]), p.style("fill", x[S % u.length]));
  const A = p.node().getBBox();
  return t.height = A.height + (a?.sequence?.labelBoxHeight ?? 0), r || (M++, O.append("line").attr("id", "actor" + M).attr("x1", s).attr("y1", n).attr("x2", s).attr("y2", 2e3).attr("class", "actor-line 200").attr("stroke-width", "0.5px").attr("stroke", "#999").attr("name", t.name).attr("data-et", "life-line").attr("data-id", t.name), t.actorCnt = M), Et(a, Q(t.description))(
    t.description,
    p,
    _.x,
    _.y + (r ? 15 : 30),
...
}, "drawActorTypeEntity"), wr = /* @__PURE__ */ g(function(e, t, a, r, i) {
  const o = r ? t.stopy : t.starty, s = t.x + t.width / 2, n = o + t.height + 2 * a.boxTextMargin, { theme: E, themeVariables: T, look: l } = a, { bkgColorArray: x, borderColorArray: u, actorBorder: O } = T, p = e.append("g").lower();
  let f = p;
  r || (M++, Object.keys(t.links || {}).length && !a.forceMenus && f.attr("onclick", Ft(`actor${M}_popup`)).attr("cursor", "pointer"), f.append("line").attr("id", "actor" + M).attr("x1", s).attr("y1", n).attr("x2", s).attr("y2", 2e3).attr("class", "actor-line 200").attr("stroke-width", "0.5px").attr("stroke", "#999").attr("name", t.name).attr("data-et", "life-line").attr("data-id", t.name), f = p.append("g"), t.actorCnt = M, t.links != null && f.attr("id", "root-" + M), l === "neo" && f.attr("data-look", "neo"));
  const _ = dt();
  let I = "actor";
  t.properties?.class ? I = t.properties.class : _.fill = "#eaeaea", r ? I += ` ${_t}` : I += ` ${ft}`, _.x = t.x, _.y = o, _.width = t.width, _.height = t.height, _.class = I, _.name = t.name, _.x = t.x, _.y = o;
  ...
  l 0,-${b - 2 * A}
`;
  N.append("path").attr("d", B), l === "neo" && N.attr("filter", "url(#drop-shadow)");
  const V = i.get(t.name) ?? 0;
  pt.has(E) ? (N.style("stroke", u[V % u.length]), N.style("fill", x[V % u.length])) : N.style("stroke", O), N.attr("transform", `translate(${L}, ${A})`), t.rectData = _, Et(a, Q(t.description))(
    t.description,
    f,
    _.x,
    _.y + 35,
...
}, "drawActorTypeDatabase"), Nr = /* @__PURE__ */ g(function(e, t, a, r, i) {
  const o = r ? t.stopy : t.starty, s = t.x + t.width / 2, n = o + 80, E = 22, T = e.append("g").lower(), { look: l, theme: x, themeVariables: u } = a, { bkgColorArray: O, borderColorArray: p, actorBorder: f } = u;
  r || (M++, T.append("line").attr("id", "actor" + M).attr("x1", s).attr("y1", n).attr("x2", s).attr("y2", 2e3).attr("class", "actor-line 200").attr("stroke-width", "0.5px").attr("stroke", "#999").attr("name", t.name).attr("data-et", "life-line").attr("data-id", t.name), t.actorCnt = M);
  const _ = e.append("g");
  let I = yt;
  r ? I += ` ${_t}` : I += ` ${ft}`, _.attr("class", I), _.attr("name", t.name);
  const L = dt();
  L.x = t.x, L.y = o, L.fill = "#eaeaea", L.width = t.width, L.height = t.height, L.class = "actor", _.append("line").attr("id", "actor-man-torso" + M).attr("x1", t.x + t.width / 2 - E * 2.5).attr("y1", o + 12).attr("x2", t.x + t.width / 2 - 15).attr("y2", o + 12), _.append("line").attr("id", "actor-man-arms" + M).attr("x1", t.x + t.width / 2 - E * 2.5).attr("y1", o + 2).attr("x2", t.x + t.width / 2 - E * 2.5).attr("y2", o + 22), _.append("circle").attr("cx", t.x + t.width / 2).attr("cy", o + 12).attr("r", E), l === "neo" && _.attr("filter", "url(#drop-shadow)");
  ...
  return t.height = S.height + (a.sequence.labelBoxHeight ?? 0), Et(a, Q(t.description))(
    t.description,
    _,
    L.x,
    L.y + 15,
...
}, "drawActorTypeBoundary"), Pr = /* @__PURE__ */ g(function(e, t, a, r, i) {
  const o = r ? t.stopy : t.starty, s = t.x + t.width / 2, n = o + 80, { look: E, theme: T, themeVariables: l } = a, { bkgColorArray: x, borderColorArray: u, actorBorder: O } = l, p = e.append("g").lower();
  r || (M++, p.append("line").attr("id", "actor" + M).attr("x1", s).attr("y1", n).attr("x2", s).attr("y2", 2e3).attr("class", "actor-line 200").attr("stroke-width", "0.5px").attr("stroke", "#999").attr("name", t.name).attr("data-et", "life-line").attr("data-id", t.name), t.actorCnt = M);
  const f = e.append("g");
  let _ = yt;
  r ? _ += ` ${_t}` : _ += ` ${ft}`, f.attr("class", _), f.attr("name", t.name), r || f.attr("data-et", "participant").attr("data-type", "actor").attr("data-id", t.name);
  const I = E === "neo" ? 0.5 : 1, L = E === "neo" ? o + (1 - I) * 30 : o;
  ...
  const N = i.get(t.name) ?? 0;
  return pt.has(T) ? (f.style("stroke", u[N % u.length]), f.style("fill", x[N % u.length])) : f.style("stroke", O), Et(a, Q(t.description))(
    t.description,
    f,
    A.x,
    L + 35 * I - (E === "neo" ? 10 : 0),
...
}, "drawActorTypeActor"), kr = /* @__PURE__ */ g(async function(e, t, a, r, i, o, s) {
  const n = s ?? new Map(
    [...o.db.getActors().values()].map((E, T) => [E.name, T])
  );
  switch (t.type) {
    case "actor":
      return await Pr(e, t, a, r, n);
    case "participant":
      return await Lr(e, t, a, r, n);
    case "boundary":
      return await Nr(e, t, a, r, n);
    case "control":
      return await Ar(
        e,
        t,
    ...
    case "entity":
      return await Sr(e, t, a, r, n);
    case "database":
      return await wr(e, t, a, r, n);
    case "collections":
      return await br(e, t, a, r, n);
    case "queue":
      return await mr(e, t, a, r, n);
  }
}, "drawActor"), Dr = /* @__PURE__ */ g(function(e, t, a) {
  const i = e.append("g");
  We(i, t), t.name && Et(a)(
    t.name,
    i,
...
}, "drawBox"), vr = /* @__PURE__ */ g(function(e) {
  return e.append("g");
}, "anchorElement"), Cr = /* @__PURE__ */ g(function(e, t, a, r, i, o, s) {
  const { theme: n, themeVariables: E } = r, { bkgColorArray: T, borderColorArray: l, mainBkg: x } = E, u = dt(), O = t.anchored, p = t.actor;
  u.x = t.startx, u.y = t.starty, u.class = "activation" + i % 3, u.width = t.stopx - t.startx, u.height = a - t.starty;
  const f = St(O, u), I = (s ?? new Map(
    [...o.db.getActors().values()].map((L, b) => [L.name, b])
  )).get(p) ?? 0;
  pt.has(n) && (f.style("stroke", l[I % l.length]), f.style("fill", T[I % l.length] ?? x));
}, "drawActivation"), Mr = /* @__PURE__ */ g(async function(e, t, a, r, i) {
  const {
    boxMargin: o,
    boxTextMargin: s,
    labelBoxHeight: n,
  ...
  let p = ee();
  p.text = a, p.x = t.startx, p.y = t.starty, p.fontFamily = T, p.fontSize = l, p.fontWeight = x, p.anchor = "middle", p.valign = "middle", p.tspan = !1, p.width = Math.max(E ?? 0, 50), p.height = n + (r.look === "neo" ? 15 : 0) || 20, p.textMargin = s, p.class = "labelText", Ve(u, p), p = Ke(), p.text = t.title, p.x = t.startx + E / 2 + (t.stopx - t.startx) / 2, p.y = t.starty + o + s, p.anchor = "middle", p.valign = "middle", p.textMargin = s, p.class = "loopText", p.fontFamily = T, p.fontSize = l, p.fontWeight = x, p.wrap = !0;
  let f = Q(p.text) ? await Wt(u, p, t) : bt(u, p);
  if (t.sectionTitles !== void 0) {
    for (const [_, I] of Object.entries(t.sectionTitles))
      if (I.message) {
        p.text = I.message, p.x = t.startx + (t.stopx - t.startx) / 2, p.y = t.sections[_].y + o + s, p.class = "sectionTitle", p.anchor = "middle", p.valign = "middle", p.tspan = !1, p.fontFamily = T, p.fontSize = l, p.fontWeight = x, p.wrap = t.wrap, Q(p.text) ? (t.starty = t.sections[_].y, await Wt(u, p, t)) : bt(u, p);
        let L = Math.round(
          f.map((b) => (b._groups || b)[0][0].getBBox().height).reduce((b, S) => b + S)
        );
        t.sections[_].height += L - (o + s);
      }
  }
  return t.height = Math.round(t.stopy - t.starty), u;
}, "drawLoop"), We = /* @__PURE__ */ g(function(e, t) {
  pr(e, t);
}, "drawBackgroundRect"), Br = /* @__PURE__ */ g(function(e, t) {
...
}, "insertDatabaseIcon"), Vr = /* @__PURE__ */ g(function(e, t) {
...
}, "insertComputerIcon"), Yr = /* @__PURE__ */ g(function(e, t) {
...
}, "insertClockIcon"), Wr = /* @__PURE__ */ g(function(e, t) {
...
}, "insertArrowHead"), Kr = /* @__PURE__ */ g(function(e, t) {
...
}, "insertArrowFilledHead"), Fr = /* @__PURE__ */ g(function(e, t) {
...
}, "insertSequenceNumber"), Hr = /* @__PURE__ */ g(function(e, t) {
...
}, "insertArrowCrossHead"), qr = /* @__PURE__ */ g(function(e, t) {
  const { theme: a } = t;
...
}, "insertDropShadow"), Ke = /* @__PURE__ */ g(function() {
  return {
    x: 0,
    y: 0,
    fill: void 0,
...
}, "getTextObj"), zr = /* @__PURE__ */ g(function() {
  return {
    x: 0,
    y: 0,
    fill: "#EDF2AE",
  ...
  function e(o, s, n, E, T, l, x) {
    const u = s.append("text").attr("x", n + T / 2).attr("y", E + l / 2 + 5).style("text-anchor", "middle").text(o);
    i(u, x);
  }
  g(e, "byText");
  function t(o, s, n, E, T, l, x, u) {
    const { actorFontSize: O, actorFontFamily: p, actorFontWeight: f } = u, [_, I] = Me(O), L = o.split(P.lineBreakRegex);
    for (let b = 0; b < L.length; b++) {
      const S = b * _ - _ * (L.length - 1) / 2, A = s.append("text").attr("x", n + T / 2).attr("y", E).style("text-anchor", "middle").style("font-size", I).style("font-weight", f).style("font-family", p);
      A.append("tspan").attr("x", n + T / 2).attr("dy", S).text(L[b]), A.attr("y", E + l / 2).attr("dominant-baseline", "central").attr("alignment-baseline", "central"), i(A, x);
    }
  }
  g(t, "byTspan");
  function a(o, s, n, E, T, l, x, u) {
    const O = s.append("switch"), f = O.append("foreignObject").attr("x", n).attr("y", E).attr("width", T).attr("height", l).append("xhtml:div").style("display", "table").style("height", "100%").style("width", "100%");
    f.append("div").style("display", "table-cell").style("text-align", "center").style("vertical-align", "middle").text(o), t(o, O, n, E, T, l, x, u), i(f, x);
  }
  g(a, "byFo");
  async function r(o, s, n, E, T, l, x, u) {
    const O = await wt(o, Yt()), p = s.append("switch"), _ = p.append("foreignObject").attr("x", n + T / 2 - O.width / 2).attr("y", E + l / 2 - O.height / 2).attr("width", O.width).attr("height", O.height).append("xhtml:div").style("height", "100%").style("width", "100%");
    _.append("div").style("text-align", "center").style("vertical-align", "middle").html(await Be(o, Yt())), t(o, p, n, E, T, l, x, u), i(_, x);
  }
  g(r, "byKatex");
  function i(o, s) {
    for (const n in s)
      s.hasOwnProperty(n) && o.attr(n, s[n]);
  }
  return g(i, "_setTextAttrs"), function(o, s = !1) {
    return s ? r : o.textPlacement === "fo" ? a : o.textPlacement === "old" ? e : t;
  };
})(), Ur = /* @__PURE__ */ (function() {
  function e(i, o, s, n, E, T, l) {
    const x = o.append("text").attr("x", s).attr("y", n).style("text-anchor", "start").text(i);
    r(x, l);
  }
  g(e, "byText");
  function t(i, o, s, n, E, T, l, x) {
    const { actorFontSize: u, actorFontFamily: O, actorFontWeight: p } = x, f = i.split(P.lineBreakRegex);
    for (let _ = 0; _ < f.length; _++) {
      const I = _ * u - u * (f.length - 1) / 2, L = o.append("text").attr("x", s).attr("y", n).style("text-anchor", "start").style("font-size", u).style("font-weight", p).style("font-family", O);
      L.append("tspan").attr("x", s).attr("dy", I).text(f[_]), L.attr("y", n + T / 2).attr("dominant-baseline", "central").attr("alignment-baseline", "central"), r(L, l);
    }
  }
  g(t, "byTspan");
  function a(i, o, s, n, E, T, l, x) {
    const u = o.append("switch"), p = u.append("foreignObject").attr("x", s).attr("y", n).attr("width", E).attr("height", T).append("xhtml:div").style("display", "table").style("height", "100%").style("width", "100%");
    p.append("div").style("display", "table-cell").style("text-align", "center").style("vertical-align", "middle").text(i), t(i, u, s, n, E, T, l, x), r(p, l);
  }
  g(a, "byFo");
  function r(i, o) {
    for (const s in o)
      o.hasOwnProperty(s) && i.attr(s, o[s]);
  }
  return g(r, "_setTextAttrs"), function(i) {
    return i.textPlacement === "fo" ? a : i.textPlacement === "old" ? e : t;
  };
})(), Gr = /* @__PURE__ */ g(function(e, t) {
...
}, "insertSolidTopArrowHead"), Xr = /* @__PURE__ */ g(function(e, t) {
...
}, "insertSolidBottomArrowHead"), Jr = /* @__PURE__ */ g(function(e, t) {
...
}, "insertStickTopArrowHead"), Zr = /* @__PURE__ */ g(function(e, t) {
  ...
  updateBounds: /* @__PURE__ */ g(function(e, t, a, r) {
    ...
    let o = 0;
    function s(n) {
      return /* @__PURE__ */ g(function(T) {
        o++;
        const l = i.sequenceItems.length - o + 1;
        i.updateVal(T, "starty", t - l * h.boxMargin, Math.min), i.updateVal(T, "stopy", r + l * h.boxMargin, Math.max), i.updateVal(R.data, "startx", e - l * h.boxMargin, Math.min), i.updateVal(R.data, "stopx", a + l * h.boxMargin, Math.max), n !== "activation" && (i.updateVal(T, "startx", e - l * h.boxMargin, Math.min), i.updateVal(T, "stopx", a + l * h.boxMargin, Math.max), i.updateVal(R.data, "starty", t - l * h.boxMargin, Math.min), i.updateVal(R.data, "stopy", r + l * h.boxMargin, Math.max));
      }, "updateItemBounds");
    }
    g(s, "updateFn"), this.sequenceItems.forEach(s()), this.activations.forEach(s("activation"));
  }, "updateBounds"),
  insert: /* @__PURE__ */ g(function(e, t, a, r) {
    const i = P.getMin(e, a), o = P.getMax(e, a), s = P.getMin(t, r), n = P.getMax(t, r);
    this.updateVal(R.data, "startx", i, Math.min), this.updateVal(R.data, "starty", s, Math.min), this.updateVal(R.data, "stopx", o, Math.max), this.updateVal(R.data, "stopy", n, Math.max), this.updateBounds(i, s, o, n);
  }, "insert"),
  newActivation: /* @__PURE__ */ g(function(e, t, a) {
    const r = a.get(e.from), i = Ht(e.from).length || 0, o = r.x + r.width / 2 + (i - 1) * h.activationWidth / 2;
...
}, Qr = /* @__PURE__ */ g(async function(e, t, a) {
  ...
  const n = Q(s.text) ? await Wt(i, s) : bt(i, s), E = Math.round(
    n.map((T) => (T._groups || T)[0][0].getBBox().height).reduce((T, l) => T + l)
  );
  o.attr("height", E + 2 * h.noteMargin), t.height += E + 2 * h.noteMargin, R.bumpVerticalPos(E + 2 * h.noteMargin), t.stopy = t.starty + E + 2 * h.noteMargin, t.stopx = t.startx + r.width, R.insert(t.startx, t.starty, t.stopx, t.stopy), R.models.addNote(t);
}, "drawNote"), De = /* @__PURE__ */ g(function(e, t, a, r, i, o, s) {
  const n = r.db.getActors(), E = n.get(t.from), T = n.get(t.to), l = a.sequenceVisible;
  let x = E.x + E.width / 2, u = T.x + T.width / 2;
  const O = x <= u, p = Xe(t, r), f = e.append("g"), _ = 16.5, I = /* @__PURE__ */ g((N, B) => {
    const V = N ? _ : -_;
    return B ? -V : V;
...
async function Fe(e, t) {
  ...
  const { startx: a, stopx: r, message: i } = t, o = P.splitBreaks(i).length, s = Q(i), n = s ? await wt(i, $()) : Z.calculateTextDimensions(i, Rt(h));
  if (!s) {
    const x = n.height / o;
  ...
  const l = n.width;
  if (a === r) {
    E = R.getVerticalPos() + T, h.rightAngles || (T += h.boxMargin, E = R.getVerticalPos() + T), T += 30;
    const x = P.getMax(l / 2, h.width / 2);
    R.insert(
      a - x,
      R.getVerticalPos() - 10 + T,
      r + x,
      R.getVerticalPos() + 30 + T
    );
  } else
    T += h.boxMargin, E = R.getVerticalPos() + T, R.insert(a, E - 10, r, E);
  return R.bumpVerticalPos(T), t.height += T, t.stopy = t.starty + t.height, R.insert(t.fromBounds, t.starty, t.toBounds, t.stopy), E;
}
g(Fe, "boundMessage");
var $r = /* @__PURE__ */ g(async function(e, t, a, r, i, o) {
  const { startx: s, stopx: n, starty: E, message: T, type: l, sequenceIndex: x, sequenceVisible: u } = t, O = Z.calculateTextDimensions(T, Rt(h)), p = ee();
  p.x = Math.min(s, n), p.y = E + 10, p.width = Math.abs(n - s), p.class = "messageText", p.dy = "1em", p.text = T, p.fontFamily = h.messageFontFamily, p.fontSize = h.messageFontSize, p.fontWeight = h.messageFontWeight, p.anchor = h.messageAlign, p.valign = "center", p.textMargin = h.wrapPadding, p.tspan = !1, Q(p.text) ? await Wt(e, p, { startx: s, stopx: n, starty: a }) : bt(e, p);
  const f = O.width;
  let _;
  if (s === n) {
    const L = u || h.showSequenceNumbers, b = Xe(i, r), S = ia(i, r), A = s + (L && (b || S) ? 10 : 0);
  ...
  if (r) {
    ...
    R.bumpVerticalPos(n + h.boxMargin);
  } else
    for (const n of a) {
      const E = t.get(n);
      await F.drawActor(e, E, h, !1, i, o, s);
    }
}, "drawActors"), He = /* @__PURE__ */ g(function(e, t, a, r) {
  let i = 0, o = 0;
  for (const s of a) {
    const n = t.get(s), E = ea(n), T = F.drawPopup(
      e,
      n,
      E,
      h,
    ...
    T.height > i && (i = T.height), T.width + n.x > o && (o = T.width + n.x);
  }
  return { maxHeight: i, maxWidth: o };
}, "drawActorsPopup"), qe = /* @__PURE__ */ g(function(e) {
  rr(h, e), e.fontFamily && (h.actorFontFamily = h.noteFontFamily = h.messageFontFamily = e.fontFamily), e.fontSize && (h.actorFontSize = h.noteFontSize = h.messageFontSize = e.fontSize), e.fontWeight && (h.actorFontWeight = h.noteFontWeight = h.messageFontWeight = e.fontWeight);
}, "setConf"), Ht = /* @__PURE__ */ g(function(e) {
  return R.activations.filter(function(t) {
    return t.actor === e;
  });
}, "actorActivations"), ve = /* @__PURE__ */ g(function(e, t) {
  const a = t.get(e), r = Ht(e), i = r.reduce(
    function(s, n) {
      return P.getMin(s, n.startx);
    },
    a.x + a.width / 2 - 1
  ), o = r.reduce(
    function(s, n) {
      return P.getMax(s, n.stopx);
    },
    a.x + a.width / 2 + 1
  );
  return [i, o];
...
function ht(e, t, a, r, i) {
  ...
  if (t.id && t.message && e[t.id]) {
    const s = e[t.id].width, n = Rt(h);
    t.message = Z.wrapLabel(`[${t.message}]`, s - 2 * h.wrapPadding, n), t.width = s, t.wrap = !0;
    const E = Z.calculateTextDimensions(t.message, n), T = P.getMax(E.height, h.labelBoxHeight);
    o = r + T, at.debug(`${T} - ${t.message}`);
  }
  i(t), R.bumpVerticalPos(o);
}
g(ht, "adjustLoopHeightForWrap");
function ze(e, t, a, r, i, o, s) {
  function n(l, x) {
    l.x < i.get(e.from).x ? (R.insert(
      t.stopx - x,
      t.starty,
      t.startx,
      t.stopy + l.height / 2 + h.noteMargin
  ...
  g(n, "receiverAdjustment");
  function E(l, x) {
    l.x < i.get(e.to).x ? (R.insert(
      t.startx - x,
      t.starty,
      t.stopx,
      t.stopy + l.height / 2 + h.noteMargin
  ...
  if (o.get(e.to) == r) {
    const l = i.get(e.to), x = T.includes(l.type) ? It / 2 + 3 : l.width / 2 + 3;
    n(l, x), l.starty = a - l.height / 2, R.bumpVerticalPos(l.height / 2);
  } else if (s.get(e.from) == r) {
    const l = i.get(e.from);
    if (h.mirrorActors) {
      const x = T.includes(l.type) ? It / 2 : l.width / 2;
      E(l, x);
    }
    ...
    const l = i.get(e.to);
    if (h.mirrorActors) {
      const x = T.includes(l.type) ? It / 2 + 3 : l.width / 2 + 3;
      n(l, x);
    }
    l.stopy = a - l.height / 2, R.bumpVerticalPos(l.height / 2);
  }
}
g(ze, "adjustCreatedDestroyedData");
var ta = /* @__PURE__ */ g(async function(e, t, a, r) {
  const { securityLevel: i, sequence: o, look: s } = $();
  h = o;
  let n;
  i === "sandbox" && (n = Mt("#i" + t));
  const E = i === "sandbox" ? Mt(n.nodes()[0].contentDocument.body) : Mt("body"), T = i === "sandbox" ? n.nodes()[0].contentDocument : document;
  R.init(), at.debug(r.db);
  const l = i === "sandbox" ? E.select(`[id="${t}"]`) : Mt(`[id="${t}"]`), x = r.db.getActors(), u = r.db.getCreatedActors(), O = r.db.getDestroyedActors(), p = r.db.getBoxes();
  let f = r.db.getActorKeys();
  const _ = r.db.getMessages(), I = r.db.getDiagramTitle(), L = r.db.hasAtLeastOneBox(), b = r.db.hasAtLeastOneBoxWithTitle(), S = await Ue(x, _, r);
  if (h.height = await Ge(x, S, p), F.insertComputerIcon(l, t), F.insertDatabaseIcon(l, t), F.insertClockIcon(l, t), L && (R.bumpVerticalPos(h.boxMargin), b && R.bumpVerticalPos(p[0].textMaxHeight)), h.hideUnusedParticipants === !0) {
  ...
  jr(l, x, u, f, 0, _, !1);
  const N = await oa(_, x, S, r);
  F.insertArrowHead(l, t), F.insertArrowCrossHead(l, t), F.insertArrowFilledHead(l, t), F.insertSequenceNumber(l, t), F.insertSolidTopArrowHead(l, t), F.insertSolidBottomArrowHead(l, t), F.insertStickTopArrowHead(l, t), F.insertStickBottomArrowHead(l, t), s === "neo" && F.insertDropShadow(l, h);
  function B(m, D) {
  ...
  for (const m of _) {
    ...
    switch (m.type) {
      case r.db.LINETYPE.NOTE:
        R.resetVerticalPos(), lt = m.noteModel, await Qr(l, lt, m.id);
        break;
      case r.db.LINETYPE.ACTIVE_START:
        R.newActivation(m, l, x);
        break;
      ...
      case r.db.LINETYPE.LOOP_END:
        D = R.endLoop(), await F.drawLoop(l, D, "loop", h, m), R.bumpVerticalPos(D.stopy - R.getVerticalPos()), R.models.addLoop(D);
        break;
      ...
      case r.db.LINETYPE.OPT_END:
        D = R.endLoop(), await F.drawLoop(l, D, "opt", h, m), R.bumpVerticalPos(D.stopy - R.getVerticalPos()), R.models.addLoop(D);
        break;
      ...
      case r.db.LINETYPE.ALT_END:
        D = R.endLoop(), await F.drawLoop(l, D, "alt", h, m), R.bumpVerticalPos(D.stopy - R.getVerticalPos()), R.models.addLoop(D);
        break;
      ...
      case r.db.LINETYPE.PAR_END:
        D = R.endLoop(), await F.drawLoop(l, D, "par", h, m), R.bumpVerticalPos(D.stopy - R.getVerticalPos()), R.models.addLoop(D);
        break;
      ...
      case r.db.LINETYPE.CRITICAL_END:
        D = R.endLoop(), await F.drawLoop(l, D, "critical", h, m), R.bumpVerticalPos(D.stopy - R.getVerticalPos()), R.models.addLoop(D);
        break;
      ...
      case r.db.LINETYPE.BREAK_END:
        D = R.endLoop(), await F.drawLoop(l, D, "break", h, m), R.bumpVerticalPos(D.stopy - R.getVerticalPos()), R.models.addLoop(D);
        break;
      default:
        try {
    ...
    ].includes(m.type) && (V = Math.round((V + H) * 100) / 100), X++;
  }
  at.debug("createdActors", u), at.debug("destroyedActors", O), await te(l, x, f, !1, t, r, A);
  for (const m of U)
    await $r(l, m.messageModel, m.lineStartY, r, m.msg, t);
  h.mirrorActors && await te(l, x, f, !0, t, r, A), G.forEach((m) => F.drawBackgroundRect(l, m)), Ye(l, x, f, h);
  for (const m of R.models.boxes) {
    m.height = R.getVerticalPos() - m.y, R.insert(m.x, m.y, m.x + m.width, m.height);
    const D = h.boxMargin * 2;
    m.startx = m.x - D, m.starty = m.y - D * 0.25, m.stopx = m.startx + m.width + 2 * D, m.stopy = m.starty + m.height + D * 0.75, m.stroke = "rgb(0,0,0, 0.5)", F.drawBox(l, m, h);
  }
  L && R.bumpVerticalPos(h.boxMargin);
  const j = He(l, x, f, T), { bounds: q } = R.getBounds();
  ...
  I && l.append("text").text(I).attr("x", (q.stopx - q.startx) / 2 - 2 * h.diagramMarginX).attr("y", -25), er(l, tt, Y, h.useMaxWidth);
  const C = I ? 40 : 0, Nt = x.size && s === "neo" ? 30 : 0;
  l.attr(
    "viewBox",
    q.startx - h.diagramMarginX + " -" + (h.diagramMarginY + C) + " " + Y + " " + (tt + C + Nt)
...
async function Ue(e, t, a) {
  ...
  for (const i of t)
    if (e.get(i.to) && e.get(i.from)) {
      const o = e.get(i.to);
      if (i.placement === a.db.PLACEMENT.LEFTOF && !o.prevActor || i.placement === a.db.PLACEMENT.RIGHTOF && !o.nextActor)
        continue;
      const s = i.placement !== void 0, n = !s, E = s ? Lt(h) : Rt(h), T = i.wrap ? Z.wrapLabel(i.message, h.width - 2 * h.wrapPadding, E) : i.message, x = (Q(T) ? await wt(i.message, $()) : Z.calculateTextDimensions(T, E)).width + 2 * h.wrapPadding;
      n && i.from === o.nextActor ? r[i.to] = P.getMax(
        r[i.to] || 0,
        x
      ) : n && i.from === o.prevActor ? r[i.from] = P.getMax(
        r[i.from] || 0,
        x
      ) : n && i.from === i.to ? (r[i.from] = P.getMax(
        r[i.from] || 0,
        x / 2
      ), r[i.to] = P.getMax(
        r[i.to] || 0,
        ...
        r[i.from] || 0,
        x
      ) : i.placement === a.db.PLACEMENT.LEFTOF ? r[o.prevActor] = P.getMax(
        r[o.prevActor] || 0,
        x
      ) : i.placement === a.db.PLACEMENT.OVER && (o.prevActor && (r[o.prevActor] = P.getMax(
        r[o.prevActor] || 0,
        x / 2
      )), o.nextActor && (r[i.from] = P.getMax(
        r[i.from] || 0,
        x / 2
      )));
    }
...
g(Ue, "getMaxMessageWidthPerActor");
var ea = /* @__PURE__ */ g(function(e) {
  let t = 0;
  const a = jt(h);
  for (const r in e.links) {
    const o = Z.calculateTextDimensions(r, a).width + 2 * h.wrapPadding + 2 * h.boxMargin;
    t < o && (t = o);
  }
  return t;
...
async function Ge(e, t, a) {
  ...
  for (const o of e.keys()) {
    ...
    const n = Q(s.description) ? await wt(s.description, $()) : Z.calculateTextDimensions(s.description, jt(h));
    s.width = s.wrap ? h.width : P.getMax(h.width, n.width + 2 * h.wrapPadding), s.height = s.wrap ? P.getMax(n.height, h.height) : h.height, r = P.getMax(r, s.height);
  }
  for (const o in t) {
    const s = e.get(o);
    if (!s)
    ...
    if (!n) {
      const x = t[o] + h.actorMargin - s.width / 2;
      s.margin = P.getMax(x, h.actorMargin);
      continue;
    }
    const T = t[o] + h.actorMargin - s.width / 2 - n.width / 2;
    s.margin = P.getMax(T, h.actorMargin);
  }
  let i = 0;
  return a.forEach((o) => {
    const s = Rt(h);
    let n = o.actorKeys.reduce((x, u) => x += e.get(u).width + (e.get(u).margin || 0), 0);
    const E = h.boxMargin * 8;
    n += E, n -= 2 * h.boxTextMargin, o.wrap && (o.name = Z.wrapLabel(o.name, n - 2 * h.wrapPadding, s));
    const T = Z.calculateTextDimensions(o.name, s);
    i = P.getMax(T.height, i);
    const l = P.getMax(n, T.width + 2 * h.wrapPadding);
    if (o.margin = h.boxTextMargin, n < l) {
      const x = (l - n) / 2;
      o.margin += x;
    }
  }), a.forEach((o) => o.textMaxHeight = i), P.getMax(r, h.height);
}
g(Ge, "calculateActorMargins");
var ra = /* @__PURE__ */ g(async function(e, t, a) {
  const r = t.get(e.from), i = t.get(e.to), o = r.x, s = i.x, n = e.wrap && e.message;
  let E = Q(e.message) ? await wt(e.message, $()) : Z.calculateTextDimensions(
    n ? Z.wrapLabel(e.message, h.width, Lt(h)) : e.message,
    Lt(h)
  );
  const T = {
    width: n ? h.width : P.getMax(h.width, E.width + 2 * h.noteMargin),
    height: 0,
    startx: r.x,
    stopx: 0,
    starty: 0,
  ...
  return e.placement === a.db.PLACEMENT.RIGHTOF ? (T.width = n ? P.getMax(h.width, E.width) : P.getMax(
    r.width / 2 + i.width / 2,
    E.width + 2 * h.noteMargin
  ), T.startx = o + (r.width + h.actorMargin) / 2) : e.placement === a.db.PLACEMENT.LEFTOF ? (T.width = n ? P.getMax(h.width, E.width + 2 * h.noteMargin) : P.getMax(
    r.width / 2 + i.width / 2,
    E.width + 2 * h.noteMargin
  ), T.startx = o - T.width + (r.width - h.actorMargin) / 2) : e.to === e.from ? (E = Z.calculateTextDimensions(
    n ? Z.wrapLabel(e.message, P.getMax(h.width, r.width), Lt(h)) : e.message,
    Lt(h)
  ), T.width = n ? P.getMax(h.width, r.width) : P.getMax(r.width, h.width, E.width + 2 * h.noteMargin), T.startx = o + (r.width - T.width) / 2) : (T.width = Math.abs(o + r.width / 2 - (s + i.width / 2)) + h.actorMargin, T.startx = o < s ? o + r.width / 2 - h.actorMargin / 2 : s + i.width / 2 - h.actorMargin / 2), n && (T.message = Z.wrapLabel(
    e.message,
    T.width - 2 * h.wrapPadding,
    Lt(h)
  )), at.debug(
    `NM:[${T.startx},${T.stopx},${T.starty},${T.stopy}:${T.width},${T.height}=${e.message}]`
  ), T;
}, "buildNoteModel"), aa = 4, Qt = /* @__PURE__ */ g(function(e, t) {
  const { CENTRAL_CONNECTION: a, CENTRAL_CONNECTION_REVERSE: r, CENTRAL_CONNECTION_DUAL: i } = t.db.LINETYPE;
  return [a, r, i].includes(
    e.centralConnection
  );
}, "hasCentralConnection"), sa = /* @__PURE__ */ g(function(e, t, a) {
  const {
    CENTRAL_CONNECTION_REVERSE: r,
    CENTRAL_CONNECTION_DUAL: i,
    BIDIRECTIONAL_SOLID: o,
    BIDIRECTIONAL_DOTTED: s
  } = t.db.LINETYPE;
  let n = 0;
  return (e.centralConnection === r || e.centralConnection === i) && (n += aa), (e.centralConnection === r || e.centralConnection === i) && (e.type === o || e.type === s) && (n += a ? 0 : -6), n;
}, "calculateCentralConnectionOffset"), Xe = /* @__PURE__ */ g(function(e, t) {
  const {
    SOLID_ARROW_TOP_REVERSE: a,
    SOLID_ARROW_TOP_REVERSE_DOTTED: r,
    SOLID_ARROW_BOTTOM_REVERSE: i,
    SOLID_ARROW_BOTTOM_REVERSE_DOTTED: o,
    STICK_ARROW_TOP_REVERSE: s,
    STICK_ARROW_TOP_REVERSE_DOTTED: n,
    STICK_ARROW_BOTTOM_REVERSE: E,
    STICK_ARROW_BOTTOM_REVERSE_DOTTED: T
  } = t.db.LINETYPE;
  return [
    a,
    r,
...
}, "isReverseArrowType"), ia = /* @__PURE__ */ g(function(e, t) {
  const { BIDIRECTIONAL_SOLID: a, BIDIRECTIONAL_DOTTED: r } = t.db.LINETYPE;
  return [a, r].includes(e.type);
}, "isBidirectionalArrowType"), na = /* @__PURE__ */ g(function(e, t, a) {
  const { look: r } = $();
  if (![
    ...
    return {};
  const [i, o] = ve(e.from, t), [s, n] = ve(e.to, t), E = i <= s;
  let T = E ? o : i, l = E ? s : n;
  r === "neo" && (e.type !== a.db.LINETYPE.SOLID_OPEN && (l += E ? -3 : 3), (e.type === a.db.LINETYPE.BIDIRECTIONAL_SOLID || e.type === a.db.LINETYPE.BIDIRECTIONAL_DOTTED) && (T += E ? 3 : -3)), T += sa(e, a, E);
  const x = Math.abs(s - n) > 2, u = /* @__PURE__ */ g((_) => E ? -_ : _, "adjustValue");
  e.from === e.to ? l = T : (e.activate && !x && (l += u(h.activationWidth / 2 - 1)), [
    a.db.LINETYPE.SOLID_OPEN,
    a.db.LINETYPE.DOTTED_OPEN,
    a.db.LINETYPE.STICK_TOP,
    a.db.LINETYPE.STICK_BOTTOM,
  ...
  const O = [i, o, s, n], p = Math.abs(T - l);
...
}, "buildMessageModel"), oa = /* @__PURE__ */ g(async function(e, t, a, r) {
  const i = {}, o = [];
  let s, n, E;
  for (const T of e) {
    switch (T.type) {
      ...
      case r.db.LINETYPE.PAR_AND:
      case r.db.LINETYPE.CRITICAL_OPTION:
        T.message && (s = o.pop(), i[s.id] = s, i[T.id] = s, o.push(s));
        break;
      case r.db.LINETYPE.LOOP_END:
      case r.db.LINETYPE.ALT_END:
      case r.db.LINETYPE.OPT_END:
      ...
      case r.db.LINETYPE.ACTIVE_START:
        {
          const x = t.get(T.from ? T.from : T.to.actor), u = Ht(T.from ? T.from : T.to.actor).length, O = x.x + x.width / 2 + (u - 1) * h.activationWidth / 2, p = {
            startx: O,
            stopx: O + h.activationWidth,
            actor: T.from,
            enabled: !0
      ...
      case r.db.LINETYPE.ACTIVE_END:
        {
          const x = R.activations.map((u) => u.actor).lastIndexOf(T.from);
          R.activations.splice(x, 1).splice(0, 1);
        }
        break;
    }
    T.placement !== void 0 ? (n = await ra(T, t, r), T.noteModel = n, o.forEach((x) => {
      s = x, s.from = P.getMin(s.from, n.startx), s.to = P.getMax(s.to, n.startx + n.width), s.width = P.getMax(s.width, Math.abs(s.from - s.to)) - h.labelBoxWidth;
    })) : (E = na(T, t, r), T.msgModel = E, E.startx && E.stopx && o.length > 0 && o.forEach((x) => {
      if (s = x, E.startx === E.stopx) {
        const u = t.get(T.from), O = t.get(T.to);
        s.from = P.getMin(
          u.x - E.width / 2,
          u.x - u.width / 2,
          s.from
  ...
  styles: Rr,
  init: /* @__PURE__ */ g((e) => {
    e.sequence || (e.sequence = {}), e.wrap && (e.sequence.wrap = e.wrap, tr({ sequence: { wrap: e.wrap } }));
  }, "init")
};
export {
  Ta as diagram
