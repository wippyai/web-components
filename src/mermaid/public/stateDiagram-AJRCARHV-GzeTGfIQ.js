import { b as R, s as W, S as N } from "./chunk-AQP2D5EJ-DbphR-zT.js";
import { b as f, a4 as t, a_ as H, aD as S, E as P, z, aA as _, K as U, af as C, bk as F } from "./mermaid.core-FRDjOodn.js";
import { G as O } from "./graph-yNRfypD2.js";
import { l as D } from "./layout-DivnQK5l.js";
var J = /* @__PURE__ */ f((e) => e.append("circle").attr("class", "start-state").attr("r", t().state.sizeUnit).attr("cx", t().state.padding + t().state.sizeUnit).attr("cy", t().state.padding + t().state.sizeUnit), "drawStartState"), X = /* @__PURE__ */ f((e) => e.append("line").style("stroke", "grey").style("stroke-dasharray", "3").attr("x1", t().state.textHeight).attr("class", "divider").attr("x2", t().state.textHeight * 2).attr("y1", 0).attr("y2", 0), "drawDivider"), Y = /* @__PURE__ */ f((e, i) => {
  ...
  const d = /* @__PURE__ */ f(function(o, m, y) {
    const E = o.append("tspan").attr("x", 2 * t().state.padding).text(m);
  ...
  i.type === "start" && J(n), i.type === "end" && q(n), (i.type === "fork" || i.type === "join") && K(n, i), i.type === "note" && j(i.note.text, n), i.type === "divider" && X(n), i.type === "default" && i.descriptions.length === 0 && Y(n, i), i.type === "default" && i.descriptions.length > 0 && I(n, i);
  ...
  const n = i.points, l = _().x(function(s) {
    ...
    return s.y;
  }).curve(U), p = e.append("path").attr("d", l(n)).attr("id", "edge" + A).attr("class", "transition");
  let a = "";
  if (t().state.arrowMarkerAbsolute && (a = C(!0)), p.attr(
    ...
    for (let u = 0; u <= g.length; u++) {
      ...
      y = Math.max(y, w.width), E = Math.min(E, w.x), S.info(w.x, B, x + o), o === 0 && (o = h.node().getBBox().height, S.info("Title height", o, x)), m.push(h);
    }
    let k = o * g.length;
    if (g.length > 1) {
  ...
  const g = b.padding, o = s.node().getBBox(), m = o.width + g * 2, y = o.height + g * 2, E = m * 1.75;
  P(s, y, E, b.useMaxWidth), s.attr(
    "viewBox",
  ...
  }), D(a), S.debug("Graph after layout", a.nodes());
  const y = i.node();
