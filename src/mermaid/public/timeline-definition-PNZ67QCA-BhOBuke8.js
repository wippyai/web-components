import { b as o, a3 as pt, au as Rt, az as Ct, L as Wt, a4 as gt, aD as E, a$ as Pt, aM as Bt, b6 as ft, a_ as X, _ as Vt, y as Ft, t as zt } from "./mermaid.core-FRDjOodn.js";
import { d as ot } from "./arc-DoJBinwv.js";
var tt = (function() {
  var e = /* @__PURE__ */ o(function(k, s, d, l) {
    ...
    parse: /* @__PURE__ */ o(function(s) {
      ...
      var F = w.yylloc;
      u.push(F);
      var U = w.options && w.options.ranges;
        ...
        switch (T[0]) {
          ...
          case 2:
            if (B = this.productions_[T[1]][1], C.$ = x[x.length - B], C._$ = {
              ...
              return P;
            B && (l = l.slice(0, -1 * B * 2), x = x.slice(0, -1 * B), u = u.slice(0, -1 * B)), l.push(this.productions_[T[1]][0]), x.push(C.$), u.push(C._$), Z = S[l[l.length - 2]][l[l.length - 1]], l.push(Z);
            break;
          case 3:
            return !0;
        }
...
var D = "", mt = 0, nt = "LR", rt = [], q = [], K = [], xt = /* @__PURE__ */ o(() => Ft, "getCommonDb"), kt = /* @__PURE__ */ o(function() {
  rt.length = 0, q.length = 0, D = "", K.length = 0, nt = "LR", zt();
  ...
  K.find((n) => n.id === mt - 1).events.push(e);
  ...
  const e = /* @__PURE__ */ o(function(n) {
    return K[n].processed;
  }, "compileTask");
  let t = !0;
  for (const [n, i] of K.entries())
    e(n), t = t && i.processed;
  return t;
}, "compileTasks"), Gt = {
  clear: kt,
...
}, "drawFace"), Kt = /* @__PURE__ */ o(function(e, t) {
...
}, "drawText"), Ut = /* @__PURE__ */ o(function(e, t) {
...
function it(e, t) {
  e.each(function() {
    var n = X(this), i = n.text().split(/(\s+|<br>)/).reverse(), r, h = [], c = 1.1, a = n.attr("y"), f = parseFloat(n.attr("dy")), g = n.text(null).append("tspan").attr("x", 0).attr("y", a).attr("dy", f + "em");
...
var Qt = /* @__PURE__ */ o(function(e, t, n, i, r, h = !1) {
  ...
  if (t.height = l.height + p * 1.1 * 0.5 + t.padding, t.height = Math.max(t.height, t.maxHeight), t.width = t.width + 2 * t.padding, s.attr("transform", "translate(" + t.width / 2 + ", " + t.padding / 2 + ")"), f && s.attr(
    ...
    const x = c.includes("dark"), u = e.node()?.ownerSVGElement ?? e.node(), S = X(u), v = S.attr("id") ?? "", I = v ? `${v}-drop-shadow` : "drop-shadow";
    if (S.select(`#${I}`).empty()) {
  ...
  let s;
  k === "sandbox" && (s = X("#i" + t));
  const l = (k === "sandbox" ? X(s.nodes()[0].contentDocument.body) : X("body")).select("#" + t);
  l.append("g");
  ...
  const [H] = Bt(r.fontSize), V = (H ?? 16) * 2, F = (H ?? 16) * 0.5 + 20, U = c.append("g").attr("class", "lineWrapper");
  U.append("line").attr("x1", I).attr("y1", d - V).attr("x2", I).attr("y2", w.y + w.height + F).attr("stroke-width", 4).attr("stroke", "black").attr("marker-end", "url(#arrowhead)"), U.lower(), ft(
    void 0,
    c,
    r.timeline?.padding ?? 50,
    r.timeline?.useMaxWidth ?? !1
